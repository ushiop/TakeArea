...
//library PlayerEvent:
    ...
    function PlayerEvent__onDisconnect takes nothing returns nothing
        ...
        if ( x != 0 ) then
            call ForForce((s__Teams___Team_Players[GetPlayerTeam((p))]), function PlayerEvent__anon__8) // INLINED!!
        endif
    ...
    function PlayerEvent__onInit takes nothing returns nothing
        call ForForce(Teams___AllPlayers, (function PlayerEvent__anon__9)) // INLINED!!
...
call ExecuteFunc("jasshelper__initstructs689371531")
...
function jasshelper__initstructs689371531 takes nothing returns nothing
