...
//library BlackSaber:
                    ...
                    if ( s__Units_Alive(u) == true ) then
                        ...
                        if ( s___Data_r[s__Data_r[data]+1] == 0 ) then
                            if ( s___Data_r[s__Data_r[data]] < 360 ) then
                                ...
                                call s__Units_Position(m,s__Units_X(u) + 90 * CosBJ(s__Units_F(u)) , s__Units_Y(u) + 90 * SinBJ(s__Units_F(u)) , false)
                                call s__Units_SetH(m,125 * s__Util_GetPwx(3.99 , s___Data_r[s__Data_r[data]] , 720)) //DestroyEffect( AddSpecialEffect("Abilities\\Weapons\\AncientProtectorMissile\\AncientProtectorMissile.mdl",m.X(),m.Y()) );
                        ...
                        if ( s___Data_r[s__Data_r[data]+1] == 1 ) then
                            if ( s___Data_r[s__Data_r[data]] < 50 ) then //data.r[0]+=1;
                            else //Units.MJ(u.player.player,'e008','A012',0,m.X(),m.Y(),0,2,1.5*(data.r[0]/50),2.5, "death","BlackDragonMissile.mdl").SetH(m.H());                            
                                set s___Data_r[s__Data_r[data]+1]=2
                                call BJDebugMsg("?")
                                call s__Units_RemoveAbility(u,'A014')
                                call s__Units_SetH(s__Units_MJ(s__Players_player[s__Units_player[u]] , 'e008' , 'A012' , 0 , s__Units_X(m) , s__Units_Y(m) , 0 , 2 , 1.5 , 1 , "death" , "blue-fire.mdl"),s__Units_H(m))
                            endif
                        endif
                    else
            ...
            function s__BlackSaber___BlackSaber_anon__77 takes integer dash returns nothing
                ...
                if ( s___Data_i[s__Data_i[data]] == 0 ) then
                    ...
                    if ( k != null ) then
                        ...
                        call SetTimerData(t , data)
                        call s__Dash_Start(s__Units_unit[u] , s__Dash_Angle[dash] , 200 , s__Dash_SUB , 20 , true , false)
                        call TimerStart(t, 0.01, true, function s__BlackSaber___BlackSaber_anon__78)
                        set t=null
                    endif
                endif
            endfunction
        ...
        function s__BlackSaber___BlackSaber_R takes integer e returns nothing
            ...
            set s__Dash_onMove[dash]=(16)
            set s__Dash_onEnd[dash]=(17)
        endfunction
                            ...
                            exitwhen ( FirstOfGroup(tmp_group) == null )
                                ...
                                if ( IsUnitEnemy(s__Units_unit[mj], s__Players_player[s__Units_player[u]]) == true ) then
                                    if ( s___Data_r[s__Data_r[data]+2] == 1 or s___Data_r[s__Data_r[data]+2] == 5 ) then
                                        ...
                                        call s__Units_Damage(u,s__Units_unit[mj] , 'A00X' , s__Damage_Magic , s__Units_Int(u,true) * 3)
                                    ...
                                    if ( s___Data_r[s__Data_r[data]+2] >= 2 and s___Data_r[s__Data_r[data]+2] <= 4 ) then
                                        if ( s__Units_H(mj) > 10 ) then
                                            ...
                                            call s__Units_Damage(u,s__Units_unit[mj] , 'A00X' , s__Damage_Chaos , s__Units_Int(u,true) * 3)
                                            call DestroyEffect(AddSpecialEffectTarget("fire-boom-new-darkblue-3.mdl", s__Units_unit[mj], "chest"))
                                            call s__Units_Position(mj,s__Units_X(mj) + 25 * CosBJ(s__Units_F(u)) , s__Units_Y(mj) + 25 * SinBJ(s__Units_F(u)) , true)
                                        endif
                                    endif
            ...
            function s__BlackSaber___BlackSaber_anon__81 takes integer dash returns nothing
                ...
                if ( s__Dash_Speed[dash] < 2 ) then
                    ...
                    exitwhen ( FirstOfGroup(tmp_group) == null )
                        ...
                        call GroupRemoveUnit(tmp_group, s__Units_unit[mj])
                        if ( IsUnitEnemy(s__Units_unit[mj], s__Players_player[s__Units_player[u]]) == true ) then
                            call s__Units_Damage(u,s__Units_unit[mj] , 'A00V' , s__Damage_Magic , s__Units_Int(u,true) * 10)
                        endif
                    endloop
                    call GroupClear(tmp_group)
        ...
        function s__BlackSaber___BlackSaber_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A012' , (22))
            call s__Spell_On(s__Spell_onSpell , 'A00U' , (23))
            call s__Spell_On(s__Spell_onSpell , 'A00V' , (24))
            call s__Spell_On(s__Spell_onSpell , 'A00X' , (25))
            call s__Spell_On(s__Spell_onReady , 'A00X' , (26))
            call s__Spell_On(s__Spell_onStop , 'A00X' , (27))
            call s__Spell_On(s__Spell_onReady , 'A00V' , (26))
            call s__Spell_On(s__Spell_onStop , 'A00V' , (27))
...
//library DazzleMaster:
        ...
        function s__DazzleMaster__DazzleMaster_Spawn takes integer u,integer m returns nothing
            ...
            if ( s__Units_IsAbility(u,'A008') == true ) then
                ...
                call SetTimerData(t , data)
                call TimerStart(t, 0.01, true, function s__DazzleMaster__DazzleMaster_anon__35)
                set t=null
            endif
        endfunction
        ...
        function s__DazzleMaster__DazzleMaster_HERO_STOP takes integer e returns nothing
            ...
            function s__DazzleMaster__DazzleMaster_anon__36 takes integer b returns nothing
            ...
            function s__DazzleMaster__DazzleMaster_anon__37 takes integer dash returns nothing
                local integer u=s__Units_Get(s__Dash_Unit[dash])
        ...
        function s__DazzleMaster__DazzleMaster_D takes integer e returns nothing
            ...
            set s__Buffs_onEnd[s__Buffs_Add(s__Units_unit[u] , 'A00G' , 'B002' , 5 , false)]=(28)
            ...
            set s__Dash_onMove[dash]=(29)
            set s__Dash_onEnd[dash]=(30)
            call s__Spell_Destroy(e)
        endfunction
                    ...
                    if ( s__Units_Alive(u) == true ) then
                        ...
                        exitwhen ( FirstOfGroup(tmp_group) == null )
                            ...
                            if ( IsUnitEnemy(s__Units_unit[tmp], s__Players_player[s__Units_player[u]]) == true ) then
                                ...
                                set s__Dash_onMove[s__Dash_Start(s__Units_unit[tmp] , s__Util_XY(s__Units_unit[tmp] , s__Units_unit[u]) , s__Util_XY2(s__Units_unit[tmp] , s__Units_unit[u]) , s__Dash_NORMAL , s__Util_XY2(s__Units_unit[tmp] , s__Units_unit[u]) / 4 , true , false)]=(33)
                        ...
                        if ( GroupNumber(s___Data_g[s__Data_g[data]]) != 0 ) then
                            ...
                            call TimerStart(GetExpiredTimer(), 0.02, true, function s__DazzleMaster__DazzleMaster_anon__42)
                        else
                            call DestroyGroup(s___Data_g[s__Data_g[data]])
                            call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                            set s___Data_g[s__Data_g[data]]=null
            ...
            function s__DazzleMaster__DazzleMaster_anon__39 takes nothing returns nothing
                ...
                if ( s__Units_Alive(u) == true ) then
                    ...
                    if ( GroupFind(s__Units_unit[u] , x , y , 150 , false , false) != null ) then
                        ...
                        set t=NewTimer()
                        call SetTimerData(t , data)
                        call TimerStart(t, 0.15, false, function s__DazzleMaster__DazzleMaster_anon__40)
                        set t=null
                        call ReleaseTimer(GetExpiredTimer())
                    else
                        call s__Units_PositionEnabled(u,true)
        ...
        function s__DazzleMaster__DazzleMaster_R takes integer e returns nothing
            ...
            call TimerStart(t, 0.25, false, function s__DazzleMaster__DazzleMaster_anon__39)
            set t=null
        endfunction
        ...
        function s__DazzleMaster__DazzleMaster_E takes integer e returns nothing
            ...
            call SetTimerData(t , data)
            call TimerStart(t, 0.1, true, function s__DazzleMaster__DazzleMaster_anon__45)
            set t=null
        endfunction
    ...
    function DazzleMaster__onInit takes nothing returns nothing
        call s__Spell_On(s__Spell_onSpell , 'A008' , (40))
        call s__Spell_On(s__Spell_onSpell , 'A009' , (41))
        call s__Spell_On(s__Spell_onSpell , 'A00B' , (42))
        call s__Spell_On(s__Spell_onSpell , 'A00D' , (43))
        call s__Spell_On(s__Spell_onSpell , 'A00E' , (44))
        call s__Spell_On(s__Spell_onReady , 'A009' , (45))
        call s__Spell_On(s__Spell_onStop , 'A009' , (46))
        call s__Damage_On(s__Damage_onHeroDamageed , (47))
...
//library OrdinaryWizard:
        ...
        function s__OrdinaryWizard__OrdinaryWizard_R takes integer e returns nothing
            ...
            set s__Dash_Obj[dash]=data
            set s__Dash_onMove[dash]=(48)
            set s__Dash_onEnd[dash]=(49)
        endfunction
        ...
        function s__OrdinaryWizard__OrdinaryWizard_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A002' , (54))
            call s__Spell_On(s__Spell_onSpell , 'A004' , (55))
            call s__Spell_On(s__Spell_onSpell , 'A006' , (56))
            call s__Spell_On(s__Spell_onStart , 'A002' , (57))
            call s__Spell_On(s__Spell_onStop , 'A002' , (58))
            call s__Spell_On(s__Spell_onStart , 'A006' , (57))
            call s__Spell_On(s__Spell_onStop , 'A006' , (58))
...
//library WindWalk:
        ...
        function s__WindWalk___WindWalk_R takes integer e returns nothing
            ...
            function s__WindWalk___WindWalk_anon__56 takes integer dash returns nothing
                ...
                set s__Dash_onMove[dash1]=(63)
                set s__Dash_onEnd[dash1]=(64)
            endfunction
        ...
        function s__WindWalk___WindWalk_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00M' , (77))
            call s__Spell_On(s__Spell_onSpell , 'A00L' , (78))
            call s__Spell_On(s__Spell_onSpell , 'A00J' , (79))
            call s__Spell_On(s__Spell_onSpell , 'A00K' , (80))
            call s__Spell_On(s__Spell_onReady , 'A00K' , (81))
            call s__Spell_On(s__Spell_onStop , 'A00K' , (82))
            call s__Spell_On(s__Spell_onReady , 'A00M' , (81))
            call s__Spell_On(s__Spell_onStop , 'A00M' , (82))
        endfunction
...
//library ZZ:
        ...
        function s__ZZ___ZZ_W takes integer e returns nothing
            ...
            set dash=s__Dash_Start(s__Units_unit[u] , s__Spell_Angle[e] , 1000 , s__Dash_ADD , 70 , true , false)
            set s__Dash_Obj[dash]=e
            set s__Dash_onMove[dash]=(87)
            set s__Dash_onEnd[dash]=(88)
        endfunction
        ...
        function s__ZZ___ZZ_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00S' , (89))
            call s__Spell_On(s__Spell_onSpell , 'A00R' , (90))
            call s__Spell_On(s__Spell_onSpell , 'A00P' , (91))
            call s__Spell_On(s__Spell_onSpell , 'A00O' , (92))
            call s__Spell_On(s__Spell_onStart , 'A00O' , (93))
            call s__Spell_On(s__Spell_onStop , 'A00O' , (94))
            call s__Spell_On(s__Spell_onStart , 'A00R' , (93))
            call s__Spell_On(s__Spell_onStop , 'A00R' , (94))
            call s__Spell_On(s__Spell_onStart , 'A00S' , (93))
            call s__Spell_On(s__Spell_onStop , 'A00S' , (94))
        endfunction
...
call ExecuteFunc("jasshelper__initstructs137311921")
...
function sa___prototype1_s__BlackSaber___BlackSaber_anon__77 takes nothing returns boolean
...
function sa___prototype45_s__DazzleMaster__DazzleMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype45_s__DazzleMaster__DazzleMaster_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function jasshelper__initstructs137311921 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype1[16],function sa___prototype1_s__BlackSaber___BlackSaber_anon__77)
    call TriggerAddCondition(st___prototype1[16],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__77))
    set st___prototype1[17]=CreateTrigger()
    call TriggerAddAction(st___prototype1[17],function sa___prototype1_s__BlackSaber___BlackSaber_anon__79)
    call TriggerAddCondition(st___prototype1[17],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__79))
    set st___prototype1[18]=CreateTrigger()
    call TriggerAddAction(st___prototype1[18],function sa___prototype1_s__BlackSaber___BlackSaber_anon__81)
    call TriggerAddCondition(st___prototype1[18],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__81))
    ...
    call TriggerAddAction(st___prototype1[20],function sa___prototype1_s__BlackSaber___BlackSaber_anon__83)
    call TriggerAddCondition(st___prototype1[20],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__83))
    set st___prototype1[21]=CreateTrigger()
    call TriggerAddAction(st___prototype1[21],function sa___prototype1_s__BlackSaber___BlackSaber_anon__84)
    call TriggerAddCondition(st___prototype1[21],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__84))
    set st___prototype1[22]=CreateTrigger()
    call TriggerAddAction(st___prototype1[22],function sa___prototype1_s__BlackSaber___BlackSaber_R)
    call TriggerAddCondition(st___prototype1[22],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_R))
    set st___prototype1[23]=CreateTrigger()
    call TriggerAddAction(st___prototype1[23],function sa___prototype1_s__BlackSaber___BlackSaber_Q)
    call TriggerAddCondition(st___prototype1[23],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_Q))
    set st___prototype1[24]=CreateTrigger()
    call TriggerAddAction(st___prototype1[24],function sa___prototype1_s__BlackSaber___BlackSaber_W)
    call TriggerAddCondition(st___prototype1[24],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_W))
    set st___prototype1[25]=CreateTrigger()
    call TriggerAddAction(st___prototype1[25],function sa___prototype1_s__BlackSaber___BlackSaber_E)
    call TriggerAddCondition(st___prototype1[25],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_E))
    set st___prototype1[26]=CreateTrigger()
    call TriggerAddAction(st___prototype1[26],function sa___prototype1_s__BlackSaber___BlackSaber_HERO_START)
    call TriggerAddCondition(st___prototype1[26],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_HERO_START))
    set st___prototype1[27]=CreateTrigger()
    call TriggerAddAction(st___prototype1[27],function sa___prototype1_s__BlackSaber___BlackSaber_HERO_STOP)
    call TriggerAddCondition(st___prototype1[27],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_HERO_STOP))
    ...
    call TriggerAddAction(st___prototype1[28],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__36)
    call TriggerAddCondition(st___prototype1[28],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__36))
    set st___prototype1[29]=CreateTrigger()
    call TriggerAddAction(st___prototype1[29],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__37)
    call TriggerAddCondition(st___prototype1[29],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__37))
    ...
    call TriggerAddAction(st___prototype1[31],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__43)
    call TriggerAddCondition(st___prototype1[31],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__43))
    set st___prototype1[32]=CreateTrigger()
    call TriggerAddAction(st___prototype1[32],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__44)
    call TriggerAddCondition(st___prototype1[32],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__44))
    ...
    call TriggerAddAction(st___prototype1[40],function sa___prototype1_s__DazzleMaster__DazzleMaster_D)
    call TriggerAddCondition(st___prototype1[40],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_D))
    set st___prototype1[41]=CreateTrigger()
    call TriggerAddAction(st___prototype1[41],function sa___prototype1_s__DazzleMaster__DazzleMaster_Q)
    call TriggerAddCondition(st___prototype1[41],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_Q))
    set st___prototype1[42]=CreateTrigger()
    call TriggerAddAction(st___prototype1[42],function sa___prototype1_s__DazzleMaster__DazzleMaster_W)
    call TriggerAddCondition(st___prototype1[42],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_W))
    set st___prototype1[43]=CreateTrigger()
    call TriggerAddAction(st___prototype1[43],function sa___prototype1_s__DazzleMaster__DazzleMaster_E)
    call TriggerAddCondition(st___prototype1[43],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_E))
    set st___prototype1[44]=CreateTrigger()
    call TriggerAddAction(st___prototype1[44],function sa___prototype1_s__DazzleMaster__DazzleMaster_R)
    call TriggerAddCondition(st___prototype1[44],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_R))
    set st___prototype1[45]=CreateTrigger()
    call TriggerAddAction(st___prototype1[45],function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_START)
    call TriggerAddCondition(st___prototype1[45],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_START))
    set st___prototype1[46]=CreateTrigger()
    call TriggerAddAction(st___prototype1[46],function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_STOP)
    call TriggerAddCondition(st___prototype1[46],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_STOP))
    set st___prototype1[47]=CreateTrigger()
    call TriggerAddAction(st___prototype1[47],function sa___prototype1_s__DazzleMaster__DazzleMaster_Attack)
    call TriggerAddCondition(st___prototype1[47],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_Attack))
    set st___prototype45[2]=CreateTrigger()
    call TriggerAddAction(st___prototype45[2],function sa___prototype45_s__DazzleMaster__DazzleMaster_Spawn)
    call TriggerAddCondition(st___prototype45[2],Condition(function sa___prototype45_s__DazzleMaster__DazzleMaster_Spawn))
    set st___prototype45[3]=CreateTrigger()
    call TriggerAddAction(st___prototype45[3],function sa___prototype45_s__DazzleMaster__DazzleMaster_Death)
    call TriggerAddCondition(st___prototype45[3],Condition(function sa___prototype45_s__DazzleMaster__DazzleMaster_Death))
    ...
    call TriggerAddAction(st___prototype1[48],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__28)
    call TriggerAddCondition(st___prototype1[48],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__28))
    set st___prototype1[49]=CreateTrigger()
    call TriggerAddAction(st___prototype1[49],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__29)
    call TriggerAddCondition(st___prototype1[49],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__29))
    set st___prototype1[50]=CreateTrigger()
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31))
    set st___prototype1[51]=CreateTrigger()
    call TriggerAddAction(st___prototype1[51],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__32)
    call TriggerAddCondition(st___prototype1[51],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__32))
    set st___prototype1[52]=CreateTrigger()
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__33)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__33))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__34)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__34))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START))
    set st___prototype1[58]=CreateTrigger()
    call TriggerAddAction(st___prototype1[58],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[58],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP))
    set st___prototype45[4]=CreateTrigger()
    call TriggerAddAction(st___prototype45[4],function sa___prototype45_s__OrdinaryWizard__OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype45[4],Condition(function sa___prototype45_s__OrdinaryWizard__OrdinaryWizard_E))
    set st___prototype1[59]=CreateTrigger()
    call TriggerAddAction(st___prototype1[59],function sa___prototype1_s__WindWalk___WindWalk_anon__53)
    call TriggerAddCondition(st___prototype1[59],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__53))
    set st___prototype1[60]=CreateTrigger()
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__WindWalk___WindWalk_anon__54)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__54))
    set st___prototype1[61]=CreateTrigger()
    call TriggerAddAction(st___prototype1[61],function sa___prototype1_s__WindWalk___WindWalk_anon__52)
    call TriggerAddCondition(st___prototype1[61],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__52))
    set st___prototype1[62]=CreateTrigger()
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__WindWalk___WindWalk_anon__55)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__55))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__WindWalk___WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__57))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__WindWalk___WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__58))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__WindWalk___WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__56))
    set st___prototype1[66]=CreateTrigger()
    call TriggerAddAction(st___prototype1[66],function sa___prototype1_s__WindWalk___WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[66],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__62))
    set st___prototype1[67]=CreateTrigger()
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__WindWalk___WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__63))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__WindWalk___WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__59))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__WindWalk___WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__60))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__WindWalk___WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__61))
    set st___prototype1[71]=CreateTrigger()
    call TriggerAddAction(st___prototype1[71],function sa___prototype1_s__WindWalk___WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[71],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__67))
    set st___prototype1[72]=CreateTrigger()
    call TriggerAddAction(st___prototype1[72],function sa___prototype1_s__WindWalk___WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[72],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__68))
    set st___prototype1[73]=CreateTrigger()
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__WindWalk___WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__66))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__WindWalk___WindWalk_anon__69)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__69))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__WindWalk___WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__64))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__WindWalk___WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__65))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__WindWalk___WindWalk_R)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__WindWalk___WindWalk_R))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__WindWalk___WindWalk_E)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__WindWalk___WindWalk_E))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__WindWalk___WindWalk_Q)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__WindWalk___WindWalk_Q))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__WindWalk___WindWalk_W)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__WindWalk___WindWalk_W))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__WindWalk___WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_START))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP))
    set st___prototype1[83]=CreateTrigger()
    call TriggerAddAction(st___prototype1[83],function sa___prototype1_s__ZZ___ZZ_anon__71)
    call TriggerAddCondition(st___prototype1[83],Condition(function sa___prototype1_s__ZZ___ZZ_anon__71))
    set st___prototype1[84]=CreateTrigger()
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__ZZ___ZZ_anon__72)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__ZZ___ZZ_anon__72))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__ZZ___ZZ_anon__70)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__ZZ___ZZ_anon__70))
    set st___prototype1[86]=CreateTrigger()
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__ZZ___ZZ_anon__73)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__ZZ___ZZ_anon__73))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__ZZ___ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__ZZ___ZZ_anon__75))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__ZZ___ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__ZZ___ZZ_anon__76))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__ZZ___ZZ_R)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__ZZ___ZZ_R))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__ZZ___ZZ_E)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__ZZ___ZZ_E))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__ZZ___ZZ_W)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__ZZ___ZZ_W))
    set st___prototype1[92]=CreateTrigger()
    call TriggerAddAction(st___prototype1[92],function sa___prototype1_s__ZZ___ZZ_Q)
    call TriggerAddCondition(st___prototype1[92],Condition(function sa___prototype1_s__ZZ___ZZ_Q))
    set st___prototype1[93]=CreateTrigger()
    call TriggerAddAction(st___prototype1[93],function sa___prototype1_s__ZZ___ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[93],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_START))
    set st___prototype1[94]=CreateTrigger()
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__ZZ___ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_STOP))
    set st___prototype45[5]=CreateTrigger()
    call TriggerAddAction(st___prototype45[5],function sa___prototype45_s__Respawn__Respawn_Death)
    call TriggerAddCondition(st___prototype45[5],Condition(function sa___prototype45_s__Respawn__Respawn_Death))
