...
constant integer si__SoundUtils__soundhelper=24
...
constant integer si__SoundUtils__soundrecycler=25
...
constant integer si__PlayerPress=29
...
constant integer si__MR___MR=42
...
constant integer si__Respawn__Respawn=48
...
function sc___prototype35_execute takes integer i,unit a1,integer a2 returns nothing
    set f__arg_unit1=a1
    set f__arg_integer1=a2

    call TriggerExecute(st___prototype35[i])
endfunction
function sc___prototype35_evaluate takes integer i,unit a1,integer a2 returns nothing
    set f__arg_unit1=a1
    set f__arg_integer1=a2
...
function sc___prototype36_execute takes integer i,player a1,string a2 returns nothing
    set f__arg_player1=a1
    set f__arg_string1=a2

    call TriggerExecute(st___prototype36[i])
endfunction
function sc___prototype36_evaluate takes integer i,player a1,string a2 returns nothing
    set f__arg_player1=a1
    set f__arg_string1=a2
...
function sc___prototype47_execute takes integer i,integer a1,integer a2 returns nothing
    set f__arg_integer1=a1
    set f__arg_integer2=a2

    call TriggerExecute(st___prototype47[i])
endfunction
function sc___prototype47_evaluate takes integer i,integer a1,integer a2 returns nothing
    set f__arg_integer1=a1
    set f__arg_integer2=a2
...
function sc___prototype55_execute takes integer i,integer a1,unit a2,integer a3,integer a4,real a5 returns nothing
    set f__arg_integer1=a1
    set f__arg_unit1=a2
...
function sc___prototype55_evaluate takes integer i,integer a1,unit a2,integer a3,integer a4,real a5 returns nothing
    set f__arg_integer1=a1
    set f__arg_unit1=a2
    set f__arg_integer2=a3
    set f__arg_integer3=a4
...
//library BuyStrAgiInt:
    ...
    function BuyStrAgiInt__Buy takes integer e returns nothing
        ...
        if ( GetItemType(s__EventArgs_BuyItem[e]) == ITEM_TYPE_PERMANENT ) then
            ...
            call DisplayTimedTextFromPlayer(s__Players_player[p], 0, 0, 5, "属性转换完成~！现在的属性是: 力量(" + I2S((GetHeroStr(s__Units_unit[s__Players_hero[s__Units_player[(s__Players_hero[p])]]], (true)))) + ")  敏捷(" + I2S((GetHeroAgi(s__Units_unit[s__Players_hero[s__Units_player[(s__Players_hero[p])]]], (true)))) + ")   智力(" + I2S((GetHeroInt(s__Units_unit[s__Players_hero[s__Units_player[(s__Players_hero[p])]]], (true)))) + ")") // INLINED!!
        endif
    endfunction
        ...
        //public:  //总持续时间
            ...
            function s__Buffs_Trigger takes string eName,unit u,integer m returns nothing
                ...
                exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                    ...
                    call sc___prototype35_evaluate(callback,u , m)
                set i=i + 1
                endloop
            endfunction
...
//library BuffUI:
        ...
        function s__BuffUI_Move takes integer this,real x,real y returns nothing
            ...
            function s__BuffUI_anon__31 takes nothing returns nothing
        ...
        function s__BuffUI_RegBuff takes integer id returns nothing
            ...
            if ( s__Players_localplayer == s__Players_localplayer ) then
                call DzFrameSetScriptByCode(s__BuffUI_BuffUIButton[b], 1, function s__BuffUI_anon__29, false)
                call DzFrameSetScriptByCode(s__BuffUI_BuffUIButton[b], 2, function s__BuffUI_anon__30, false)
                call DzFrameSetScriptByCode(s__BuffUI_BuffUIButton[b], 3, function s__BuffUI_anon__31, false)
            endif
...
//processed:     function interface Press__PressSnycEventInterface takes player arg0, string arg1 returns nothing  //主要用于同步玩家的按键 //网易提供的事件延迟太高了 //改为使用YDWE-LUA引擎的message.hook+GC实现
        function s__Press_TriggerSnyc takes string eName,player n,string keyName returns nothing
            ...
            exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                set callback=((LoadInteger(Table__ht, (((- StringHash((eName))))), (i)))) // INLINED!!
                call sc___prototype36_evaluate(callback,n , keyName)
            set i=i + 1
            endloop
        endfunction
        ...
        function Press__anon__0 takes nothing returns nothing
    ...
    function GCSnyc takes nothing returns nothing
        call ForForce(Teams__AllPlayers, (function Press__anon__0)) // INLINED!!
    endfunction
...
//library Disconnect:
    ...
    function Disconnect__onDisconnect takes integer e returns nothing
        ...
        local unit u
        local timer t
        set Disconnect__tmp=(LoadInteger(Table__ht, ((s__Players_ht)), GetHandleId(((s__EventArgs_TriggerPlayer[e]))))) // INLINED!!
        ...
        if ( x != 0 ) then
            call ForForce((s__Teams__Team_Players[GetPlayerTeam((s__Players_player[Disconnect__tmp]))]), function Disconnect__anon__17) // INLINED!!
        endif
        call s__Teams_PlayerRemoveForce(s__Players_player[Disconnect__tmp])
        call DisplayTimedTextToForce((Teams__AllPlayers), 5.00, s__Players_name[Disconnect__tmp] + " 离开了游戏，金钱将平分给他的队友。") // INLINED!!
...
//library LevelUp:
        ...
        function LevelUp__anon__25 takes nothing returns nothing
            local integer p=(LoadInteger(Table__ht, ((s__Players_ht)), GetHandleId(((GetEnumPlayer()))))) // INLINED!!
    ...
    function LevelUp__LvUp takes integer e returns nothing
        ...
        if ( lv > LevelUp__MaxLv ) then
            ...
            call ForForce((Teams__AllPlayers), function LevelUp__anon__25) // INLINED!!
        endif
...
//processed:     function interface Units__UnitsEventInterface takes Units arg0, Units arg1 returns nothing  //单位基础类 //管理单位身上的集合数据,创建单位用该类函数,杀死单位也是 //以及单位事件
        ...
        //public:  //自定义事件
            function s__Units_Trigger takes string eName,unit u,unit m returns nothing
                ...
                exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                    set callback=((LoadInteger(Table__ht, (((- StringHash((eName))))), (i)))) // INLINED!!
                    call sc___prototype47_evaluate(callback,sc__Units_Get(u) , sc__Units_Get(m))
                set i=i + 1
                endloop
            endfunction
...
//library Groups:
    ...
    function GroupIsAliveAloc takes nothing returns boolean
        return (GetUnitAbilityLevel(GetFilterUnit(), 'Aloc') == 1) and (IsUnitAliveBJ(GetFilterUnit())) // INLINED!!
    endfunction
    function GroupIsAliveNotAloc takes nothing returns boolean
        return (GetUnitAbilityLevel(GetFilterUnit(), 'Aloc') == 0) and (IsUnitAliveBJ(GetFilterUnit())) and not ( (IsUnitType(GetFilterUnit(), UNIT_TYPE_STRUCTURE)) ) // INLINED!!
    endfunction
    function GroupFirst takes group g returns unit
        ...
        exitwhen ( FirstOfGroup(Groups__tmp_create_group) == null )
            set tmp=(LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((FirstOfGroup(Groups__tmp_create_group)))))) // INLINED!!
    ...
    function GroupDamage takes integer u,real x,real y,real dis,real dmg,integer dmgtype,integer aid,boolean hero returns nothing
        ...
        exitwhen ( FirstOfGroup(Groups__tmp_damage_group) == null )
            set tmp=(LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((FirstOfGroup(Groups__tmp_damage_group)))))) // INLINED!!
            set f=false
...
//library Winner:
        ...
        function s__Winner_Death takes integer u,integer m returns nothing
            ...
            if ( s__Players_hero[s__Units_player[m]] != null ) then
                ...
                if ( (s__Teams__Team_Kills[(s__Players_teamid[s__Units_player[m]])]) >= s__Winner_MaxKills ) then // INLINED!!
                    ...
                    call DisplayTimedTextToForce((Teams__AllPlayers), 5.00, "游戏结束啦！！！！！！！！！！！ " + (s__Teams__Team_Name[(s__Players_teamid[s__Units_player[m]])]) + " 获得了最终的胜利！！") // INLINED!!
        ...
        function s__Winner_ShowWin takes integer teamid returns nothing
            ...
            call ForForce((Teams__AllPlayers), function s__Winner_anon__18) // INLINED!!
        endfunction
...
//processed:     function interface Ai__AiEventInterface takes unit arg0 returns nothing  //非玩家英雄的自动施法、移动类 //对于没有实现AI接口的英雄 //点目标技能会在1000码内释放 //无目标技能会在400码内释放 //相同的顺序，无目标和点目标有2套命令串顺序 //在调整施法顺序的时候将对应的命令串填入即可 // 点目标：curse - dispel - charm  - channel -  doom     // 无目标: heal  -  hex   - impale - inferno - instant
    function Ai__AISpell takes unit ua returns nothing
        ...
        if ( mps > 0.2 ) then
            ...
            call IssuePointOrder(s__Units_unit[u], "attack", GetRectCenterX((s__Teams__Team_Rect[GetPlayerTeam((s__Players_player[s__Units_player[u]]))])), GetRectCenterY((s__Teams__Team_Rect[GetPlayerTeam((s__Players_player[s__Units_player[u]]))]))) // INLINED!!
        endif
        ...
        function Ai__anon__28 takes nothing returns nothing
            local integer p=(LoadInteger(Table__ht, ((s__Players_ht)), GetHandleId(((GetEnumPlayer()))))) // INLINED!!
    ...
    function Ai__onLoop takes nothing returns nothing
        call ForForce((Teams__AllPlayers), function Ai__anon__28) // INLINED!!
    endfunction
...
//library DazzleMaster:
        ...
        function s__DazzleMaster___DazzleMaster_AI takes unit ua returns nothing
            ...
            function s__DazzleMaster___DazzleMaster_anon__39 takes nothing returns nothing
                local integer data=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer tmp
                local real h=0
        ...
        function s__DazzleMaster___DazzleMaster_Spawn takes integer u,integer m returns nothing
            ...
            if ( (GetUnitAbilityLevel(s__Units_unit[(u)], ('A008')) > 0) == true ) then // INLINED!!
                ...
                set s__TimerUtils__data[GetHandleId((t )) - TimerUtils__VOFFSET]= ( data) // INLINED!!
                call TimerStart(t, 0.01, true, function s__DazzleMaster___DazzleMaster_anon__39)
                set t=null
            endif
        endfunction
        ...
        function s__DazzleMaster___DazzleMaster_HERO_STOP takes integer e returns nothing
            ...
            function s__DazzleMaster___DazzleMaster_anon__40 takes integer b returns nothing
        ...
        function s__DazzleMaster___DazzleMaster_D takes integer e returns nothing
            ...
            call s__Spell_Destroy(e)
                ...
                function s__DazzleMaster___DazzleMaster_anon__44 takes nothing returns nothing
                    local integer data=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                    local integer u=(s___Data_c[s__Data_c[data]])
                    local integer tmp
                    ...
                    if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
                        ...
                        if ( (CountUnitsInGroup((s___Data_g[s__Data_g[data]]))) != 0 ) then // INLINED!!
                            ...
                            call TimerStart(GetExpiredTimer(), 0.02, true, function s__DazzleMaster___DazzleMaster_anon__46)
                        else
                            call DestroyGroup(s___Data_g[s__Data_g[data]])
                            call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                            set s___Data_g[s__Data_g[data]]=null
            ...
            function s__DazzleMaster___DazzleMaster_anon__43 takes nothing returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
                    ...
                    if ( GroupFind(s__Units_unit[u] , x , y , 150 , false , false) != null ) then
                        ...
                        set t=NewTimer()
                        set s__TimerUtils__data[GetHandleId((t )) - TimerUtils__VOFFSET]= ( data) // INLINED!!
                        call TimerStart(t, 0.15, false, function s__DazzleMaster___DazzleMaster_anon__44)
                        set t=null
                        call ReleaseTimer(GetExpiredTimer())
                    else
                        call s__Units_PositionEnabled(u,true)
        ...
        function s__DazzleMaster___DazzleMaster_R takes integer e returns nothing
            ...
            call TimerStart(t, 0.25, false, function s__DazzleMaster___DazzleMaster_anon__43)
            set t=null
        endfunction
            ...
            function s__DazzleMaster___DazzleMaster_anon__49 takes nothing returns nothing
                local integer data=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                local integer mj
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer dash
                if ( s__PlayerPress_E[s__Players_press[s__Units_player[u]]] == true and s___Data_r[s__Data_r[data]] <= 2 and (GetUnitAbilityLevel(s__Units_unit[(u)], ('BPSE')) > 0) == false and (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
        ...
        function s__DazzleMaster___DazzleMaster_E takes integer e returns nothing
            ...
            set s__TimerUtils__data[GetHandleId((t )) - TimerUtils__VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, 0.1, true, function s__DazzleMaster___DazzleMaster_anon__49)
            set t=null
        endfunction
        ...
        function s__DazzleMaster___DazzleMaster_W takes integer e returns nothing
            ...
            function s__DazzleMaster___DazzleMaster_anon__55 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer u=(s___Data_c[s__Data_c[data]])
                call DestroyGroup(s___Data_g[s__Data_g[data]])
                set s___Data_g[s__Data_g[data]]=null
...
//library Init:
    ...
    function Init__onInit takes nothing returns nothing
        ...
        call ForForce(Teams__AllPlayers, (function Init__anon__8)) // INLINED!!
        set i=0 //测试
        loop
        exitwhen ( i > 5 )
...
//library KillUi:
        ...
        function s__KillUi_create takes integer tid,integer index returns integer
            ...
            call ForForce((s__Teams__Team_Players[(tid)]), function s__KillUi_anon__20) // INLINED!!
        ...
        function s__KillUi_FlushKillData takes integer tid returns nothing
            call DzFrameSetText(s__KillUi_KillBackgroundText, " 杀敌数   " + (s__Teams__Team_Name[(0)]) + ":" + I2S((s__Teams__Team_Kills[(0)])) + "    " + (s__Teams__Team_Name[(1)]) + ":" + I2S((s__Teams__Team_Kills[(1)])) + "    " + (s__Teams__Team_Name[(2)]) + ":" + I2S((s__Teams__Team_Kills[(2)])) + "    胜利:" + I2S((s__Winner_MaxKills)) + "    ↓F2↓") // INLINED!!
            if ( tid != - 1 ) then
...
//library OrdinaryWizard:
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__33 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer e=(s___Data_c[s__Data_c[data]])
                local integer u=(LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))) // INLINED!!
                local integer mj
        ...
        function s__OrdinaryWizard___OrdinaryWizard_E takes integer u,integer m returns nothing
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__34 takes nothing returns nothing
                local integer i
        ...
        function s__OrdinaryWizard___OrdinaryWizard_W takes integer e returns nothing
            ...
            endloop
            call GroupClear(tmp_group)
            call TimerStart(t, 0.4, false, function s__OrdinaryWizard___OrdinaryWizard_anon__34)
            set t=null
        endfunction
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__36 takes integer da returns nothing
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__38 takes integer d returns nothing
                local integer i
        ...
        function s__OrdinaryWizard___OrdinaryWizard_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A002' )), ( ( (58)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A004' )), ( ( (59)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A006' )), ( ( (60)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A002' )), ( ( (61)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A002' )), ( ( (62)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A006' )), ( ( (61)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A006' )), ( ( (62)))) // INLINED!!
            call s__Units_On(s__Units_onAlocDeath , (7))
        endfunction
...
//library SL:
                        ...
                        if ( s___Data_i[s__Data_i[data]+3] == 0 ) then
                            ...
                            if ( s___Data_i[s__Data_i[data]+1] == 0 ) then
                                ...
                                if ( (IsUnitAliveBJ(s__Units_unit[(m)])) == true ) then // INLINED!!
                                    ...
                                    set s__Dash_Obj[dash]=data
                                    set s__Dash_onMove[dash]=(69)
                                    set s__Dash_onEnd[dash]=(70)
                                else
            ...
            function s__SL___SL_anon__100 takes integer dash returns nothing
                ...
                if ( s__Dash_Speed[dash] < 4 ) then
                    ...
                    if ( k != null ) then
                        ...
                        set dash1=s__Dash_Start(s__Units_unit[mj] , s__Util_XY(s__Units_unit[u] , k) - 45 , s__Util_XY2(s__Units_unit[u] , k) * 4 , s__Dash_SUB , 60 , true , false)
                        set s__Dash_Obj[dash1]=data
                        set s__Dash_onMove[dash1]=(73)
                        set s__Dash_onEnd[dash1]=(74)
                        set k=null
                    endif
                endif
            endfunction
        ...
        function s__SL___SL_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01B' )), ( ( (77)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01A' )), ( ( (78)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A017' )), ( ( (79)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A018' )), ( ( (80)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A018' )), ( ( (81)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A01B' )), ( ( (81)))) // INLINED!!
        endfunction
...
//library SwordMaster:
                ...
                function s__SwordMaster___SwordMaster_anon__112 takes nothing returns nothing
                    ...
                    elseif ( s___Data_r[s__Data_r[data]+2] == 0 ) then
                        if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == false or (GetUnitAbilityLevel(s__Units_unit[(u)], ('B009')) > 0) == false ) then // INLINED!!
                            ...
                            set s__Dash_onMove[s__Dash_Start(s__Units_unit[u] , (GetUnitFacing(s__Units_unit[(u)])) , 300 , s__Dash_SUB , 10 , true , false)]=(82) // INLINED!!
        ...
        function s__SwordMaster___SwordMaster_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01E' )), ( ( (86)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01D' )), ( ( (87)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01F' )), ( ( (88)))) // INLINED!!
...
//library WindWalk:
            ...
            function s__WindWalk___WindWalk_anon__56 takes integer dash returns nothing
                ...
                if ( k != null ) then
                    ...
                    set s__Dash_Obj[dash1]=data
                    set s__Dash_onMove[dash1]=(89)
                    set s__Dash_onEnd[dash1]=(90)
                endif
                set k=null
                if ( s__Dash_Speed[dash] < 4 ) then
                    call s__Dash_Stop(dash)
        ...
        function s__WindWalk___WindWalk_R takes integer e returns nothing
            ...
            function s__WindWalk___WindWalk_anon__60 takes integer dash returns nothing
                ...
                set s__Dash_onMove[dash1]=(93)
                set s__Dash_onEnd[dash1]=(94)
            endfunction
        ...
        function s__WindWalk___WindWalk_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00M' )), ( ( (107)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00L' )), ( ( (108)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00J' )), ( ( (109)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00K' )), ( ( (110)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00K' )), ( ( (111)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00K' )), ( ( (112)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00M' )), ( ( (111)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00M' )), ( ( (112)))) // INLINED!!
        endfunction

//library WindWalk ends
//library YeG:

            function YeG__anon__27 takes nothing returns boolean
                return GetUnitTypeId(GetFilterUnit()) == 'n001'
            endfunction
        function YeG__anon__26 takes nothing returns nothing
            local integer s
            local location d
            call GroupEnumUnitsInRange(tmp_group, 0, 0, 9999999999, Condition(function YeG__anon__27))
    ...
    function YeG__onInit takes nothing returns nothing
        ...
        call TimerStart(NewTimer(), 20, true, function YeG__anon__26)
    endfunction
...
//library ZZ:
        ...
        function s__ZZ___ZZ_W takes integer e returns nothing
            ...
            set dash=s__Dash_Start(s__Units_unit[u] , s__Spell_Angle[e] , 1000 , s__Dash_ADD , 70 , true , false)
            set s__Dash_Obj[dash]=e
            set s__Dash_onMove[dash]=(117)
            set s__Dash_onEnd[dash]=(118)
        endfunction
        ...
        function s__ZZ___ZZ_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00S' )), ( ( (119)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00R' )), ( ( (120)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00P' )), ( ( (121)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00O' )), ( ( (122)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00O' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00O' )), ( ( (124)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00R' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00R' )), ( ( (124)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00S' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00S' )), ( ( (124)))) // INLINED!!
        endfunction
...
//library NewUI:
    ...
    function NewUI___Reg takes nothing returns nothing
        ...
        call s__BuffUI_RegBuff('B001') //BUFF条
    ...
    function NewUI___onInit takes nothing returns nothing
        ...
        call s__Events_On(s__Events_onPlayerSelectUnit , (125))
    endfunction
...
//library Respawn:
        ...
        function s__Respawn__Respawn_Time takes nothing returns nothing
            call ForForce((Teams__AllPlayers), function s__Respawn__Respawn_anon__23) // INLINED!!
        endfunction
            ...
            if ( s__Players_hero[s__Units_player[u]] != null ) then
                ...
                if ( s__Players_hero[s__Units_player[m]] != null ) then
                    if ( s__Players_teamid[s__Units_player[u]] != s__Players_teamid[s__Units_player[m]] and s__Units_unit[m] != null ) then
                        ...
                        call ForForce((s__Teams__Team_Players[GetPlayerTeam((s__Players_player[s__Units_player[m]]))]), function s__Respawn__Respawn_anon__24) // INLINED!!
                        call DisplayTimedTextToForce((Teams__AllPlayers), 5.00, s__Players_name[s__Units_player[m]] + "与队友 因击杀 " + s__Players_name[s__Units_player[u]] + " 而获得了|cffffcc00$300|r") // INLINED!!
                    ...
                    call DisplayTimedTextToForce((Teams__AllPlayers), 5.00, s__Players_name[s__Units_player[u]] + "死在了野怪的手里...") // INLINED!!
                endif
...
call ExecuteFunc("jasshelper__initstructs1170343937")
...
function sa___prototype47_s__Dash_Death takes nothing returns boolean
...
function sa___prototype36_s__PlayerPress_Down takes nothing returns boolean
 local player ps=f__arg_player1
...
function sa___prototype36_s__PlayerPress_Up takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype55_s__Units_Damage takes nothing returns boolean
...
function sa___prototype47_s__Winner_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype32_s__BlackSaber___BlackSaber_AI takes nothing returns boolean
...
function sa___prototype47_s__BlackSaber___BlackSaber_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__55 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype47_s__DazzleMaster___DazzleMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype47_s__DazzleMaster___DazzleMaster_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype36_s__KillUi_Show takes nothing returns boolean
 local player p=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype36_s__KillUi_Hide takes nothing returns boolean
 local player p=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype47_s__MR___MR_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38 takes nothing returns boolean
 local integer d=f__arg_integer1
...
function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype32_s__SwordMaster___SwordMaster_AI takes nothing returns boolean
...
function sa___prototype47_s__SwordMaster___SwordMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype47_s__Respawn__Respawn_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype36_s__Respawn__Respawn_Press takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype36_s__Respawn__Respawn_PressSnyc takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function jasshelper__initstructs1170343937 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype1[6],function sa___prototype1_BuyNextHero__Buy)
    call TriggerAddCondition(st___prototype1[6],Condition(function sa___prototype1_BuyNextHero__Buy))
    ...
    call TriggerAddAction(st___prototype1[125],function sa___prototype1_NewUI___Select)
    call TriggerAddCondition(st___prototype1[125],Condition(function sa___prototype1_NewUI___Select))
    set st___prototype47[1]=CreateTrigger()
    call TriggerAddAction(st___prototype47[1],function sa___prototype47_s__Dash_Death)
    call TriggerAddCondition(st___prototype47[1],Condition(function sa___prototype47_s__Dash_Death))
    ...
    call TriggerAddAction(st___prototype36[1],function sa___prototype36_s__PlayerPress_Down)
    call TriggerAddCondition(st___prototype36[1],Condition(function sa___prototype36_s__PlayerPress_Down))
    set st___prototype36[2]=CreateTrigger()
    call TriggerAddAction(st___prototype36[2],function sa___prototype36_s__PlayerPress_Up)
    call TriggerAddCondition(st___prototype36[2],Condition(function sa___prototype36_s__PlayerPress_Up))
    set st___prototype55[1]=CreateTrigger()
    call TriggerAddAction(st___prototype55[1],function sa___prototype55_s__Units_Damage)
    call TriggerAddCondition(st___prototype55[1],Condition(function sa___prototype55_s__Units_Damage))
    ...
    call TriggerAddAction(st___prototype47[2],function sa___prototype47_s__Winner_Death)
    call TriggerAddCondition(st___prototype47[2],Condition(function sa___prototype47_s__Winner_Death))
    set st___prototype1[15]=CreateTrigger()
    call TriggerAddAction(st___prototype1[15],function sa___prototype1_s__BlackSaber___BlackSaber_anon__82)
    call TriggerAddCondition(st___prototype1[15],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__82))
    set st___prototype1[16]=CreateTrigger()
    call TriggerAddAction(st___prototype1[16],function sa___prototype1_s__BlackSaber___BlackSaber_anon__85)
    call TriggerAddCondition(st___prototype1[16],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__85))
    set st___prototype1[17]=CreateTrigger()
    call TriggerAddAction(st___prototype1[17],function sa___prototype1_s__BlackSaber___BlackSaber_anon__83)
    call TriggerAddCondition(st___prototype1[17],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__83))
    set st___prototype1[18]=CreateTrigger()
    call TriggerAddAction(st___prototype1[18],function sa___prototype1_s__BlackSaber___BlackSaber_anon__86)
    call TriggerAddCondition(st___prototype1[18],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__86))
    set st___prototype1[19]=CreateTrigger()
    call TriggerAddAction(st___prototype1[19],function sa___prototype1_s__BlackSaber___BlackSaber_anon__88)
    call TriggerAddCondition(st___prototype1[19],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__88))
    set st___prototype1[20]=CreateTrigger()
    call TriggerAddAction(st___prototype1[20],function sa___prototype1_s__BlackSaber___BlackSaber_anon__89)
    call TriggerAddCondition(st___prototype1[20],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__89))
    set st___prototype1[21]=CreateTrigger()
    call TriggerAddAction(st___prototype1[21],function sa___prototype1_s__BlackSaber___BlackSaber_anon__90)
    call TriggerAddCondition(st___prototype1[21],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__90))
    set st___prototype1[22]=CreateTrigger()
    call TriggerAddAction(st___prototype1[22],function sa___prototype1_s__BlackSaber___BlackSaber_anon__91)
    call TriggerAddCondition(st___prototype1[22],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__91))
    set st___prototype32[1]=CreateTrigger()
    call TriggerAddAction(st___prototype32[1],function sa___prototype32_s__BlackSaber___BlackSaber_AI)
    call TriggerAddCondition(st___prototype32[1],Condition(function sa___prototype32_s__BlackSaber___BlackSaber_AI))
    ...
    call TriggerAddAction(st___prototype47[3],function sa___prototype47_s__BlackSaber___BlackSaber_Spawn)
    call TriggerAddCondition(st___prototype47[3],Condition(function sa___prototype47_s__BlackSaber___BlackSaber_Spawn))
    ...
    call TriggerAddAction(st___prototype1[30],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__40)
    call TriggerAddCondition(st___prototype1[30],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__40))
    set st___prototype1[31]=CreateTrigger()
    call TriggerAddAction(st___prototype1[31],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__41)
    call TriggerAddCondition(st___prototype1[31],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__41))
    set st___prototype1[32]=CreateTrigger()
    call TriggerAddAction(st___prototype1[32],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__42)
    call TriggerAddCondition(st___prototype1[32],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__42))
    set st___prototype1[33]=CreateTrigger()
    call TriggerAddAction(st___prototype1[33],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__47)
    call TriggerAddCondition(st___prototype1[33],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__47))
    set st___prototype1[34]=CreateTrigger()
    call TriggerAddAction(st___prototype1[34],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__48)
    call TriggerAddCondition(st___prototype1[34],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__48))
    set st___prototype1[35]=CreateTrigger()
    call TriggerAddAction(st___prototype1[35],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__45)
    call TriggerAddCondition(st___prototype1[35],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__45))
    set st___prototype1[36]=CreateTrigger()
    call TriggerAddAction(st___prototype1[36],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__50)
    call TriggerAddCondition(st___prototype1[36],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__50))
    set st___prototype1[37]=CreateTrigger()
    call TriggerAddAction(st___prototype1[37],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__51)
    call TriggerAddCondition(st___prototype1[37],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__51))
    set st___prototype1[38]=CreateTrigger()
    call TriggerAddAction(st___prototype1[38],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__52)
    call TriggerAddCondition(st___prototype1[38],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__52))
    set st___prototype1[39]=CreateTrigger()
    call TriggerAddAction(st___prototype1[39],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__53)
    call TriggerAddCondition(st___prototype1[39],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__53))
    set st___prototype1[40]=CreateTrigger()
    call TriggerAddAction(st___prototype1[40],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__54)
    call TriggerAddCondition(st___prototype1[40],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__54))
    set st___prototype1[41]=CreateTrigger()
    call TriggerAddAction(st___prototype1[41],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__55)
    call TriggerAddCondition(st___prototype1[41],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__55))
    ...
    call TriggerAddAction(st___prototype47[4],function sa___prototype47_s__DazzleMaster___DazzleMaster_Spawn)
    call TriggerAddCondition(st___prototype47[4],Condition(function sa___prototype47_s__DazzleMaster___DazzleMaster_Spawn))
    set st___prototype47[5]=CreateTrigger()
    call TriggerAddAction(st___prototype47[5],function sa___prototype47_s__DazzleMaster___DazzleMaster_Death)
    call TriggerAddCondition(st___prototype47[5],Condition(function sa___prototype47_s__DazzleMaster___DazzleMaster_Death))
    set st___prototype36[3]=CreateTrigger()
    call TriggerAddAction(st___prototype36[3],function sa___prototype36_s__KillUi_Show)
    call TriggerAddCondition(st___prototype36[3],Condition(function sa___prototype36_s__KillUi_Show))
    set st___prototype36[4]=CreateTrigger()
    call TriggerAddAction(st___prototype36[4],function sa___prototype36_s__KillUi_Hide)
    call TriggerAddCondition(st___prototype36[4],Condition(function sa___prototype36_s__KillUi_Hide))
    set st___prototype1[50]=CreateTrigger()
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__MR___MR_anon__119)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__MR___MR_anon__119))
    ...
    call TriggerAddAction(st___prototype47[6],function sa___prototype47_s__MR___MR_Spawn)
    call TriggerAddCondition(st___prototype47[6],Condition(function sa___prototype47_s__MR___MR_Spawn))
    ...
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38))
    set st___prototype1[58]=CreateTrigger()
    call TriggerAddAction(st___prototype1[58],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[58],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q))
    set st___prototype1[59]=CreateTrigger()
    call TriggerAddAction(st___prototype1[59],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[59],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W))
    set st___prototype1[60]=CreateTrigger()
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R))
    set st___prototype1[61]=CreateTrigger()
    call TriggerAddAction(st___prototype1[61],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[61],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START))
    set st___prototype1[62]=CreateTrigger()
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP))
    set st___prototype47[7]=CreateTrigger()
    call TriggerAddAction(st___prototype47[7],function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype47[7],Condition(function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__SL___SL_anon__93)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__SL___SL_anon__93))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__SL___SL_anon__94)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__SL___SL_anon__94))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__SL___SL_anon__92)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__SL___SL_anon__92))
    set st___prototype1[66]=CreateTrigger()
    call TriggerAddAction(st___prototype1[66],function sa___prototype1_s__SL___SL_anon__96)
    call TriggerAddCondition(st___prototype1[66],Condition(function sa___prototype1_s__SL___SL_anon__96))
    set st___prototype1[67]=CreateTrigger()
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__SL___SL_anon__98)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__SL___SL_anon__98))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__SL___SL_anon__99)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__SL___SL_anon__99))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__SL___SL_anon__107)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__SL___SL_anon__107))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__SL___SL_anon__108)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__SL___SL_anon__108))
    set st___prototype1[71]=CreateTrigger()
    call TriggerAddAction(st___prototype1[71],function sa___prototype1_s__SL___SL_anon__101)
    call TriggerAddCondition(st___prototype1[71],Condition(function sa___prototype1_s__SL___SL_anon__101))
    set st___prototype1[72]=CreateTrigger()
    call TriggerAddAction(st___prototype1[72],function sa___prototype1_s__SL___SL_anon__102)
    call TriggerAddCondition(st___prototype1[72],Condition(function sa___prototype1_s__SL___SL_anon__102))
    set st___prototype1[73]=CreateTrigger()
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__SL___SL_anon__104)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__SL___SL_anon__104))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__SL___SL_anon__105)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__SL___SL_anon__105))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__SL___SL_anon__100)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__SL___SL_anon__100))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__SL___SL_anon__109)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__SL___SL_anon__109))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__SL___SL_R)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__SL___SL_R))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__SL___SL_E)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__SL___SL_E))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__SL___SL_Q)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__SL___SL_Q))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__SL___SL_W)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__SL___SL_W))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__SL___SL_HERO_START)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__SL___SL_HERO_START))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__SwordMaster___SwordMaster_anon__113)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__113))
    set st___prototype1[83]=CreateTrigger()
    call TriggerAddAction(st___prototype1[83],function sa___prototype1_s__SwordMaster___SwordMaster_anon__114)
    call TriggerAddCondition(st___prototype1[83],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__114))
    set st___prototype1[84]=CreateTrigger()
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__SwordMaster___SwordMaster_anon__115)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__115))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__SwordMaster___SwordMaster_anon__117)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__117))
    set st___prototype32[3]=CreateTrigger()
    call TriggerAddAction(st___prototype32[3],function sa___prototype32_s__SwordMaster___SwordMaster_AI)
    call TriggerAddCondition(st___prototype32[3],Condition(function sa___prototype32_s__SwordMaster___SwordMaster_AI))
    set st___prototype1[86]=CreateTrigger()
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__SwordMaster___SwordMaster_W)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_W))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__SwordMaster___SwordMaster_E)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_E))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__SwordMaster___SwordMaster_R)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_R))
    set st___prototype47[8]=CreateTrigger()
    call TriggerAddAction(st___prototype47[8],function sa___prototype47_s__SwordMaster___SwordMaster_Spawn)
    call TriggerAddCondition(st___prototype47[8],Condition(function sa___prototype47_s__SwordMaster___SwordMaster_Spawn))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__WindWalk___WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__57))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__WindWalk___WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__58))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__WindWalk___WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__56))
    set st___prototype1[92]=CreateTrigger()
    call TriggerAddAction(st___prototype1[92],function sa___prototype1_s__WindWalk___WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[92],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__59))
    set st___prototype1[93]=CreateTrigger()
    call TriggerAddAction(st___prototype1[93],function sa___prototype1_s__WindWalk___WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[93],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__61))
    set st___prototype1[94]=CreateTrigger()
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__WindWalk___WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__62))
    set st___prototype1[95]=CreateTrigger()
    call TriggerAddAction(st___prototype1[95],function sa___prototype1_s__WindWalk___WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[95],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__60))
    set st___prototype1[96]=CreateTrigger()
    call TriggerAddAction(st___prototype1[96],function sa___prototype1_s__WindWalk___WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[96],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__66))
    set st___prototype1[97]=CreateTrigger()
    call TriggerAddAction(st___prototype1[97],function sa___prototype1_s__WindWalk___WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[97],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__67))
    set st___prototype1[98]=CreateTrigger()
    call TriggerAddAction(st___prototype1[98],function sa___prototype1_s__WindWalk___WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[98],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__63))
    set st___prototype1[99]=CreateTrigger()
    call TriggerAddAction(st___prototype1[99],function sa___prototype1_s__WindWalk___WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[99],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__64))
    set st___prototype1[100]=CreateTrigger()
    call TriggerAddAction(st___prototype1[100],function sa___prototype1_s__WindWalk___WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[100],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__65))
    set st___prototype1[101]=CreateTrigger()
    call TriggerAddAction(st___prototype1[101],function sa___prototype1_s__WindWalk___WindWalk_anon__71)
    call TriggerAddCondition(st___prototype1[101],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__71))
    set st___prototype1[102]=CreateTrigger()
    call TriggerAddAction(st___prototype1[102],function sa___prototype1_s__WindWalk___WindWalk_anon__72)
    call TriggerAddCondition(st___prototype1[102],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__72))
    set st___prototype1[103]=CreateTrigger()
    call TriggerAddAction(st___prototype1[103],function sa___prototype1_s__WindWalk___WindWalk_anon__70)
    call TriggerAddCondition(st___prototype1[103],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__70))
    set st___prototype1[104]=CreateTrigger()
    call TriggerAddAction(st___prototype1[104],function sa___prototype1_s__WindWalk___WindWalk_anon__73)
    call TriggerAddCondition(st___prototype1[104],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__73))
    set st___prototype1[105]=CreateTrigger()
    call TriggerAddAction(st___prototype1[105],function sa___prototype1_s__WindWalk___WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[105],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__68))
    ...
    call TriggerAddAction(st___prototype1[107],function sa___prototype1_s__WindWalk___WindWalk_R)
    call TriggerAddCondition(st___prototype1[107],Condition(function sa___prototype1_s__WindWalk___WindWalk_R))
    set st___prototype1[108]=CreateTrigger()
    call TriggerAddAction(st___prototype1[108],function sa___prototype1_s__WindWalk___WindWalk_E)
    call TriggerAddCondition(st___prototype1[108],Condition(function sa___prototype1_s__WindWalk___WindWalk_E))
    set st___prototype1[109]=CreateTrigger()
    call TriggerAddAction(st___prototype1[109],function sa___prototype1_s__WindWalk___WindWalk_Q)
    call TriggerAddCondition(st___prototype1[109],Condition(function sa___prototype1_s__WindWalk___WindWalk_Q))
    set st___prototype1[110]=CreateTrigger()
    call TriggerAddAction(st___prototype1[110],function sa___prototype1_s__WindWalk___WindWalk_W)
    call TriggerAddCondition(st___prototype1[110],Condition(function sa___prototype1_s__WindWalk___WindWalk_W))
    set st___prototype1[111]=CreateTrigger()
    call TriggerAddAction(st___prototype1[111],function sa___prototype1_s__WindWalk___WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[111],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_START))
    set st___prototype1[112]=CreateTrigger()
    call TriggerAddAction(st___prototype1[112],function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[112],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP))
    set st___prototype1[113]=CreateTrigger()
    call TriggerAddAction(st___prototype1[113],function sa___prototype1_s__ZZ___ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[113],Condition(function sa___prototype1_s__ZZ___ZZ_anon__75))
    set st___prototype1[114]=CreateTrigger()
    call TriggerAddAction(st___prototype1[114],function sa___prototype1_s__ZZ___ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[114],Condition(function sa___prototype1_s__ZZ___ZZ_anon__76))
    set st___prototype1[115]=CreateTrigger()
    call TriggerAddAction(st___prototype1[115],function sa___prototype1_s__ZZ___ZZ_anon__74)
    call TriggerAddCondition(st___prototype1[115],Condition(function sa___prototype1_s__ZZ___ZZ_anon__74))
    set st___prototype1[116]=CreateTrigger()
    call TriggerAddAction(st___prototype1[116],function sa___prototype1_s__ZZ___ZZ_anon__77)
    call TriggerAddCondition(st___prototype1[116],Condition(function sa___prototype1_s__ZZ___ZZ_anon__77))
    set st___prototype1[117]=CreateTrigger()
    call TriggerAddAction(st___prototype1[117],function sa___prototype1_s__ZZ___ZZ_anon__79)
    call TriggerAddCondition(st___prototype1[117],Condition(function sa___prototype1_s__ZZ___ZZ_anon__79))
    set st___prototype1[118]=CreateTrigger()
    call TriggerAddAction(st___prototype1[118],function sa___prototype1_s__ZZ___ZZ_anon__80)
    call TriggerAddCondition(st___prototype1[118],Condition(function sa___prototype1_s__ZZ___ZZ_anon__80))
    set st___prototype1[119]=CreateTrigger()
    call TriggerAddAction(st___prototype1[119],function sa___prototype1_s__ZZ___ZZ_R)
    call TriggerAddCondition(st___prototype1[119],Condition(function sa___prototype1_s__ZZ___ZZ_R))
    set st___prototype1[120]=CreateTrigger()
    call TriggerAddAction(st___prototype1[120],function sa___prototype1_s__ZZ___ZZ_E)
    call TriggerAddCondition(st___prototype1[120],Condition(function sa___prototype1_s__ZZ___ZZ_E))
    set st___prototype1[121]=CreateTrigger()
    call TriggerAddAction(st___prototype1[121],function sa___prototype1_s__ZZ___ZZ_W)
    call TriggerAddCondition(st___prototype1[121],Condition(function sa___prototype1_s__ZZ___ZZ_W))
    set st___prototype1[122]=CreateTrigger()
    call TriggerAddAction(st___prototype1[122],function sa___prototype1_s__ZZ___ZZ_Q)
    call TriggerAddCondition(st___prototype1[122],Condition(function sa___prototype1_s__ZZ___ZZ_Q))
    set st___prototype1[123]=CreateTrigger()
    call TriggerAddAction(st___prototype1[123],function sa___prototype1_s__ZZ___ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[123],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_START))
    set st___prototype1[124]=CreateTrigger()
    call TriggerAddAction(st___prototype1[124],function sa___prototype1_s__ZZ___ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[124],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_STOP))
    set st___prototype47[9]=CreateTrigger()
    call TriggerAddAction(st___prototype47[9],function sa___prototype47_s__Respawn__Respawn_Death)
    call TriggerAddCondition(st___prototype47[9],Condition(function sa___prototype47_s__Respawn__Respawn_Death))
    set st___prototype36[5]=CreateTrigger()
    call TriggerAddAction(st___prototype36[5],function sa___prototype36_s__Respawn__Respawn_Press)
    call TriggerAddCondition(st___prototype36[5],Condition(function sa___prototype36_s__Respawn__Respawn_Press))
    set st___prototype36[6]=CreateTrigger()
    call TriggerAddAction(st___prototype36[6],function sa___prototype36_s__Respawn__Respawn_PressSnyc)
    call TriggerAddCondition(st___prototype36[6],Condition(function sa___prototype36_s__Respawn__Respawn_PressSnyc))
