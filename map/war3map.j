...
constant integer si__SoundUtils__soundhelper=23
...
constant integer si__SoundUtils__soundrecycler=24
...
constant integer si__PlayerPress=31
...
constant integer si__Winner=32
...
constant integer si__BlackSaber___BlackSaber=33
...
constant integer si__DazzleMaster___DazzleMaster=34
...
constant integer si__KillUi=35
...
constant integer si__MR__MR=42
integer si__MR__MR_F=0
integer si__MR__MR_I=0
integer array si__MR__MR_V
constant integer si__OrdinaryWizard___OrdinaryWizard=43
...
constant integer si__SL___SL=44
integer si__SL___SL_F=0
integer si__SL___SL_I=0
integer array si__SL___SL_V
constant integer si__SwordMaster___SwordMaster=45
...
function sc___prototype33_execute takes integer i,unit a1 returns nothing
    set f__arg_unit1=a1

    call TriggerExecute(st___prototype33[i])
endfunction
function sc___prototype33_evaluate takes integer i,unit a1 returns nothing
    set f__arg_unit1=a1

    call TriggerEvaluate(st___prototype33[i])

endfunction
function sc___prototype36_execute takes integer i,unit a1,integer a2 returns nothing
    set f__arg_unit1=a1
    set f__arg_integer1=a2

    call TriggerExecute(st___prototype36[i])
endfunction
function sc___prototype36_evaluate takes integer i,unit a1,integer a2 returns nothing
    set f__arg_unit1=a1
    set f__arg_integer1=a2
...
function sc___prototype37_execute takes integer i,sound a1,boolean a2,boolean a3 returns nothing
...
function sc___prototype37_evaluate takes integer i,sound a1,boolean a2,boolean a3 returns nothing
    set f__arg_sound1=a1
    set f__arg_boolean1=a2
    set f__arg_boolean2=a3
...
function sc___prototype47_execute takes integer i,player a1,string a2 returns nothing
    set f__arg_player1=a1
    set f__arg_string1=a2

    call TriggerExecute(st___prototype47[i])
endfunction
function sc___prototype47_evaluate takes integer i,player a1,string a2 returns nothing
    set f__arg_player1=a1
    set f__arg_string1=a2
...
function sc___prototype48_execute takes integer i,integer a1,integer a2 returns nothing
    set f__arg_integer1=a1
    set f__arg_integer2=a2

    call TriggerExecute(st___prototype48[i])
endfunction
function sc___prototype48_evaluate takes integer i,integer a1,integer a2 returns nothing
    set f__arg_integer1=a1
    set f__arg_integer2=a2
...
function sc___prototype56_execute takes integer i,integer a1,unit a2,integer a3,integer a4,real a5 returns nothing
    set f__arg_integer1=a1
    set f__arg_unit1=a2
...
function sc___prototype56_evaluate takes integer i,integer a1,unit a2,integer a3,integer a4,real a5 returns nothing
    set f__arg_integer1=a1
    set f__arg_unit1=a2
    set f__arg_integer2=a3
    set f__arg_integer3=a4
...
function h__StopSound takes sound a0, boolean a1, boolean a2 returns nothing
    ...
    call sc___prototype37_evaluate(1,a0,a1,a2)
...
//library SpellNameText:
    ...
    function SpellText takes unit ua,integer aid,real time,real text returns nothing
        ...
        local integer mj
        if ( aid == 'A006' or aid == 'A00M' or aid == 'A00E' or aid == 'A00S' or aid == 'A015' or aid == 'A01B' or aid == 'A01F' ) then
            if ( aid == 'A006' ) then
        ...
        //public:  //总持续时间
            ...
            function s__Buffs_Trigger takes string eName,unit u,integer m returns nothing
                ...
                exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                    ...
                    call sc___prototype36_evaluate(callback,u , m)
                set i=i + 1
                endloop
            endfunction
        ...
        function s__BuffUI_Flush takes unit u returns nothing
            ...
            exitwhen ( i >= s__BuffUI_MaxBuffUI )
                ...
                if ( s__BuffUI_ShowState[b] == true ) then
                    ...
                    call DzFrameSetPoint(s__BuffUI_BuffUIBackground[(b)], 0, s__BuffUI_BuffBackground, 0, ((0.001 + ( x * 0.02 ) )*1.0), (( - 0.003)*1.0)) // INLINED!!
                    set x=x + 1
                    ...
                    if ( tmp != s__Dash_Root ) then
                        ...
                        if ( s__Dash_NowDis[tmp] < s__Dash_MaxDis[tmp] and IsUnitAliveBJ(s__Dash_Unit[tmp]) == true ) then
                            ...
                            elseif ( s__Dash_DashType[tmp] == s__Dash_PWX ) then
                                set speed=s__Dash_MaxSpeed[tmp] * ( (1.00 - ( ((3.99 )*1.0) * Pow(( ( (( s__Dash_NowDis[tmp] )*1.0) / (( s__Dash_MaxDis[tmp])*1.0) ) - 0.50 ), 2.00) )) ) // INLINED!!
                            elseif ( s__Dash_DashType[tmp] == s__Dash_ADD ) then
                                set speed=s__Dash_MaxSpeed[tmp] * ( (1.00 - ( ((3.99 )*1.0) * Pow(( ( (( s__Dash_NowDis[tmp] / 2 )*1.0) / (( s__Dash_MaxDis[tmp])*1.0) ) - 0.50 ), 2.00) )) ) // INLINED!!
                            elseif ( s__Dash_DashType[tmp] == s__Dash_SUB ) then
                                set speed=s__Dash_MaxSpeed[tmp] * ( 1 - (1.00 - ( ((3.99 )*1.0) * Pow(( ( (( s__Dash_NowDis[tmp] / 2 )*1.0) / (( s__Dash_MaxDis[tmp])*1.0) ) - 0.50 ), 2.00) )) ) // INLINED!!
                            endif
...
//processed:     function interface Events__EventInterface takes EventArgs arg0 returns nothing
    ...
    function Events__Event_onPlayerSelectUnit takes nothing returns nothing
        local integer i
        local integer callback
        local integer e=s__EventArgs_create()
        set s__EventArgs_DeathUnit[e]=GetDyingUnit()
    ...
    function Events__onInit takes nothing returns nothing
        ...
        set index=index + 1
        endloop
        call TriggerAddAction(t, function Events__Event_onPlayerSelectUnit) //end of: AllPlayerRegisterEvent("TriggerRegisterPlayerSelectionEventBJ","","Event_onPlayerSelectUnit",",true")
        set t=CreateTrigger()
...
//library LevelUp:
        ...
        function LevelUp___anon__24 takes nothing returns nothing
    ...
    function LevelUp___LvUp takes integer e returns nothing
        ...
        if ( lv > LevelUp___MaxLv ) then
            ...
            call ForForce((Teams___AllPlayers), function LevelUp___anon__24) // INLINED!!
        endif
...
//processed:     function interface Press__PressSnycEventInterface takes player arg0, string arg1 returns nothing  //主要用于同步玩家的按键 //网易提供的事件延迟太高了 //改为使用YDWE-LUA引擎的message.hook+GC实现 //发现网易和LUA.MESSAGE不兼容，重新用网易事件实现
        function s__Press_TriggerSnyc takes string eName,player n,string keyName returns nothing
            ...
            exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                set callback=((LoadInteger(Table__ht, (((- StringHash((eName))))), (i)))) // INLINED!!
                call sc___prototype47_evaluate(callback,n , keyName)
            set i=i + 1
            endloop
        endfunction
...
//processed:     function interface Units__UnitsEventInterface takes Units arg0, Units arg1 returns nothing  //单位基础类 //管理单位身上的集合数据,创建单位用该类函数,杀死单位也是 //以及单位事件
        //public:  //属性 //玩家对象
            ...
            function s__Units_HP takes integer this returns real
                ...
                function s__Units_anon__1 takes nothing returns nothing
                    ...
                    if ( s___Data_r[s__Data_r[data]+3] <= 0 ) then
                        call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (s___Data_i[s__Data_i[data]+2])) // INLINED!!
                        ...
                        call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (s___Data_i[s__Data_i[data]+1])) // INLINED!!
                    endif
                endfunction
            function s__Units_DelayAlpha takes integer this,integer nowA,integer maxA,real time returns nothing
                ...
                call SetUnitVertexColor(s__Units_unit[(this)], 255, 255, 255, (nowA)) // INLINED!!
            ...
            function s__Units_DelaySize takes integer this,real s,real delay returns nothing
                ...
                function s__Units_anon__5 takes nothing returns nothing
                    local integer d=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                    local integer u=(s___Data_c[s__Data_c[d]])
                    call SetUnitTimeScale(s__Units_unit[(u)], ((s___Data_r[s__Data_r[d]])*1.0)) // INLINED!!
                    call s__Data_Destroy(d)
                    call ReleaseTimer(GetExpiredTimer())
                endfunction
            function s__Units_DelayAnimeSpeed takes integer this,real speed,real delay returns nothing
                ...
                function s__Units_anon__6 takes nothing returns nothing
                    local integer d=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                    local integer u=(s___Data_c[s__Data_c[d]])
                    call SetUnitTimeScale(s__Units_unit[(u)], ((1)*1.0)) // INLINED!!
        ...
        //public:  //自定义事件
            function s__Units_Trigger takes string eName,unit u,unit m returns nothing
                ...
                exitwhen ( i >= (LoadInteger(Table__ht, (((- StringHash((eName))))), (0))) ) // INLINED!!
                    set callback=((LoadInteger(Table__ht, (((- StringHash((eName))))), (i)))) // INLINED!!
                    call sc___prototype48_evaluate(callback,sc__Units_Get(u) , sc__Units_Get(m))
                set i=i + 1
                endloop
            endfunction
...
//library Winner:
        ...
        function s__Winner_ShowWin takes integer teamid returns nothing
            ...
            call ForForce((Teams___AllPlayers), function s__Winner_anon__17) // INLINED!!
        endfunction
...
//processed:     function interface Ai___AiEventInterface takes unit arg0 returns nothing  //非玩家英雄的自动施法、移动类 //对于没有实现AI接口的英雄 //点目标技能会在1000码内释放 //无目标技能会在400码内释放 //相同的顺序，无目标和点目标有2套命令串顺序 //在调整施法顺序的时候将对应的命令串填入即可 // 点目标：curse - dispel - charm  - channel -  doom     // 无目标: heal  -  hex   - impale - inferno - instant
    function Ai___AISpell takes unit ua returns nothing
        ...
        if ( s__Units_ai[u] != 0 ) then
            call sc___prototype33_evaluate((s__Units_ai[u]),s__Units_unit[u])
        else
        ...
        function Ai___anon__27 takes nothing returns nothing
            local integer p=(LoadInteger(Table__ht, ((s__Players_ht)), GetHandleId(((GetEnumPlayer()))))) // INLINED!!
            if ( s__Players_isai[p] == true and (IsUnitAliveBJ(s__Units_unit[(s__Players_hero[p])])) ) then // INLINED!!
                call Ai___AISpell(s__Units_unit[s__Players_hero[p]])
            endif
        endfunction
    function Ai___onLoop takes nothing returns nothing
        call ForForce((Teams___AllPlayers), function Ai___anon__27) // INLINED!!
    endfunction
...
//library BlackSaber:
                    ...
                    if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true and (IsUnitAliveBJ(s__Units_unit[(m)])) ) then // INLINED!!
                        ...
                        if ( s___Data_r[s__Data_r[data]+1] == 2 ) then
                            if ( s___Data_r[s__Data_r[data]] < 15 ) then
                                ...
                                call SetUnitTimeScale(s__Units_unit[(u)], ((0.5)*1.0)) // INLINED!!
            ...
            function s__BlackSaber___BlackSaber_anon__82 takes integer dash returns nothing
                ...
                if ( s___Data_i[s__Data_i[data]] == 0 ) then
                    ...
                    if ( k != null ) then
                        ...
                        call SetUnitTimeScale(s__Units_unit[(u)], ((1.5)*1.0)) // INLINED!!
                        set s___Data_r[s__Data_r[data]]=0
        ...
        function s__BlackSaber___BlackSaber_R takes integer e returns nothing
            ...
            call SetUnitTimeScale(s__Units_unit[(u)], ((2.5)*1.0)) // INLINED!!
        ...
        function s__BlackSaber___BlackSaber_E takes integer e returns nothing
            ...
            call SetUnitTimeScale(s__Units_unit[(u)], ((3.5)*1.0)) // INLINED!!
        ...
        function s__BlackSaber___BlackSaber_W takes integer e returns nothing
            ...
            function s__BlackSaber___BlackSaber_anon__89 takes integer dash returns nothing
                ...
                if ( k != null ) then
                    ...
                    call s__Units_Pause(u,true)
                    call SetUnitTimeScale(s__Units_unit[(u)], ((4)*1.0)) // INLINED!!
        ...
        function s__BlackSaber___BlackSaber_HERO_START takes integer e returns nothing
            ...
            if ( s__Spell_Id[e] == 'A00V' ) then
                call SetUnitTimeScale(s__Units_unit[(u)], ((1.75)*1.0)) // INLINED!!
        ...
        function s__BlackSaber___BlackSaber_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A015' )), ( ( (23)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A012' )), ( ( (24)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00U' )), ( ( (25)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00V' )), ( ( (26)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00X' )), ( ( (27)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00X' )), ( ( (28)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00X' )), ( ( (29)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00V' )), ( ( (28)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00V' )), ( ( (29)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A015' )), ( ( (28)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A015' )), ( ( (29)))) // INLINED!!
...
//library DazzleMaster:
        ...
        function s__DazzleMaster___DazzleMaster_AI takes unit ua returns nothing
            ...
            function s__DazzleMaster___DazzleMaster_anon__38 takes nothing returns nothing
                local integer data=((s__TimerUtils__data[GetHandleId((GetExpiredTimer())) - TimerUtils__VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer tmp
                local real h=0
        ...
        function s__DazzleMaster___DazzleMaster_Spawn takes integer u,integer m returns nothing
            ...
            if ( (GetUnitAbilityLevel(s__Units_unit[(u)], ('A008')) > 0) == true ) then // INLINED!!
                ...
                set s__TimerUtils__data[GetHandleId((t )) - TimerUtils__VOFFSET]= ( data) // INLINED!!
                call TimerStart(t, 0.01, true, function s__DazzleMaster___DazzleMaster_anon__38)
                set t=null
            endif
        endfunction
        ...
        function s__DazzleMaster___DazzleMaster_HERO_STOP takes integer e returns nothing
            ...
            function s__DazzleMaster___DazzleMaster_anon__41 takes integer dash returns nothing
                ...
                call SetUnitTimeScale(s__Units_unit[(u)], ((2)*1.0)) // INLINED!!
            ...
            function s__DazzleMaster___DazzleMaster_anon__51 takes integer dash returns nothing
                ...
                if ( s__Dash_NowDis[dash] > 180 ) then
                    ...
                    if ( s__Dash_NowDis[dash] < 197 ) then
                        call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (255)) // INLINED!!
                    else
                        call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (0)) // INLINED!!
                    endif
                else
                    call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (0)) // INLINED!!
                endif
        ...
        function s__DazzleMaster___DazzleMaster_Q takes integer e returns nothing
            ...
            call SetUnitTimeScale(s__Units_unit[(ts)], ((0.7)*1.0)) // INLINED!!
    ...
    function DazzleMaster___onInit takes nothing returns nothing
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A008' )), ( ( (42)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A009' )), ( ( (43)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00B' )), ( ( (44)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00D' )), ( ( (45)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00E' )), ( ( (46)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A009' )), ( ( (47)))) // INLINED!!
        call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A009' )), ( ( (48)))) // INLINED!!
...
//library KillUi:
        ...
        function s__KillUi_create takes integer tid,integer index returns integer
            ...
            call ForForce((s__Teams___Team_Players[(tid)]), function s__KillUi_anon__19) // INLINED!!
    ...
    function KillUi___onInit takes nothing returns nothing
        call TimerStart(NewTimer(), 0.05, false, function KillUi___anon__20)
        call TimerStart(NewTimer(), 0.06, false, function KillUi___anon__21)
    endfunction
...
//library MR:
            ...
            function s__MR__MR_anon__117 takes nothing returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == false ) then // INLINED!!
                    ...
                    set speed=s__Util_XY2EX((GetUnitX(s__Units_unit[(u)])) , (GetUnitY(s__Units_unit[(u)])) , s___Data_r[s__Data_r[data]] , s___Data_r[s__Data_r[data]+1]) // INLINED!!
                    if ( speed > 5 ) then
                        ...
                        if ( s___Data_i[s__Data_i[data]] == 1 ) then
                            set s___Data_i[s__Data_i[data]]=0
                            set s__Dash_onMove[s__Dash_Start(s__Units_unit[u] , (GetUnitFacing(s__Units_unit[(u)])) , 300 , s__Dash_SUB , 10 , true , false)]=(50) // INLINED!!
                        endif
                    endif
        ...
        function s__MR__MR_HERO_START takes integer e returns nothing
            local integer u=(LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))) // INLINED!!
            if ( s__Spell_Id[e] == 'A020' ) then
                call sc__Units_DelayAnime((u),(2) , 0) // INLINED!!
            endif
            call s__Spell_Destroy(e)
        endfunction
        function s__MR__MR_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A020' )), ( ( (53)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A020' )), ( ( (54)))) // INLINED!!
...
//library OrdinaryWizard:
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__32 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer e=(s___Data_c[s__Data_c[data]])
                local integer u=(LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))) // INLINED!!
                local integer mj
        ...
        function s__OrdinaryWizard___OrdinaryWizard_E takes integer u,integer m returns nothing
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__33 takes nothing returns nothing
                local integer i
        ...
        function s__OrdinaryWizard___OrdinaryWizard_W takes integer e returns nothing
            ...
            endloop
            call GroupClear(tmp_group)
            call TimerStart(t, 0.4, false, function s__OrdinaryWizard___OrdinaryWizard_anon__33)
            set t=null
        endfunction
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__35 takes integer da returns nothing
            ...
            function s__OrdinaryWizard___OrdinaryWizard_anon__37 takes integer d returns nothing
                local integer i
        ...
        function s__OrdinaryWizard___OrdinaryWizard_Q takes integer e returns nothing
            ...
            set s__Dash_onMove[dash]=(59)
            set s__Dash_onEnd[dash]=(60)
            call SetUnitTimeScale(s__Units_unit[(u)], ((1)*1.0)) // INLINED!!
            call s__Spell_Destroy(e)
        endfunction
        function s__OrdinaryWizard___OrdinaryWizard_HERO_START takes integer e returns nothing
            if ( s__Spell_Id[e] == 'A002' ) then
                call SetUnitTimeScale(s__Units_unit[((LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))))], ((2.5)*1.0)) // INLINED!!
            ...
            if ( s__Spell_Id[e] == 'A006' ) then
                ...
                call SetUnitTimeScale(s__Units_unit[((LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))))], ((1.5)*1.0)) // INLINED!!
            endif
            call s__Spell_Destroy(e)
        endfunction
        function s__OrdinaryWizard___OrdinaryWizard_HERO_STOP takes integer e returns nothing
            call SetUnitTimeScale(s__Units_unit[((LoadInteger(Table__ht, ((s__Units_ht)), GetHandleId(((s__Spell_Spell[e]))))))], ((1)*1.0)) // INLINED!!
            call s__Spell_Destroy(e)
        endfunction
        function s__OrdinaryWizard___OrdinaryWizard_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A002' )), ( ( (61)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A004' )), ( ( (62)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A006' )), ( ( (63)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A002' )), ( ( (64)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A002' )), ( ( (65)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A006' )), ( ( (64)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A006' )), ( ( (65)))) // INLINED!!
...
//library SL:
        ...
        function s__SL___SL_R takes integer e returns nothing
            ...
            set s__Dash_Obj[dash]=data
            set s__Dash_onMove[dash]=(68)
            set s__Dash_onEnd[dash]=(69)
        endfunction
            ...
            function s__SL___SL_anon__96 takes nothing returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
                    ...
                    set s__Dash_Obj[dash]=2
                    set s__Dash_onMove[dash]=(70)
                    set s__Dash_onEnd[dash]=(71)
                endif
                if ( s__Players_lv15[s__Units_player[u]] == null ) then
                    ...
                    call SetUnitTimeScale(s__Units_unit[(u)], ((3)*1.0)) // INLINED!!
                    call s__Units_DelayReleaseAnimePause(u,0.2)
                endif
                call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                call s__Data_Destroy(data)
        ...
        function s__SL___SL_E takes integer e returns nothing
            ...
            if ( s__Players_lv15[s__Units_player[u]] != null ) then
                set s=0.01
                call SetUnitTimeScale(s__Units_unit[(u)], ((6)*1.0)) // INLINED!!
            endif
            call SetUnitAnimationByIndex(s__Units_unit[(u)], (6)) // INLINED!!
            set s___Data_c[s__Data_c[data]]=u
            set s___Data_c[s__Data_c[data]+1]=e
            ...
            set t=null
                ...
                function s__SL___SL_anon__101 takes integer dash returns nothing
                    ...
                    call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (200)) // INLINED!!
                    call SetUnitAnimationByIndex(s__Units_unit[(u)], (3)) // INLINED!!
                    ...
                    if ( s__Dash_Speed[dash] < 4 ) then
                        ...
                        function s__SL___SL_anon__107 takes integer dash returns nothing
                            ...
                            if ( s__Players_lv15[s__Units_player[u]] == null ) then
                                ...
                                call s__Buffs_Add(s__Units_unit[u] , 'A01C' , 'B008' , 0.25 , false)
                                call SetUnitTimeScale(s__Units_unit[(u)], ((5)*1.0)) // INLINED!!
                                call s__Units_DelayReleaseAnimePause(u,0.2)
                            endif
                            set s___Data_u[s__Data_u[data]]=null
                            call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                        ...
                        if ( s___Data_i[s__Data_i[data]+3] == 0 ) then
                            ...
                            if ( s___Data_i[s__Data_i[data]+1] == 0 ) then
                                ...
                                if ( (IsUnitAliveBJ(s__Units_unit[(m)])) == true ) then // INLINED!!
                                    ...
                                    set s__Dash_Obj[dash]=data
                                    set s__Dash_onMove[dash]=(72)
                                    set s__Dash_onEnd[dash]=(73)
                                else
                                    call SetUnitVertexColor(s__Units_unit[(m)], 255, 255, 255, (255)) // INLINED!!
            ...
            function s__SL___SL_anon__99 takes integer dash returns nothing
                ...
                if ( s__Dash_Speed[dash] < 4 ) then
                    ...
                    if ( k != null ) then
                        ...
                        set s__Dash_onMove[dash1]=(74)
                        set s__Dash_onEnd[dash1]=(75)
                        ...
                        set dash1=s__Dash_Start(s__Units_unit[mj] , s__Util_XY(s__Units_unit[u] , k) - 45 , s__Util_XY2(s__Units_unit[u] , k) * 4 , s__Dash_SUB , 60 , true , false)
                        set s__Dash_Obj[dash1]=data
                        set s__Dash_onMove[dash1]=(76)
                        set s__Dash_onEnd[dash1]=(77)
                        set k=null
                    endif
                endif
            endfunction
        ...
        function s__SL___SL_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01B' )), ( ( (80)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01A' )), ( ( (81)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A017' )), ( ( (82)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A018' )), ( ( (83)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A018' )), ( ( (84)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A01B' )), ( ( (84)))) // INLINED!!
        endfunction
...
//library SwordMaster:
                ...
                function s__SwordMaster___SwordMaster_anon__111 takes nothing returns nothing
                    ...
                    elseif ( s___Data_r[s__Data_r[data]+2] == 0 ) then
                        if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == false or (GetUnitAbilityLevel(s__Units_unit[(u)], ('B009')) > 0) == false ) then // INLINED!!
                            ...
                            set s__Dash_onMove[s__Dash_Start(s__Units_unit[u] , (GetUnitFacing(s__Units_unit[(u)])) , 300 , s__Dash_SUB , 10 , true , false)]=(85) // INLINED!!
        ...
        function s__SwordMaster___SwordMaster_E takes integer e returns nothing
            ...
            function s__SwordMaster___SwordMaster_anon__115 takes nothing returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == false or s___Data_r[s__Data_r[data]] <= 0 ) then // INLINED!!
                    call DestroyGroup(s___Data_g[s__Data_g[data]])
                    set s___Data_g[s__Data_g[data]]=null
                    call SetUnitVertexColor(s__Units_unit[(mj)], 255, 255, 255, (0)) // INLINED!!
        ...
        function s__SwordMaster___SwordMaster_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01E' )), ( ( (89)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01D' )), ( ( (90)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01F' )), ( ( (91)))) // INLINED!!
...
//library WindWalk:
                ...
                function s__WindWalk___WindWalk_anon__57 takes integer dash returns nothing
                    ...
                    call SetUnitTimeScale(s__Units_unit[(c)], ((2)*1.0)) // INLINED!!
            ...
            function s__WindWalk___WindWalk_anon__55 takes integer dash returns nothing
                ...
                if ( k != null ) then
                    ...
                    set s__Dash_Obj[dash1]=data
                    set s__Dash_onMove[dash1]=(92)
                    set s__Dash_onEnd[dash1]=(93)
                endif
                set k=null
                if ( s__Dash_Speed[dash] < 4 ) then
                    call s__Dash_Stop(dash)
        ...
        function s__WindWalk___WindWalk_R takes integer e returns nothing
            ...
            function s__WindWalk___WindWalk_anon__59 takes integer dash returns nothing
                ...
                call SetUnitVertexColor(s__Units_unit[(mj)], 255, 255, 255, (50)) // INLINED!!
                ...
                set s__Dash_onMove[dash1]=(96)
                set s__Dash_onEnd[dash1]=(97)
            endfunction
        ...
        function s__WindWalk___WindWalk_W takes integer e returns nothing
            ...
            function s__WindWalk___WindWalk_anon__68 takes integer dash returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
                    ...
                    set s__Dash_onMove[dash1]=(106)
                    set s__Dash_onEnd[dash1]=(107)
                else
                    call s__Spell_Destroy((s__Dash_Obj[dash]))
                endif
            endfunction
        function s__WindWalk___WindWalk_Q takes integer e returns nothing
            ...
            set s__Dash_Obj[dash]=e
            set s__Dash_onMove[dash]=(108)
            set s__Dash_onEnd[dash]=(109)
        endfunction
        ...
        function s__WindWalk___WindWalk_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00M' )), ( ( (110)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00L' )), ( ( (111)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00J' )), ( ( (112)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00K' )), ( ( (113)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00K' )), ( ( (114)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00K' )), ( ( (115)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00M' )), ( ( (114)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00M' )), ( ( (115)))) // INLINED!!
        endfunction

//library WindWalk ends
//library YeG:

            function YeG___anon__26 takes nothing returns boolean
                return GetUnitTypeId(GetFilterUnit()) == 'n001'
            endfunction
        function YeG___anon__25 takes nothing returns nothing
            local integer s
            local location d
            call GroupEnumUnitsInRange(tmp_group, 0, 0, 9999999999, Condition(function YeG___anon__26))
    ...
    function YeG___onInit takes nothing returns nothing
        ...
        call TimerStart(NewTimer(), 20, true, function YeG___anon__25)
    endfunction
...
//library ZZ:
                function s__ZZ___ZZ_anon__74 takes integer dash returns nothing
                    ...
                    elseif ( s__Util_XY2(s__Units_unit[u] , s__Units_unit[k]) < 25 ) then
                        ...
                        call SetUnitTimeScale(s__Units_unit[(u)], ((GetRandomReal(0.7, 1.2))*1.0)) // INLINED!!
                        call SetUnitAnimation(s__Units_unit[(u)], ("death")) // INLINED!!
                ...
                if ( s__Units_aidindex[u] == 0 ) then
                    ...
                    if ( k != null ) then
                        ...
                        if ( k != null ) then
                            ...
                            set s__Dash_onMove[dash1]=(116)
                            set s__Dash_onEnd[dash1]=(117)
                        endif
                    endif
                    set k=null
                endif
        ...
        function s__ZZ___ZZ_HERO_START takes integer e returns nothing
            ...
            if ( s__Spell_Id[e] == 'A00O' ) then
                call SetUnitTimeScale(s__Units_unit[(u)], ((1.7)*1.0)) // INLINED!!
                call sc__Units_DelayAnime((u),(6) , 0) // INLINED!!
            endif
        ...
        function s__ZZ___ZZ_onInit takes nothing returns nothing
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00S' )), ( ( (122)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00R' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00P' )), ( ( (124)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00O' )), ( ( (125)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00O' )), ( ( (126)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00O' )), ( ( (127)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00R' )), ( ( (126)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00R' )), ( ( (127)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00S' )), ( ( (126)))) // INLINED!!
            call SaveInteger(Table__ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00S' )), ( ( (127)))) // INLINED!!
        endfunction
...
//library NewUI:
    ...
    function NewUI___Reg takes nothing returns nothing
        ...
        call s__BuffUI_RegBuff('B00C') //BUFF条
    ...
    function NewUI___Loop takes nothing returns nothing
        ...
        if ( UISelectUnit != null ) then
            if ( IsUnitAliveBJ(UISelectUnit) == true and IsUnitVisible(UISelectUnit, s__Players_localplayer) == true ) then
    ...
    function NewUI___onInit takes nothing returns nothing
        ...
        call s__Events_On(s__Events_onPlayerSelectUnit , (128))
    endfunction
...
//library Respawn:
        ...
        function s__Respawn___Respawn_Time takes nothing returns nothing
            call ForForce((Teams___AllPlayers), function s__Respawn___Respawn_anon__22) // INLINED!!
        endfunction
            ...
            if ( s__Players_hero[s__Units_player[u]] != null ) then
                ...
                if ( s__Players_hero[s__Units_player[m]] != null ) then
                    if ( s__Players_teamid[s__Units_player[u]] != s__Players_teamid[s__Units_player[m]] and s__Units_unit[m] != null ) then
                        ...
                        call ForForce((s__Teams___Team_Players[GetPlayerTeam((s__Players_player[s__Units_player[m]]))]), function s__Respawn___Respawn_anon__23) // INLINED!!
...
call ExecuteFunc("jasshelper__initstructs1404168218")
...
local player p=f__arg_player1
set f__result_integer= (LoadInteger(Table__ht, ((s__Players_ht)), GetHandleId((p)))) // INLINED!!
   return true
endfunction
...
function sa___prototype37_SoundUtils__HookStopSound takes nothing returns boolean
...
function sa___prototype48_s__Dash_Death takes nothing returns boolean
...
function sa___prototype56_s__Units_Damage takes nothing returns boolean
...
function sa___prototype47_s__PlayerPress_Down takes nothing returns boolean
 local player ps=f__arg_player1
...
function sa___prototype47_s__PlayerPress_Up takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype48_s__Winner_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype33_s__BlackSaber___BlackSaber_AI takes nothing returns boolean
...
function sa___prototype48_s__BlackSaber___BlackSaber_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype33_s__DazzleMaster___DazzleMaster_AI takes nothing returns boolean
...
function sa___prototype48_s__DazzleMaster___DazzleMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype48_s__DazzleMaster___DazzleMaster_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype47_s__KillUi_Show takes nothing returns boolean
 local player p=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype47_s__KillUi_Hide takes nothing returns boolean
 local player p=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype48_s__MR__MR_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype48_s__MR__MR_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37 takes nothing returns boolean
 local integer d=f__arg_integer1
...
function sa___prototype48_s__OrdinaryWizard___OrdinaryWizard_E takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype33_s__SwordMaster___SwordMaster_AI takes nothing returns boolean
...
function sa___prototype48_s__SwordMaster___SwordMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype48_s__Respawn___Respawn_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function jasshelper__initstructs1404168218 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype37[1],function sa___prototype37_SoundUtils__HookStopSound)
    call TriggerAddCondition(st___prototype37[1],Condition(function sa___prototype37_SoundUtils__HookStopSound))
    ...
    call TriggerAddAction(st___prototype1[128],function sa___prototype1_NewUI___Select)
    call TriggerAddCondition(st___prototype1[128],Condition(function sa___prototype1_NewUI___Select))
    set st___prototype48[1]=CreateTrigger()
    call TriggerAddAction(st___prototype48[1],function sa___prototype48_s__Dash_Death)
    call TriggerAddCondition(st___prototype48[1],Condition(function sa___prototype48_s__Dash_Death))
    ...
    call TriggerAddAction(st___prototype56[1],function sa___prototype56_s__Units_Damage)
    call TriggerAddCondition(st___prototype56[1],Condition(function sa___prototype56_s__Units_Damage))
    ...
    call TriggerAddAction(st___prototype47[1],function sa___prototype47_s__PlayerPress_Down)
    call TriggerAddCondition(st___prototype47[1],Condition(function sa___prototype47_s__PlayerPress_Down))
    set st___prototype47[2]=CreateTrigger()
    call TriggerAddAction(st___prototype47[2],function sa___prototype47_s__PlayerPress_Up)
    call TriggerAddCondition(st___prototype47[2],Condition(function sa___prototype47_s__PlayerPress_Up))
    set st___prototype48[2]=CreateTrigger()
    call TriggerAddAction(st___prototype48[2],function sa___prototype48_s__Winner_Death)
    call TriggerAddCondition(st___prototype48[2],Condition(function sa___prototype48_s__Winner_Death))
    set st___prototype1[15]=CreateTrigger()
    call TriggerAddAction(st___prototype1[15],function sa___prototype1_s__BlackSaber___BlackSaber_anon__81)
    call TriggerAddCondition(st___prototype1[15],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__81))
    set st___prototype1[16]=CreateTrigger()
    call TriggerAddAction(st___prototype1[16],function sa___prototype1_s__BlackSaber___BlackSaber_anon__84)
    call TriggerAddCondition(st___prototype1[16],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__84))
    set st___prototype1[17]=CreateTrigger()
    call TriggerAddAction(st___prototype1[17],function sa___prototype1_s__BlackSaber___BlackSaber_anon__82)
    call TriggerAddCondition(st___prototype1[17],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__82))
    set st___prototype1[18]=CreateTrigger()
    call TriggerAddAction(st___prototype1[18],function sa___prototype1_s__BlackSaber___BlackSaber_anon__85)
    call TriggerAddCondition(st___prototype1[18],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__85))
    set st___prototype1[19]=CreateTrigger()
    call TriggerAddAction(st___prototype1[19],function sa___prototype1_s__BlackSaber___BlackSaber_anon__87)
    call TriggerAddCondition(st___prototype1[19],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__87))
    set st___prototype1[20]=CreateTrigger()
    call TriggerAddAction(st___prototype1[20],function sa___prototype1_s__BlackSaber___BlackSaber_anon__88)
    call TriggerAddCondition(st___prototype1[20],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__88))
    set st___prototype1[21]=CreateTrigger()
    call TriggerAddAction(st___prototype1[21],function sa___prototype1_s__BlackSaber___BlackSaber_anon__89)
    call TriggerAddCondition(st___prototype1[21],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__89))
    set st___prototype1[22]=CreateTrigger()
    call TriggerAddAction(st___prototype1[22],function sa___prototype1_s__BlackSaber___BlackSaber_anon__90)
    call TriggerAddCondition(st___prototype1[22],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_anon__90))
    set st___prototype33[1]=CreateTrigger()
    call TriggerAddAction(st___prototype33[1],function sa___prototype33_s__BlackSaber___BlackSaber_AI)
    call TriggerAddCondition(st___prototype33[1],Condition(function sa___prototype33_s__BlackSaber___BlackSaber_AI))
    set st___prototype1[23]=CreateTrigger()
    call TriggerAddAction(st___prototype1[23],function sa___prototype1_s__BlackSaber___BlackSaber_D)
    call TriggerAddCondition(st___prototype1[23],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_D))
    set st___prototype1[24]=CreateTrigger()
    call TriggerAddAction(st___prototype1[24],function sa___prototype1_s__BlackSaber___BlackSaber_R)
    call TriggerAddCondition(st___prototype1[24],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_R))
    set st___prototype1[25]=CreateTrigger()
    call TriggerAddAction(st___prototype1[25],function sa___prototype1_s__BlackSaber___BlackSaber_Q)
    call TriggerAddCondition(st___prototype1[25],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_Q))
    set st___prototype1[26]=CreateTrigger()
    call TriggerAddAction(st___prototype1[26],function sa___prototype1_s__BlackSaber___BlackSaber_W)
    call TriggerAddCondition(st___prototype1[26],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_W))
    set st___prototype1[27]=CreateTrigger()
    call TriggerAddAction(st___prototype1[27],function sa___prototype1_s__BlackSaber___BlackSaber_E)
    call TriggerAddCondition(st___prototype1[27],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_E))
    set st___prototype1[28]=CreateTrigger()
    call TriggerAddAction(st___prototype1[28],function sa___prototype1_s__BlackSaber___BlackSaber_HERO_START)
    call TriggerAddCondition(st___prototype1[28],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_HERO_START))
    set st___prototype1[29]=CreateTrigger()
    call TriggerAddAction(st___prototype1[29],function sa___prototype1_s__BlackSaber___BlackSaber_HERO_STOP)
    call TriggerAddCondition(st___prototype1[29],Condition(function sa___prototype1_s__BlackSaber___BlackSaber_HERO_STOP))
    set st___prototype48[3]=CreateTrigger()
    call TriggerAddAction(st___prototype48[3],function sa___prototype48_s__BlackSaber___BlackSaber_Spawn)
    call TriggerAddCondition(st___prototype48[3],Condition(function sa___prototype48_s__BlackSaber___BlackSaber_Spawn))
    set st___prototype33[2]=CreateTrigger()
    call TriggerAddAction(st___prototype33[2],function sa___prototype33_s__DazzleMaster___DazzleMaster_AI)
    call TriggerAddCondition(st___prototype33[2],Condition(function sa___prototype33_s__DazzleMaster___DazzleMaster_AI))
    set st___prototype1[30]=CreateTrigger()
    call TriggerAddAction(st___prototype1[30],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__39)
    call TriggerAddCondition(st___prototype1[30],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__39))
    set st___prototype1[31]=CreateTrigger()
    call TriggerAddAction(st___prototype1[31],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__40)
    call TriggerAddCondition(st___prototype1[31],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__40))
    set st___prototype1[32]=CreateTrigger()
    call TriggerAddAction(st___prototype1[32],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__41)
    call TriggerAddCondition(st___prototype1[32],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__41))
    set st___prototype1[33]=CreateTrigger()
    call TriggerAddAction(st___prototype1[33],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__46)
    call TriggerAddCondition(st___prototype1[33],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__46))
    set st___prototype1[34]=CreateTrigger()
    call TriggerAddAction(st___prototype1[34],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__47)
    call TriggerAddCondition(st___prototype1[34],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__47))
    set st___prototype1[35]=CreateTrigger()
    call TriggerAddAction(st___prototype1[35],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__44)
    call TriggerAddCondition(st___prototype1[35],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__44))
    set st___prototype1[36]=CreateTrigger()
    call TriggerAddAction(st___prototype1[36],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__49)
    call TriggerAddCondition(st___prototype1[36],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__49))
    set st___prototype1[37]=CreateTrigger()
    call TriggerAddAction(st___prototype1[37],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__50)
    call TriggerAddCondition(st___prototype1[37],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__50))
    set st___prototype1[38]=CreateTrigger()
    call TriggerAddAction(st___prototype1[38],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__51)
    call TriggerAddCondition(st___prototype1[38],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__51))
    set st___prototype1[39]=CreateTrigger()
    call TriggerAddAction(st___prototype1[39],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__52)
    call TriggerAddCondition(st___prototype1[39],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__52))
    set st___prototype1[40]=CreateTrigger()
    call TriggerAddAction(st___prototype1[40],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__53)
    call TriggerAddCondition(st___prototype1[40],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__53))
    set st___prototype1[41]=CreateTrigger()
    call TriggerAddAction(st___prototype1[41],function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__54)
    call TriggerAddCondition(st___prototype1[41],Condition(function sa___prototype1_s__DazzleMaster___DazzleMaster_anon__54))
    ...
    call TriggerAddAction(st___prototype48[4],function sa___prototype48_s__DazzleMaster___DazzleMaster_Spawn)
    call TriggerAddCondition(st___prototype48[4],Condition(function sa___prototype48_s__DazzleMaster___DazzleMaster_Spawn))
    set st___prototype48[5]=CreateTrigger()
    call TriggerAddAction(st___prototype48[5],function sa___prototype48_s__DazzleMaster___DazzleMaster_Death)
    call TriggerAddCondition(st___prototype48[5],Condition(function sa___prototype48_s__DazzleMaster___DazzleMaster_Death))
    set st___prototype47[3]=CreateTrigger()
    call TriggerAddAction(st___prototype47[3],function sa___prototype47_s__KillUi_Show)
    call TriggerAddCondition(st___prototype47[3],Condition(function sa___prototype47_s__KillUi_Show))
    set st___prototype47[4]=CreateTrigger()
    call TriggerAddAction(st___prototype47[4],function sa___prototype47_s__KillUi_Hide)
    call TriggerAddCondition(st___prototype47[4],Condition(function sa___prototype47_s__KillUi_Hide))
    set st___prototype1[50]=CreateTrigger()
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__MR__MR_anon__118)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__MR__MR_anon__118))
    set st___prototype1[51]=CreateTrigger()
    call TriggerAddAction(st___prototype1[51],function sa___prototype1_s__MR__MR_Damage)
    call TriggerAddCondition(st___prototype1[51],Condition(function sa___prototype1_s__MR__MR_Damage))
    set st___prototype1[52]=CreateTrigger()
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__MR__MR_anon__119)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__MR__MR_anon__119))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__MR__MR_W)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__MR__MR_W))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__MR__MR_HERO_START)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__MR__MR_HERO_START))
    set st___prototype48[6]=CreateTrigger()
    call TriggerAddAction(st___prototype48[6],function sa___prototype48_s__MR__MR_Death)
    call TriggerAddCondition(st___prototype48[6],Condition(function sa___prototype48_s__MR__MR_Death))
    set st___prototype48[7]=CreateTrigger()
    call TriggerAddAction(st___prototype48[7],function sa___prototype48_s__MR__MR_Spawn)
    call TriggerAddCondition(st___prototype48[7],Condition(function sa___prototype48_s__MR__MR_Spawn))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__31)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__31))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__34)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__34))
    set st___prototype1[58]=CreateTrigger()
    call TriggerAddAction(st___prototype1[58],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35)
    call TriggerAddCondition(st___prototype1[58],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35))
    set st___prototype1[59]=CreateTrigger()
    call TriggerAddAction(st___prototype1[59],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36)
    call TriggerAddCondition(st___prototype1[59],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36))
    set st___prototype1[60]=CreateTrigger()
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37))
    set st___prototype1[61]=CreateTrigger()
    call TriggerAddAction(st___prototype1[61],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[61],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q))
    set st___prototype1[62]=CreateTrigger()
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP))
    set st___prototype48[8]=CreateTrigger()
    call TriggerAddAction(st___prototype48[8],function sa___prototype48_s__OrdinaryWizard___OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype48[8],Condition(function sa___prototype48_s__OrdinaryWizard___OrdinaryWizard_E))
    set st___prototype1[66]=CreateTrigger()
    call TriggerAddAction(st___prototype1[66],function sa___prototype1_s__SL___SL_anon__92)
    call TriggerAddCondition(st___prototype1[66],Condition(function sa___prototype1_s__SL___SL_anon__92))
    set st___prototype1[67]=CreateTrigger()
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__SL___SL_anon__93)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__SL___SL_anon__93))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__SL___SL_anon__91)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__SL___SL_anon__91))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__SL___SL_anon__95)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__SL___SL_anon__95))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__SL___SL_anon__97)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__SL___SL_anon__97))
    set st___prototype1[71]=CreateTrigger()
    call TriggerAddAction(st___prototype1[71],function sa___prototype1_s__SL___SL_anon__98)
    call TriggerAddCondition(st___prototype1[71],Condition(function sa___prototype1_s__SL___SL_anon__98))
    set st___prototype1[72]=CreateTrigger()
    call TriggerAddAction(st___prototype1[72],function sa___prototype1_s__SL___SL_anon__106)
    call TriggerAddCondition(st___prototype1[72],Condition(function sa___prototype1_s__SL___SL_anon__106))
    set st___prototype1[73]=CreateTrigger()
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__SL___SL_anon__107)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__SL___SL_anon__107))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__SL___SL_anon__100)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__SL___SL_anon__100))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__SL___SL_anon__101)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__SL___SL_anon__101))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__SL___SL_anon__103)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__SL___SL_anon__103))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__SL___SL_anon__104)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__SL___SL_anon__104))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__SL___SL_anon__99)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__SL___SL_anon__99))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__SL___SL_anon__108)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__SL___SL_anon__108))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__SL___SL_R)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__SL___SL_R))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__SL___SL_E)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__SL___SL_E))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__SL___SL_Q)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__SL___SL_Q))
    set st___prototype1[83]=CreateTrigger()
    call TriggerAddAction(st___prototype1[83],function sa___prototype1_s__SL___SL_W)
    call TriggerAddCondition(st___prototype1[83],Condition(function sa___prototype1_s__SL___SL_W))
    set st___prototype1[84]=CreateTrigger()
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__SL___SL_HERO_START)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__SL___SL_HERO_START))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__SwordMaster___SwordMaster_anon__112)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__112))
    set st___prototype1[86]=CreateTrigger()
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__SwordMaster___SwordMaster_anon__113)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__113))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__SwordMaster___SwordMaster_anon__114)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__114))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__SwordMaster___SwordMaster_anon__116)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__116))
    set st___prototype33[3]=CreateTrigger()
    call TriggerAddAction(st___prototype33[3],function sa___prototype33_s__SwordMaster___SwordMaster_AI)
    call TriggerAddCondition(st___prototype33[3],Condition(function sa___prototype33_s__SwordMaster___SwordMaster_AI))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__SwordMaster___SwordMaster_W)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_W))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__SwordMaster___SwordMaster_E)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_E))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__SwordMaster___SwordMaster_R)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_R))
    set st___prototype48[9]=CreateTrigger()
    call TriggerAddAction(st___prototype48[9],function sa___prototype48_s__SwordMaster___SwordMaster_Spawn)
    call TriggerAddCondition(st___prototype48[9],Condition(function sa___prototype48_s__SwordMaster___SwordMaster_Spawn))
    set st___prototype1[92]=CreateTrigger()
    call TriggerAddAction(st___prototype1[92],function sa___prototype1_s__WindWalk___WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[92],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__56))
    set st___prototype1[93]=CreateTrigger()
    call TriggerAddAction(st___prototype1[93],function sa___prototype1_s__WindWalk___WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[93],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__57))
    set st___prototype1[94]=CreateTrigger()
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__WindWalk___WindWalk_anon__55)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__55))
    set st___prototype1[95]=CreateTrigger()
    call TriggerAddAction(st___prototype1[95],function sa___prototype1_s__WindWalk___WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[95],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__58))
    set st___prototype1[96]=CreateTrigger()
    call TriggerAddAction(st___prototype1[96],function sa___prototype1_s__WindWalk___WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[96],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__60))
    set st___prototype1[97]=CreateTrigger()
    call TriggerAddAction(st___prototype1[97],function sa___prototype1_s__WindWalk___WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[97],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__61))
    set st___prototype1[98]=CreateTrigger()
    call TriggerAddAction(st___prototype1[98],function sa___prototype1_s__WindWalk___WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[98],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__59))
    set st___prototype1[99]=CreateTrigger()
    call TriggerAddAction(st___prototype1[99],function sa___prototype1_s__WindWalk___WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[99],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__65))
    set st___prototype1[100]=CreateTrigger()
    call TriggerAddAction(st___prototype1[100],function sa___prototype1_s__WindWalk___WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[100],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__66))
    set st___prototype1[101]=CreateTrigger()
    call TriggerAddAction(st___prototype1[101],function sa___prototype1_s__WindWalk___WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[101],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__62))
    set st___prototype1[102]=CreateTrigger()
    call TriggerAddAction(st___prototype1[102],function sa___prototype1_s__WindWalk___WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[102],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__63))
    set st___prototype1[103]=CreateTrigger()
    call TriggerAddAction(st___prototype1[103],function sa___prototype1_s__WindWalk___WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[103],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__64))
    set st___prototype1[104]=CreateTrigger()
    call TriggerAddAction(st___prototype1[104],function sa___prototype1_s__WindWalk___WindWalk_anon__70)
    call TriggerAddCondition(st___prototype1[104],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__70))
    set st___prototype1[105]=CreateTrigger()
    call TriggerAddAction(st___prototype1[105],function sa___prototype1_s__WindWalk___WindWalk_anon__71)
    call TriggerAddCondition(st___prototype1[105],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__71))
    set st___prototype1[106]=CreateTrigger()
    call TriggerAddAction(st___prototype1[106],function sa___prototype1_s__WindWalk___WindWalk_anon__69)
    call TriggerAddCondition(st___prototype1[106],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__69))
    set st___prototype1[107]=CreateTrigger()
    call TriggerAddAction(st___prototype1[107],function sa___prototype1_s__WindWalk___WindWalk_anon__72)
    call TriggerAddCondition(st___prototype1[107],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__72))
    set st___prototype1[108]=CreateTrigger()
    call TriggerAddAction(st___prototype1[108],function sa___prototype1_s__WindWalk___WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[108],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__67))
    set st___prototype1[109]=CreateTrigger()
    call TriggerAddAction(st___prototype1[109],function sa___prototype1_s__WindWalk___WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[109],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__68))
    set st___prototype1[110]=CreateTrigger()
    call TriggerAddAction(st___prototype1[110],function sa___prototype1_s__WindWalk___WindWalk_R)
    call TriggerAddCondition(st___prototype1[110],Condition(function sa___prototype1_s__WindWalk___WindWalk_R))
    set st___prototype1[111]=CreateTrigger()
    call TriggerAddAction(st___prototype1[111],function sa___prototype1_s__WindWalk___WindWalk_E)
    call TriggerAddCondition(st___prototype1[111],Condition(function sa___prototype1_s__WindWalk___WindWalk_E))
    set st___prototype1[112]=CreateTrigger()
    call TriggerAddAction(st___prototype1[112],function sa___prototype1_s__WindWalk___WindWalk_Q)
    call TriggerAddCondition(st___prototype1[112],Condition(function sa___prototype1_s__WindWalk___WindWalk_Q))
    set st___prototype1[113]=CreateTrigger()
    call TriggerAddAction(st___prototype1[113],function sa___prototype1_s__WindWalk___WindWalk_W)
    call TriggerAddCondition(st___prototype1[113],Condition(function sa___prototype1_s__WindWalk___WindWalk_W))
    set st___prototype1[114]=CreateTrigger()
    call TriggerAddAction(st___prototype1[114],function sa___prototype1_s__WindWalk___WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[114],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_START))
    set st___prototype1[115]=CreateTrigger()
    call TriggerAddAction(st___prototype1[115],function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[115],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP))
    set st___prototype1[116]=CreateTrigger()
    call TriggerAddAction(st___prototype1[116],function sa___prototype1_s__ZZ___ZZ_anon__74)
    call TriggerAddCondition(st___prototype1[116],Condition(function sa___prototype1_s__ZZ___ZZ_anon__74))
    set st___prototype1[117]=CreateTrigger()
    call TriggerAddAction(st___prototype1[117],function sa___prototype1_s__ZZ___ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[117],Condition(function sa___prototype1_s__ZZ___ZZ_anon__75))
    set st___prototype1[118]=CreateTrigger()
    call TriggerAddAction(st___prototype1[118],function sa___prototype1_s__ZZ___ZZ_anon__73)
    call TriggerAddCondition(st___prototype1[118],Condition(function sa___prototype1_s__ZZ___ZZ_anon__73))
    set st___prototype1[119]=CreateTrigger()
    call TriggerAddAction(st___prototype1[119],function sa___prototype1_s__ZZ___ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[119],Condition(function sa___prototype1_s__ZZ___ZZ_anon__76))
    set st___prototype1[120]=CreateTrigger()
    call TriggerAddAction(st___prototype1[120],function sa___prototype1_s__ZZ___ZZ_anon__78)
    call TriggerAddCondition(st___prototype1[120],Condition(function sa___prototype1_s__ZZ___ZZ_anon__78))
    set st___prototype1[121]=CreateTrigger()
    call TriggerAddAction(st___prototype1[121],function sa___prototype1_s__ZZ___ZZ_anon__79)
    call TriggerAddCondition(st___prototype1[121],Condition(function sa___prototype1_s__ZZ___ZZ_anon__79))
    set st___prototype1[122]=CreateTrigger()
    call TriggerAddAction(st___prototype1[122],function sa___prototype1_s__ZZ___ZZ_R)
    call TriggerAddCondition(st___prototype1[122],Condition(function sa___prototype1_s__ZZ___ZZ_R))
    set st___prototype1[123]=CreateTrigger()
    call TriggerAddAction(st___prototype1[123],function sa___prototype1_s__ZZ___ZZ_E)
    call TriggerAddCondition(st___prototype1[123],Condition(function sa___prototype1_s__ZZ___ZZ_E))
    set st___prototype1[124]=CreateTrigger()
    call TriggerAddAction(st___prototype1[124],function sa___prototype1_s__ZZ___ZZ_W)
    call TriggerAddCondition(st___prototype1[124],Condition(function sa___prototype1_s__ZZ___ZZ_W))
    set st___prototype1[125]=CreateTrigger()
    call TriggerAddAction(st___prototype1[125],function sa___prototype1_s__ZZ___ZZ_Q)
    call TriggerAddCondition(st___prototype1[125],Condition(function sa___prototype1_s__ZZ___ZZ_Q))
    set st___prototype1[126]=CreateTrigger()
    call TriggerAddAction(st___prototype1[126],function sa___prototype1_s__ZZ___ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[126],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_START))
    set st___prototype1[127]=CreateTrigger()
    call TriggerAddAction(st___prototype1[127],function sa___prototype1_s__ZZ___ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[127],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_STOP))
    set st___prototype48[10]=CreateTrigger()
    call TriggerAddAction(st___prototype48[10],function sa___prototype48_s__Respawn___Respawn_Death)
    call TriggerAddCondition(st___prototype48[10],Condition(function sa___prototype48_s__Respawn___Respawn_Death))
    set st___prototype47[5]=CreateTrigger()
    call TriggerAddAction(st___prototype47[5],function sa___prototype47_s__Respawn___Respawn_Press)
    call TriggerAddCondition(st___prototype47[5],Condition(function sa___prototype47_s__Respawn___Respawn_Press))
    set st___prototype47[6]=CreateTrigger()
    call TriggerAddAction(st___prototype47[6],function sa___prototype47_s__Respawn___Respawn_PressSnyc)
    call TriggerAddCondition(st___prototype47[6],Condition(function sa___prototype47_s__Respawn___Respawn_PressSnyc))
