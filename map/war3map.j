...
constant integer si__OrdinaryWizard___OrdinaryWizard=42
...
constant integer si__SL___SL=43
integer si__SL___SL_F=0
integer si__SL___SL_I=0
integer array si__SL___SL_V
constant integer si__SwordMaster___SwordMaster=44
...
//library Init:
    ...
    //public:  //中央球、阵初始化、杂物初始化类 //中央球,中央阵
        function Init__anon__8 takes nothing returns nothing
            ...
            set u=s__Units_Spawn(s__Players_player[p] , 'H005' , 0 , 0 , 0)
...
//library NewUI:
    ...
    function NewUI___Reg takes nothing returns nothing
        ...
        call DzFrameSetSize(NewUI___MoneyRightBackground, 0.038, 0.015)
        ...
        call DzFrameSetSize(NewUI___MoneyText, 0.038, 0.016)
    ...
    function NewUI___Chat takes integer e returns nothing
        local real r=S2R(s__EventArgs_ChatString[e])
    endfunction
    function NewUI___Select takes integer e returns nothing
        ...
        if ( s__EventArgs_TriggerPlayer[e] == s__Players_localplayer ) then
            ...
            if ( IsUnitType(UISelectUnit, UNIT_TYPE_HERO) == true ) then
                ...
                call DzFrameSetPoint(DzFrameGetCommandBarButton(2, 3), 0, NewUI___UnitInfoLine, 2, 0.121, - 0.016)
                call DzFrameSetSize(DzFrameGetCommandBarButton(2, 3), 0.04, 0.04) //D
                ...
                if ( GetOwningPlayer(UISelectUnit) == s__Players_localplayer ) then
                    ...
                    exitwhen ( i >= 3 )
                        ...
                        loop
                        exitwhen ( s >= 2 )
                            call DzFrameSetPoint(NewUI___BagItemBackground[idx], 0, NewUI___UnitInfoLine, 2, - 0.335 + ( 0.032 * i ), 0.12 + ( - 0.032 * s ))
                            call DzFrameSetPoint(DzFrameGetItemBarButton(idx), 0, NewUI___UnitInfoLine, 2, - 0.335 + ( 0.032 * i ), 0.12 + ( - 0.032 * s ))
                            set idx=idx + 1
                        set s=s + 1
                        endloop
                    set i=i + 1
                ...
                if ( GetUnitAbilityLevel(UISelectUnit, 'Apit') == 1 ) then
                    ...
                    call DzFrameSetPoint(NewUI___UnitInfoBackground, 4, NewUI___GameUI, 4, - 0.03, - 0.24)
    ...
    function NewUI___onInit takes nothing returns nothing
        ...
        call s__Events_On(s__Events_onPlayerChat , (123))
...
call ExecuteFunc("jasshelper__initstructs890459281")
...
function sa___prototype1_NewUI___Chat takes nothing returns boolean
 local integer e=f__arg_integer1
...
function jasshelper__initstructs890459281 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype1[123],function sa___prototype1_NewUI___Chat)
    call TriggerAddCondition(st___prototype1[123],Condition(function sa___prototype1_NewUI___Chat))
    ...
    call TriggerAddAction(st___prototype47[1],function sa___prototype47_s__Winner_Death)
    call TriggerAddCondition(st___prototype47[1],Condition(function sa___prototype47_s__Winner_Death))
    ...
    call TriggerAddAction(st___prototype47[2],function sa___prototype47_s__BlackSaber___BlackSaber_Spawn)
    call TriggerAddCondition(st___prototype47[2],Condition(function sa___prototype47_s__BlackSaber___BlackSaber_Spawn))
    ...
    call TriggerAddAction(st___prototype47[3],function sa___prototype47_s__DazzleMaster___DazzleMaster_Spawn)
    call TriggerAddCondition(st___prototype47[3],Condition(function sa___prototype47_s__DazzleMaster___DazzleMaster_Spawn))
    set st___prototype47[4]=CreateTrigger()
    call TriggerAddAction(st___prototype47[4],function sa___prototype47_s__DazzleMaster___DazzleMaster_Death)
    call TriggerAddCondition(st___prototype47[4],Condition(function sa___prototype47_s__DazzleMaster___DazzleMaster_Death))
    ...
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32))
    set st___prototype1[51]=CreateTrigger()
    call TriggerAddAction(st___prototype1[51],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__33)
    call TriggerAddCondition(st___prototype1[51],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__33))
    set st___prototype1[52]=CreateTrigger()
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38))
    ...
    call TriggerAddAction(st___prototype47[5],function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype47[5],Condition(function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E))
    ...
    call TriggerAddAction(st___prototype47[6],function sa___prototype47_s__SwordMaster___SwordMaster_Spawn)
    call TriggerAddCondition(st___prototype47[6],Condition(function sa___prototype47_s__SwordMaster___SwordMaster_Spawn))
    ...
    call TriggerAddAction(st___prototype47[7],function sa___prototype47_s__Respawn__Respawn_Death)
    call TriggerAddCondition(st___prototype47[7],Condition(function sa___prototype47_s__Respawn__Respawn_Death))
