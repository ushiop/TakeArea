...
//library Teams:
    ...
    function Teams__onInit takes nothing returns nothing
        set Teams__AllPlayers=GetPlayersMatching(Condition(function Teams__anon__4))
        set s__Teams__Team_Players[0]= GetPlayersMatching(Condition(function Teams__anon__5))
        set s__Teams__Team_Players[1]= GetPlayersMatching(Condition(function Teams__anon__6))
        set s__Teams__Team_Players[2]= GetPlayersMatching(Condition(function Teams__anon__7))
...
//library Init:
    ...
    //public:  //中央球、阵初始化、杂物初始化类 //中央球,中央阵
        function Init__anon__3 takes nothing returns nothing
            local unit u
    ...
    function Init__onInit takes nothing returns nothing
        ...
        call s__Teams_ActionsForAllPlayer(function Init__anon__3)
        set i=0 //测试
        loop
        exitwhen ( i > 5 )
...
call ExecuteFunc("jasshelper__initstructs461576937")
...
function jasshelper__initstructs461576937 takes nothing returns nothing
