...
//processed:     function interface Ai__AiEventInterface takes unit arg0 returns nothing  //非玩家英雄的自动施法、移动类 //对于没有实现AI接口的英雄 //点目标技能会在1000码内释放 //无目标技能会在400码内释放 //相同的顺序，无目标和点目标有2套命令串顺序 //在调整施法顺序的时候将对应的命令串填入即可 // 点目标：curse - dispel - charm  - channel -  doom     // 无目标: heal  -  hex   - impale - inferno - instant
    ...
    function Ai__onLoop takes nothing returns nothing
        call ForForce((Teams__AllPlayers), function Ai__anon__27) // INLINED!!
    endfunction
...
call ExecuteFunc("jasshelper__initstructs1301574921")
...
function sa___prototype36_SoundUtils__HookStopSound takes nothing returns boolean
...
function jasshelper__initstructs1301574921 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype36[1],function sa___prototype36_SoundUtils__HookStopSound)
    call TriggerAddCondition(st___prototype36[1],Condition(function sa___prototype36_SoundUtils__HookStopSound))
    ...
    call TriggerAddAction(st___prototype1[125],function sa___prototype1_NewUI__Select)
    call TriggerAddCondition(st___prototype1[125],Condition(function sa___prototype1_NewUI__Select))
    ...
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__32)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__32))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__34)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__34))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__35)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__35))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__36)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__36))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__37)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__37))
    set st___prototype1[58]=CreateTrigger()
    call TriggerAddAction(st___prototype1[58],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[58],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q))
    set st___prototype1[59]=CreateTrigger()
    call TriggerAddAction(st___prototype1[59],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[59],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W))
    set st___prototype1[60]=CreateTrigger()
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R))
    set st___prototype1[61]=CreateTrigger()
    call TriggerAddAction(st___prototype1[61],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[61],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START))
    set st___prototype1[62]=CreateTrigger()
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP))
    ...
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__SL___SL_anon__93)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__SL___SL_anon__93))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__SL___SL_anon__91)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__SL___SL_anon__91))
    set st___prototype1[66]=CreateTrigger()
    call TriggerAddAction(st___prototype1[66],function sa___prototype1_s__SL___SL_anon__95)
    call TriggerAddCondition(st___prototype1[66],Condition(function sa___prototype1_s__SL___SL_anon__95))
    set st___prototype1[67]=CreateTrigger()
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__SL___SL_anon__97)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__SL___SL_anon__97))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__SL___SL_anon__98)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__SL___SL_anon__98))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__SL___SL_anon__106)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__SL___SL_anon__106))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__SL___SL_anon__107)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__SL___SL_anon__107))
    set st___prototype1[71]=CreateTrigger()
    call TriggerAddAction(st___prototype1[71],function sa___prototype1_s__SL___SL_anon__100)
    call TriggerAddCondition(st___prototype1[71],Condition(function sa___prototype1_s__SL___SL_anon__100))
    set st___prototype1[72]=CreateTrigger()
    call TriggerAddAction(st___prototype1[72],function sa___prototype1_s__SL___SL_anon__101)
    call TriggerAddCondition(st___prototype1[72],Condition(function sa___prototype1_s__SL___SL_anon__101))
    set st___prototype1[73]=CreateTrigger()
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__SL___SL_anon__103)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__SL___SL_anon__103))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__SL___SL_anon__104)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__SL___SL_anon__104))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__SL___SL_anon__99)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__SL___SL_anon__99))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__SL___SL_anon__108)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__SL___SL_anon__108))
    ...
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__SwordMaster___SwordMaster_anon__112)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__112))
    set st___prototype1[83]=CreateTrigger()
    call TriggerAddAction(st___prototype1[83],function sa___prototype1_s__SwordMaster___SwordMaster_anon__113)
    call TriggerAddCondition(st___prototype1[83],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__113))
    set st___prototype1[84]=CreateTrigger()
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__SwordMaster___SwordMaster_anon__114)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__114))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__SwordMaster___SwordMaster_anon__116)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__SwordMaster___SwordMaster_anon__116))
    ...
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__WindWalk___WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__57))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__WindWalk___WindWalk_anon__55)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__55))
    set st___prototype1[92]=CreateTrigger()
    call TriggerAddAction(st___prototype1[92],function sa___prototype1_s__WindWalk___WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[92],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__58))
    ...
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__WindWalk___WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__61))
    set st___prototype1[95]=CreateTrigger()
    call TriggerAddAction(st___prototype1[95],function sa___prototype1_s__WindWalk___WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[95],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__59))
    set st___prototype1[96]=CreateTrigger()
    call TriggerAddAction(st___prototype1[96],function sa___prototype1_s__WindWalk___WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[96],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__65))
    set st___prototype1[97]=CreateTrigger()
    call TriggerAddAction(st___prototype1[97],function sa___prototype1_s__WindWalk___WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[97],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__66))
    set st___prototype1[98]=CreateTrigger()
    call TriggerAddAction(st___prototype1[98],function sa___prototype1_s__WindWalk___WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[98],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__62))
    set st___prototype1[99]=CreateTrigger()
    call TriggerAddAction(st___prototype1[99],function sa___prototype1_s__WindWalk___WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[99],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__63))
    set st___prototype1[100]=CreateTrigger()
    call TriggerAddAction(st___prototype1[100],function sa___prototype1_s__WindWalk___WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[100],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__64))
    ...
    call TriggerAddAction(st___prototype1[102],function sa___prototype1_s__WindWalk___WindWalk_anon__71)
    call TriggerAddCondition(st___prototype1[102],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__71))
    set st___prototype1[103]=CreateTrigger()
    call TriggerAddAction(st___prototype1[103],function sa___prototype1_s__WindWalk___WindWalk_anon__69)
    call TriggerAddCondition(st___prototype1[103],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__69))
    set st___prototype1[104]=CreateTrigger()
    call TriggerAddAction(st___prototype1[104],function sa___prototype1_s__WindWalk___WindWalk_anon__72)
    call TriggerAddCondition(st___prototype1[104],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__72))
    set st___prototype1[105]=CreateTrigger()
    call TriggerAddAction(st___prototype1[105],function sa___prototype1_s__WindWalk___WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[105],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__67))
    set st___prototype1[106]=CreateTrigger()
    call TriggerAddAction(st___prototype1[106],function sa___prototype1_s__WindWalk___WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[106],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__68))
    ...
    call TriggerAddAction(st___prototype1[114],function sa___prototype1_s__ZZ___ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[114],Condition(function sa___prototype1_s__ZZ___ZZ_anon__75))
    set st___prototype1[115]=CreateTrigger()
    call TriggerAddAction(st___prototype1[115],function sa___prototype1_s__ZZ___ZZ_anon__73)
    call TriggerAddCondition(st___prototype1[115],Condition(function sa___prototype1_s__ZZ___ZZ_anon__73))
    set st___prototype1[116]=CreateTrigger()
    call TriggerAddAction(st___prototype1[116],function sa___prototype1_s__ZZ___ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[116],Condition(function sa___prototype1_s__ZZ___ZZ_anon__76))
    set st___prototype1[117]=CreateTrigger()
    call TriggerAddAction(st___prototype1[117],function sa___prototype1_s__ZZ___ZZ_anon__78)
    call TriggerAddCondition(st___prototype1[117],Condition(function sa___prototype1_s__ZZ___ZZ_anon__78))
    set st___prototype1[118]=CreateTrigger()
    call TriggerAddAction(st___prototype1[118],function sa___prototype1_s__ZZ___ZZ_anon__79)
    call TriggerAddCondition(st___prototype1[118],Condition(function sa___prototype1_s__ZZ___ZZ_anon__79))
