...
constant integer si__SoundUtils___soundhelper=24
...
constant integer si__SoundUtils___soundrecycler=25
...
//processed:     function interface Press___PressSnycEventInterface takes player arg0, string arg1 returns nothing  //主要用于同步玩家的按键 //网易提供的事件延迟太高了 //改为使用YDWE-LUA引擎的message.hook+GC实现
    ...
    function GCSnyc takes nothing returns nothing
        call ForForce(Teams___AllPlayers, (function Press___anon__0)) // INLINED!!
    endfunction
...
//library Disconnect:
    ...
    function Disconnect___onDisconnect takes integer e returns nothing
        ...
        if ( x != 0 ) then
            call ForForce((s__Teams___Team_Players[GetPlayerTeam((s__Players_player[Disconnect___tmp]))]), function Disconnect___anon__17) // INLINED!!
        endif
        call s__Teams_PlayerRemoveForce(s__Players_player[Disconnect___tmp])
        call DisplayTimedTextToForce((Teams___AllPlayers), 5.00, s__Players_name[Disconnect___tmp] + " 离开了游戏，金钱将平分给他的队友。") // INLINED!!
...
//library LevelUp:
    ...
    function LevelUp___LvUp takes integer e returns nothing
        ...
        if ( lv > LevelUp___MaxLv ) then
            ...
            call ForForce((Teams___AllPlayers), function LevelUp___anon__25) // INLINED!!
        endif
...
//library Winner:
        ...
        function s__Winner_ShowWin takes integer teamid returns nothing
            ...
            call ForForce((Teams___AllPlayers), function s__Winner_anon__18) // INLINED!!
        endfunction
...
//processed:     function interface Ai___AiEventInterface takes unit arg0 returns nothing  //非玩家英雄的自动施法、移动类 //对于没有实现AI接口的英雄 //点目标技能会在1000码内释放 //无目标技能会在400码内释放 //相同的顺序，无目标和点目标有2套命令串顺序 //在调整施法顺序的时候将对应的命令串填入即可 // 点目标：curse - dispel - charm  - channel -  doom     // 无目标: heal  -  hex   - impale - inferno - instant
    function Ai___AISpell takes unit ua returns nothing
        ...
        if ( mps > 0.2 ) then
            ...
            call IssuePointOrder(s__Units_unit[u], "attack", GetRectCenterX((s__Teams___Team_Rect[GetPlayerTeam((s__Players_player[s__Units_player[u]]))])), GetRectCenterY((s__Teams___Team_Rect[GetPlayerTeam((s__Players_player[s__Units_player[u]]))]))) // INLINED!!
        endif
    ...
    function Ai___onLoop takes nothing returns nothing
        call ForForce((Teams___AllPlayers), function Ai___anon__28) // INLINED!!
    endfunction
...
//library Ai ends
//library BlackSaber:
                function s__BlackSaber__BlackSaber_anon__82 takes integer h returns nothing
        ...
        function s__BlackSaber__BlackSaber_D takes integer e returns nothing
            ...
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, 0.02, true, function s__BlackSaber__BlackSaber_anon__81)
        endfunction
        ...
        function s__BlackSaber__BlackSaber_R takes integer e returns nothing
            ...
            function s__BlackSaber__BlackSaber_anon__87 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local real x
                local real y
        ...
        function s__BlackSaber__BlackSaber_E takes integer e returns nothing
            ...
            call TimerStart(t, 0.01, true, function s__BlackSaber__BlackSaber_anon__87)
            set t=null
        endfunction
        ...
        function s__BlackSaber__BlackSaber_W takes integer e returns nothing
            ...
            function s__BlackSaber__BlackSaber_anon__91 takes integer dash returns nothing
                local integer u=(LoadInteger(Table___ht, ((s__Units_ht)), GetHandleId(((s__Dash_Unit[dash]))))) // INLINED!!
...
//library Init:
    ...
    function Init___onInit takes nothing returns nothing
        ...
        call ForForce(Teams___AllPlayers, (function Init___anon__8)) // INLINED!!
        set i=0 //测试
        loop
        exitwhen ( i > 5 )
...
//library KillUi:
        ...
        function s__KillUi_create takes integer tid,integer index returns integer
            ...
            call ForForce((s__Teams___Team_Players[(tid)]), function s__KillUi_anon__20) // INLINED!!
...
//library KillUi ends
//library MR:
                function s__MR__MR_anon__119 takes integer dash returns nothing
                    set s__Dash_Angle[dash]=GetUnitFacing(s__Dash_Unit[dash])
                endfunction
            function s__MR__MR_anon__118 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer tmp
                local real speed
                    ...
                    if ( s___Data_r[s__Data_r[data]+3] == 1.0 ) then
                        ...
                        if ( (GetUnitAbilityLevel(s__Units_unit[(u)], ('B00B')) > 0) == true ) then // INLINED!!
                            ...
                            exitwhen ( FirstOfGroup(tmp_group) == null )
                                ...
                                call GroupRemoveUnit(tmp_group, s__Units_unit[tmp])
                                if ( IsUnitEnemy(s__Units_unit[tmp], s__Players_player[s__Units_player[u]]) == true ) then
                                    call s__Damage_To(s__Units_unit[s__Players_hero[s__Units_player[(u)]]] , (s__Units_unit[tmp] ) , ( s__Damage_Chaos ) , ( 'A01X' ) , (( (GetHeroStr(s__Units_unit[s__Players_hero[s__Units_player[(u)]]], (true))) * 1.0)*1.0)) // INLINED!!
        ...
        function s__MR__MR_Spawn takes integer u,integer m returns nothing
            ...
            if ( (GetUnitAbilityLevel(s__Units_unit[(u)], ('A01X')) > 0) == true ) then // INLINED!!
                ...
                set s___Data_r[s__Data_r[data]+3]=0
                set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
                call TimerStart(t, 0.01, true, function s__MR__MR_anon__118)
                set t=null
            endif
        endfunction
...
//library OrdinaryWizard:
        ...
        function s__OrdinaryWizard___OrdinaryWizard_onInit takes nothing returns nothing
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A002' )), ( ( (58)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A004' )), ( ( (59)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A006' )), ( ( (60)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A002' )), ( ( (61)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A002' )), ( ( (62)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A006' )), ( ( (61)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A006' )), ( ( (62)))) // INLINED!!
...
//library SL:
                function s__SL__SL_anon__93 takes integer dash returns nothing
                    ...
                    function s__SL__SL_anon__95 takes nothing returns nothing
                        local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                ...
                function s__SL__SL_anon__94 takes integer dash returns nothing
                    local integer u=(LoadInteger(Table___ht, ((s__Units_ht)), GetHandleId(((s__Dash_Unit[dash]))))) // INLINED!!
                    local timer t=NewTimer()
                    local integer data=s__Data_create('A00B')
                    local integer mj
                    ...
                    set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
                    call TimerStart(t, 0.03, true, function s__SL__SL_anon__95)
                    set t=null
                endfunction
        ...
        function s__SL__SL_R takes integer e returns nothing
            ...
            function s__SL__SL_anon__97 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer mj
                local real x=(GetUnitX(s__Units_unit[(u)])) // INLINED!!
        ...
        function s__SL__SL_E takes integer e returns nothing
            ...
            set s___Data_c[s__Data_c[data]+1]=e
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, s, false, function s__SL__SL_anon__97)
            set t=null
        endfunction
                ...
                function s__SL__SL_anon__104 takes integer dash returns nothing
                    ...
                    function s__SL__SL_anon__106 takes nothing returns nothing
                        local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                ...
                function s__SL__SL_anon__105 takes integer dash returns nothing
                    ...
                    set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
                    call TimerStart(t, 0.05, true, function s__SL__SL_anon__106)
                    set t=null
                endfunction
            ...
            function s__SL__SL_anon__109 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer u=(s___Data_c[s__Data_c[data]])
                if ( s___Data_i[s__Data_i[data]] == 0 ) then
                    call SetUnitAnimationByIndex(s__Units_unit[(u)], (0)) // INLINED!!
        ...
        function s__SL__SL_W takes integer e returns nothing
            ...
            function s__SL__SL_anon__110 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer mj
                local real x=(GetUnitX(s__Units_unit[(u)])) // INLINED!!
        ...
        function s__SL__SL_Q takes integer e returns nothing
            ...
            set s___Data_c[s__Data_c[data]+1]=e
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, 0.1, false, function s__SL__SL_anon__110)
            set t=null
        endfunction
        ...
        function s__SL__SL_onInit takes nothing returns nothing
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01B' )), ( ( (77)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01A' )), ( ( (78)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A017' )), ( ( (79)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A018' )), ( ( (80)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A018' )), ( ( (81)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A01B' )), ( ( (81)))) // INLINED!!
        endfunction
...
//library SwordMaster:
                ...
                function s__SwordMaster__SwordMaster_anon__112 takes nothing returns nothing
                    local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                    local integer u=(s___Data_c[s__Data_c[data]])
                    local integer mj
                    if ( s___Data_r[s__Data_r[data]+1] == 1 ) then
            ...
            function s__SwordMaster__SwordMaster_anon__111 takes nothing returns nothing
                ...
                if ( (IsUnitAliveBJ(s__Units_unit[(u)])) == true ) then // INLINED!!
                    ...
                    call TimerStart(GetExpiredTimer(), 0.01, true, function s__SwordMaster__SwordMaster_anon__112)
                else
                    call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                    call s__Data_Destroy(data)
                    call ReleaseTimer(GetExpiredTimer())
        ...
        function s__SwordMaster__SwordMaster_R takes integer e returns nothing
            ...
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, 1, false, function s__SwordMaster__SwordMaster_anon__111)
            set t=null
        endfunction
            ...
            function s__SwordMaster__SwordMaster_anon__115 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer u=(s___Data_c[s__Data_c[data]])
                call DestroyGroup(s___Data_g[s__Data_g[data]])
                set s___Data_g[s__Data_g[data]]=null
        ...
        function s__SwordMaster__SwordMaster_E takes integer e returns nothing
            ...
            set s__Dash_onEnd[dash]=(84)
                ...
                function s__SwordMaster__SwordMaster_anon__117 takes integer dash returns nothing
            ...
            function s__SwordMaster__SwordMaster_anon__116 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
        ...
        function s__SwordMaster__SwordMaster_W takes integer e returns nothing
            ...
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call TimerStart(t, 0.02, true, function s__SwordMaster__SwordMaster_anon__116)
            set t=null
        endfunction
        ...
        function s__SwordMaster__SwordMaster_onInit takes nothing returns nothing
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01E' )), ( ( (86)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01D' )), ( ( (87)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A01F' )), ( ( (88)))) // INLINED!!
...
//library WindWalk:
        ...
        function s__WindWalk__WindWalk_W takes integer e returns nothing
            ...
            function s__WindWalk__WindWalk_anon__68 takes integer dash returns nothing
                ...
                function s__WindWalk__WindWalk_anon__73 takes integer dash returns nothing
                    local integer u=(LoadInteger(Table___ht, ((s__Units_ht)), GetHandleId(((s__Dash_Unit[dash]))))) // INLINED!!
                    call s__Spell_Destroy((s__Dash_Obj[dash]))
                    call SetUnitTimeScale(s__Units_unit[(u)], ((1)*1.0)) // INLINED!!
                    call SetUnitVertexColor(s__Units_unit[(u)], 255, 255, 255, (255)) // INLINED!!
        ...
        function s__WindWalk__WindWalk_onInit takes nothing returns nothing
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00M' )), ( ( (107)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00L' )), ( ( (108)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00J' )), ( ( (109)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00K' )), ( ( (110)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00K' )), ( ( (111)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00K' )), ( ( (112)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onReady )))))), (( 'A00M' )), ( ( (111)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00M' )), ( ( (112)))) // INLINED!!
        endfunction
...
//library ZZ:
        ...
        function s__ZZ__ZZ_R takes integer e returns nothing
            ...
            function s__ZZ__ZZ_anon__78 takes nothing returns nothing
                local integer data=((s__TimerUtils___data[GetHandleId((GetExpiredTimer())) - TimerUtils___VOFFSET])) // INLINED!!
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer mj
                local real dis
        ...
        function s__ZZ__ZZ_E takes integer e returns nothing
            ...
            set s__TimerUtils___data[GetHandleId((t )) - TimerUtils___VOFFSET]= ( data) // INLINED!!
            call DestroyEffect(AddSpecialEffect("Abilities\\Spells\\Human\\Thunderclap\\ThunderClapCaster.mdl", (GetUnitX(s__Units_unit[(u)])), (GetUnitY(s__Units_unit[(u)])))) // INLINED!!
            call TimerStart(t, 0.05, true, function s__ZZ__ZZ_anon__78)
            set t=null
        endfunction
            ...
            function s__ZZ__ZZ_anon__80 takes integer dash returns nothing
                local integer u=(LoadInteger(Table___ht, ((s__Units_ht)), GetHandleId(((s__Dash_Unit[dash]))))) // INLINED!!
                call s__Spell_Destroy((s__Dash_Obj[dash]))
        ...
        function s__ZZ__ZZ_onInit takes nothing returns nothing
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00S' )), ( ( (119)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00R' )), ( ( (120)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00P' )), ( ( (121)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onSpell )))))), (( 'A00O' )), ( ( (122)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00O' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00O' )), ( ( (124)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00R' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00R' )), ( ( (124)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStart )))))), (( 'A00S' )), ( ( (123)))) // INLINED!!
            call SaveInteger(Table___ht, (((- StringHash(((s__Spell_onStop )))))), (( 'A00S' )), ( ( (124)))) // INLINED!!
        endfunction
...
//library NewUI:
    ...
    function NewUI___Reg takes nothing returns nothing
        ...
        call s__BuffUI_RegBuff('B00B') //BUFF条
...
//library Respawn:
        ...
        function s__Respawn___Respawn_Time takes nothing returns nothing
            call ForForce((Teams___AllPlayers), function s__Respawn___Respawn_anon__23) // INLINED!!
        endfunction
            ...
            if ( s__Players_hero[s__Units_player[u]] != null ) then
                ...
                if ( s__Players_hero[s__Units_player[m]] != null ) then
                    if ( s__Players_teamid[s__Units_player[u]] != s__Players_teamid[s__Units_player[m]] and s__Units_unit[m] != null ) then
                        ...
                        call ForForce((s__Teams___Team_Players[GetPlayerTeam((s__Players_player[s__Units_player[m]]))]), function s__Respawn___Respawn_anon__24) // INLINED!!
                        call DisplayTimedTextToForce((Teams___AllPlayers), 5.00, s__Players_name[s__Units_player[m]] + "与队友 因击杀 " + s__Players_name[s__Units_player[u]] + " 而获得了|cffffcc00$300|r") // INLINED!!
                    ...
                    call DisplayTimedTextToForce((Teams___AllPlayers), 5.00, s__Players_name[s__Units_player[u]] + "死在了野怪的手里...") // INLINED!!
                endif
...
function InitAllyPriorities takes nothing returns nothing
    ...
    call SetStartLocPrio(2, 0, 7, MAP_LOC_PRIO_HIGH)
    call SetStartLocPrio(2, 1, 8, MAP_LOC_PRIO_LOW)
...
call ExecuteFunc("jasshelper__initstructs1221592468")
...
function sa___prototype1_s__BlackSaber__BlackSaber_anon__91 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype47_s__BlackSaber__BlackSaber_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype47_s__MR__MR_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype47_s__MR__MR_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype1_s__SL__SL_anon__94 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__SL__SL_anon__109 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__SwordMaster__SwordMaster_anon__115 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__SwordMaster__SwordMaster_anon__117 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype47_s__SwordMaster__SwordMaster_Spawn takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype1_s__WindWalk__WindWalk_anon__73 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__ZZ__ZZ_anon__80 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype47_s__Respawn___Respawn_Death takes nothing returns boolean
 local integer u=f__arg_integer1
 local integer m=f__arg_integer2
...
function sa___prototype36_s__Respawn___Respawn_Press takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function sa___prototype36_s__Respawn___Respawn_PressSnyc takes nothing returns boolean
 local player ps=f__arg_player1
 local string e=f__arg_string1
...
function jasshelper__initstructs1221592468 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype1[15],function sa___prototype1_s__BlackSaber__BlackSaber_anon__82)
    call TriggerAddCondition(st___prototype1[15],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__82))
    set st___prototype1[16]=CreateTrigger()
    call TriggerAddAction(st___prototype1[16],function sa___prototype1_s__BlackSaber__BlackSaber_anon__85)
    call TriggerAddCondition(st___prototype1[16],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__85))
    set st___prototype1[17]=CreateTrigger()
    call TriggerAddAction(st___prototype1[17],function sa___prototype1_s__BlackSaber__BlackSaber_anon__83)
    call TriggerAddCondition(st___prototype1[17],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__83))
    set st___prototype1[18]=CreateTrigger()
    call TriggerAddAction(st___prototype1[18],function sa___prototype1_s__BlackSaber__BlackSaber_anon__86)
    call TriggerAddCondition(st___prototype1[18],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__86))
    set st___prototype1[19]=CreateTrigger()
    call TriggerAddAction(st___prototype1[19],function sa___prototype1_s__BlackSaber__BlackSaber_anon__88)
    call TriggerAddCondition(st___prototype1[19],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__88))
    set st___prototype1[20]=CreateTrigger()
    call TriggerAddAction(st___prototype1[20],function sa___prototype1_s__BlackSaber__BlackSaber_anon__89)
    call TriggerAddCondition(st___prototype1[20],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__89))
    set st___prototype1[21]=CreateTrigger()
    call TriggerAddAction(st___prototype1[21],function sa___prototype1_s__BlackSaber__BlackSaber_anon__90)
    call TriggerAddCondition(st___prototype1[21],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__90))
    set st___prototype1[22]=CreateTrigger()
    call TriggerAddAction(st___prototype1[22],function sa___prototype1_s__BlackSaber__BlackSaber_anon__91)
    call TriggerAddCondition(st___prototype1[22],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__91))
    ...
    call TriggerAddAction(st___prototype47[3],function sa___prototype47_s__BlackSaber__BlackSaber_Spawn)
    call TriggerAddCondition(st___prototype47[3],Condition(function sa___prototype47_s__BlackSaber__BlackSaber_Spawn))
    ...
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__MR__MR_anon__119)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__MR__MR_anon__119))
    ...
    call TriggerAddAction(st___prototype47[6],function sa___prototype47_s__MR__MR_Death)
    call TriggerAddCondition(st___prototype47[6],Condition(function sa___prototype47_s__MR__MR_Death))
    set st___prototype47[7]=CreateTrigger()
    call TriggerAddAction(st___prototype47[7],function sa___prototype47_s__MR__MR_Spawn)
    call TriggerAddCondition(st___prototype47[7],Condition(function sa___prototype47_s__MR__MR_Spawn))
    ...
    call TriggerAddAction(st___prototype47[8],function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype47[8],Condition(function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__SL__SL_anon__93)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__SL__SL_anon__93))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__SL__SL_anon__94)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__SL__SL_anon__94))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__SL__SL_anon__92)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__SL__SL_anon__92))
    ...
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__SL__SL_anon__98)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__SL__SL_anon__98))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__SL__SL_anon__99)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__SL__SL_anon__99))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__SL__SL_anon__107)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__SL__SL_anon__107))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__SL__SL_anon__108)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__SL__SL_anon__108))
    ...
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__SL__SL_anon__104)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__SL__SL_anon__104))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__SL__SL_anon__105)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__SL__SL_anon__105))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__SL__SL_anon__100)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__SL__SL_anon__100))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__SL__SL_anon__109)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__SL__SL_anon__109))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__SL__SL_R)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__SL__SL_R))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__SL__SL_E)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__SL__SL_E))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__SL__SL_Q)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__SL__SL_Q))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__SL__SL_W)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__SL__SL_W))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__SL__SL_HERO_START)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__SL__SL_HERO_START))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__SwordMaster__SwordMaster_anon__113)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__113))
    ...
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__SwordMaster__SwordMaster_anon__115)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__115))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__SwordMaster__SwordMaster_anon__117)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__117))
    ...
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__SwordMaster__SwordMaster_W)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_W))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__SwordMaster__SwordMaster_E)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_E))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__SwordMaster__SwordMaster_R)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_R))
    set st___prototype47[9]=CreateTrigger()
    call TriggerAddAction(st___prototype47[9],function sa___prototype47_s__SwordMaster__SwordMaster_Spawn)
    call TriggerAddCondition(st___prototype47[9],Condition(function sa___prototype47_s__SwordMaster__SwordMaster_Spawn))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__WindWalk__WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__57))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__WindWalk__WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__58))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__WindWalk__WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__56))
    ...
    call TriggerAddAction(st___prototype1[93],function sa___prototype1_s__WindWalk__WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[93],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__61))
    set st___prototype1[94]=CreateTrigger()
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__WindWalk__WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__62))
    set st___prototype1[95]=CreateTrigger()
    call TriggerAddAction(st___prototype1[95],function sa___prototype1_s__WindWalk__WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[95],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__60))
    set st___prototype1[96]=CreateTrigger()
    call TriggerAddAction(st___prototype1[96],function sa___prototype1_s__WindWalk__WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[96],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__66))
    set st___prototype1[97]=CreateTrigger()
    call TriggerAddAction(st___prototype1[97],function sa___prototype1_s__WindWalk__WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[97],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__67))
    set st___prototype1[98]=CreateTrigger()
    call TriggerAddAction(st___prototype1[98],function sa___prototype1_s__WindWalk__WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[98],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__63))
    set st___prototype1[99]=CreateTrigger()
    call TriggerAddAction(st___prototype1[99],function sa___prototype1_s__WindWalk__WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[99],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__64))
    set st___prototype1[100]=CreateTrigger()
    call TriggerAddAction(st___prototype1[100],function sa___prototype1_s__WindWalk__WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[100],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__65))
    set st___prototype1[101]=CreateTrigger()
    call TriggerAddAction(st___prototype1[101],function sa___prototype1_s__WindWalk__WindWalk_anon__71)
    call TriggerAddCondition(st___prototype1[101],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__71))
    set st___prototype1[102]=CreateTrigger()
    call TriggerAddAction(st___prototype1[102],function sa___prototype1_s__WindWalk__WindWalk_anon__72)
    call TriggerAddCondition(st___prototype1[102],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__72))
    set st___prototype1[103]=CreateTrigger()
    call TriggerAddAction(st___prototype1[103],function sa___prototype1_s__WindWalk__WindWalk_anon__70)
    call TriggerAddCondition(st___prototype1[103],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__70))
    set st___prototype1[104]=CreateTrigger()
    call TriggerAddAction(st___prototype1[104],function sa___prototype1_s__WindWalk__WindWalk_anon__73)
    call TriggerAddCondition(st___prototype1[104],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__73))
    set st___prototype1[105]=CreateTrigger()
    call TriggerAddAction(st___prototype1[105],function sa___prototype1_s__WindWalk__WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[105],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__68))
    set st___prototype1[106]=CreateTrigger()
    call TriggerAddAction(st___prototype1[106],function sa___prototype1_s__WindWalk__WindWalk_anon__69)
    call TriggerAddCondition(st___prototype1[106],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__69))
    set st___prototype1[107]=CreateTrigger()
    call TriggerAddAction(st___prototype1[107],function sa___prototype1_s__WindWalk__WindWalk_R)
    call TriggerAddCondition(st___prototype1[107],Condition(function sa___prototype1_s__WindWalk__WindWalk_R))
    set st___prototype1[108]=CreateTrigger()
    call TriggerAddAction(st___prototype1[108],function sa___prototype1_s__WindWalk__WindWalk_E)
    call TriggerAddCondition(st___prototype1[108],Condition(function sa___prototype1_s__WindWalk__WindWalk_E))
    set st___prototype1[109]=CreateTrigger()
    call TriggerAddAction(st___prototype1[109],function sa___prototype1_s__WindWalk__WindWalk_Q)
    call TriggerAddCondition(st___prototype1[109],Condition(function sa___prototype1_s__WindWalk__WindWalk_Q))
    set st___prototype1[110]=CreateTrigger()
    call TriggerAddAction(st___prototype1[110],function sa___prototype1_s__WindWalk__WindWalk_W)
    call TriggerAddCondition(st___prototype1[110],Condition(function sa___prototype1_s__WindWalk__WindWalk_W))
    set st___prototype1[111]=CreateTrigger()
    call TriggerAddAction(st___prototype1[111],function sa___prototype1_s__WindWalk__WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[111],Condition(function sa___prototype1_s__WindWalk__WindWalk_HERO_START))
    set st___prototype1[112]=CreateTrigger()
    call TriggerAddAction(st___prototype1[112],function sa___prototype1_s__WindWalk__WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[112],Condition(function sa___prototype1_s__WindWalk__WindWalk_HERO_STOP))
    set st___prototype1[113]=CreateTrigger()
    call TriggerAddAction(st___prototype1[113],function sa___prototype1_s__ZZ__ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[113],Condition(function sa___prototype1_s__ZZ__ZZ_anon__75))
    set st___prototype1[114]=CreateTrigger()
    call TriggerAddAction(st___prototype1[114],function sa___prototype1_s__ZZ__ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[114],Condition(function sa___prototype1_s__ZZ__ZZ_anon__76))
    set st___prototype1[115]=CreateTrigger()
    call TriggerAddAction(st___prototype1[115],function sa___prototype1_s__ZZ__ZZ_anon__74)
    call TriggerAddCondition(st___prototype1[115],Condition(function sa___prototype1_s__ZZ__ZZ_anon__74))
    ...
    call TriggerAddAction(st___prototype1[117],function sa___prototype1_s__ZZ__ZZ_anon__79)
    call TriggerAddCondition(st___prototype1[117],Condition(function sa___prototype1_s__ZZ__ZZ_anon__79))
    set st___prototype1[118]=CreateTrigger()
    call TriggerAddAction(st___prototype1[118],function sa___prototype1_s__ZZ__ZZ_anon__80)
    call TriggerAddCondition(st___prototype1[118],Condition(function sa___prototype1_s__ZZ__ZZ_anon__80))
    set st___prototype1[119]=CreateTrigger()
    call TriggerAddAction(st___prototype1[119],function sa___prototype1_s__ZZ__ZZ_R)
    call TriggerAddCondition(st___prototype1[119],Condition(function sa___prototype1_s__ZZ__ZZ_R))
    set st___prototype1[120]=CreateTrigger()
    call TriggerAddAction(st___prototype1[120],function sa___prototype1_s__ZZ__ZZ_E)
    call TriggerAddCondition(st___prototype1[120],Condition(function sa___prototype1_s__ZZ__ZZ_E))
    set st___prototype1[121]=CreateTrigger()
    call TriggerAddAction(st___prototype1[121],function sa___prototype1_s__ZZ__ZZ_W)
    call TriggerAddCondition(st___prototype1[121],Condition(function sa___prototype1_s__ZZ__ZZ_W))
    set st___prototype1[122]=CreateTrigger()
    call TriggerAddAction(st___prototype1[122],function sa___prototype1_s__ZZ__ZZ_Q)
    call TriggerAddCondition(st___prototype1[122],Condition(function sa___prototype1_s__ZZ__ZZ_Q))
    set st___prototype1[123]=CreateTrigger()
    call TriggerAddAction(st___prototype1[123],function sa___prototype1_s__ZZ__ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[123],Condition(function sa___prototype1_s__ZZ__ZZ_HERO_START))
    set st___prototype1[124]=CreateTrigger()
    call TriggerAddAction(st___prototype1[124],function sa___prototype1_s__ZZ__ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[124],Condition(function sa___prototype1_s__ZZ__ZZ_HERO_STOP))
    set st___prototype47[10]=CreateTrigger()
    call TriggerAddAction(st___prototype47[10],function sa___prototype47_s__Respawn___Respawn_Death)
    call TriggerAddCondition(st___prototype47[10],Condition(function sa___prototype47_s__Respawn___Respawn_Death))
    set st___prototype36[5]=CreateTrigger()
    call TriggerAddAction(st___prototype36[5],function sa___prototype36_s__Respawn___Respawn_Press)
    call TriggerAddCondition(st___prototype36[5],Condition(function sa___prototype36_s__Respawn___Respawn_Press))
    set st___prototype36[6]=CreateTrigger()
    call TriggerAddAction(st___prototype36[6],function sa___prototype36_s__Respawn___Respawn_PressSnyc)
    call TriggerAddCondition(st___prototype36[6],Condition(function sa___prototype36_s__Respawn___Respawn_PressSnyc))
