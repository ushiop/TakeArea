...
//processed:     function interface Ai__AiEventInterface takes unit arg0 returns nothing  //非玩家英雄的自动施法、移动类 //对于没有实现AI接口的英雄 //点目标技能会在1000码内释放 //无目标技能会在400码内释放 //相同的顺序，无目标和点目标有2套命令串顺序 //在调整施法顺序的时候将对应的命令串填入即可 // 点目标：curse - dispel - charm  - channel -  doom     // 无目标: heal  -  hex   - impale - inferno - instant
    function Ai__AISpell takes unit ua returns nothing
        ...
        function Ai__anon__24 takes nothing returns nothing
            local integer p=s__Players_Get(GetEnumPlayer())
    ...
    function Ai__onLoop takes nothing returns nothing
        call ForForce(s__Teams_GetAllPlayers(), function Ai__anon__24)
    endfunction
...
//library BlackSaber:
            ...
            function s__BlackSaber__BlackSaber_anon__75 takes integer dash returns nothing
                local integer u=s__Units_Get(s__Dash_Unit[dash])
        ...
        function s__BlackSaber__BlackSaber_W takes integer e returns nothing
            ...
            function s__BlackSaber__BlackSaber_anon__76 takes integer dash returns nothing
                local integer u=s__Units_Get(s__Dash_Unit[dash])
        ...
        function s__BlackSaber__BlackSaber_onInit takes nothing returns nothing
            ...
            call s__Spell_On(s__Spell_onReady , 'A00V' , (22))
            call s__Spell_On(s__Spell_onStop , 'A00V' , (23))
...
//library DazzleMaster:
        ...
        function s__DazzleMaster__DazzleMaster_D takes integer e returns nothing
            ...
            set s__Buffs_onEnd[s__Buffs_Add(s__Units_unit[u] , 'A00G' , 'B002' , 5 , false)]=(24)
                    ...
                    if ( s__Units_Alive(u) == true ) then
                        ...
                        exitwhen ( FirstOfGroup(tmp_group) == null )
                            ...
                            if ( IsUnitEnemy(s__Units_unit[tmp], s__Players_player[s__Units_player[u]]) == true ) then
                                ...
                                set s__Dash_onMove[s__Dash_Start(s__Units_unit[tmp] , s__Util_XY(s__Units_unit[tmp] , s__Units_unit[u]) , s__Util_XY2(s__Units_unit[tmp] , s__Units_unit[u]) , s__Dash_NORMAL , s__Util_XY2(s__Units_unit[tmp] , s__Units_unit[u]) / 4 , true , false)]=(29)
                        ...
                        call TimerStart(GetExpiredTimer(), 0.02, true, function s__DazzleMaster__DazzleMaster_anon__39)
                    else
                        call s__Spell_Destroy((s___Data_c[s__Data_c[data]+1]))
                        call s__Data_Destroy(data)
                        call s__Units_PositionEnabled(u,true)
            ...
            function s__DazzleMaster__DazzleMaster_anon__36 takes nothing returns nothing
                ...
                if ( s__Units_Alive(u) == true ) then
                    ...
                    if ( GroupFind(s__Units_unit[u] , x , y , 150 , false , false) != null ) then
                        ...
                        set t=NewTimer()
                        call SetTimerData(t , data)
                        call TimerStart(t, 0.15, false, function s__DazzleMaster__DazzleMaster_anon__37)
                        set t=null
                    else
                        call s__Units_PositionEnabled(u,true)
                        call s__Units_Pause(u,false)
        ...
        function s__DazzleMaster__DazzleMaster_R takes integer e returns nothing
            ...
            call TimerStart(t, 0.25, false, function s__DazzleMaster__DazzleMaster_anon__36)
            set t=null
        endfunction
        ...
        function s__DazzleMaster__DazzleMaster_E takes integer e returns nothing
            ...
            call SetTimerData(t , data)
            call TimerStart(t, 0.1, true, function s__DazzleMaster__DazzleMaster_anon__42)
            set t=null
        endfunction
    ...
    function DazzleMaster__onInit takes nothing returns nothing
        call s__Spell_On(s__Spell_onSpell , 'A008' , (36))
        call s__Spell_On(s__Spell_onSpell , 'A009' , (37))
        call s__Spell_On(s__Spell_onSpell , 'A00B' , (38))
        call s__Spell_On(s__Spell_onSpell , 'A00D' , (39))
        call s__Spell_On(s__Spell_onSpell , 'A00E' , (40))
        call s__Spell_On(s__Spell_onReady , 'A009' , (41))
        call s__Spell_On(s__Spell_onStop , 'A009' , (42))
        call s__Spell_On(s__Spell_onReady , 'A00D' , (41))
        call s__Spell_On(s__Spell_onStop , 'A00D' , (42))
        call s__Damage_On(s__Damage_onHeroDamageed , (43))
...
//library OrdinaryWizard:
            ...
            function s__OrdinaryWizard__OrdinaryWizard_anon__26 takes integer dash returns nothing
                local integer data=(s__Dash_Obj[dash])
                local integer e=(s___Data_c[s__Data_c[data]])
                local integer u=s__Units_Get(s__Spell_Spell[e])
                local integer mj
        ...
        function s__OrdinaryWizard__OrdinaryWizard_E takes integer u,integer m returns nothing
            ...
            function s__OrdinaryWizard__OrdinaryWizard_anon__27 takes nothing returns nothing
                local integer i
        ...
        function s__OrdinaryWizard__OrdinaryWizard_W takes integer e returns nothing
            ...
            endloop
            call GroupClear(tmp_group)
            call TimerStart(t, 0.4, false, function s__OrdinaryWizard__OrdinaryWizard_anon__27)
            set t=null
        endfunction
            ...
            function s__OrdinaryWizard__OrdinaryWizard_anon__29 takes integer da returns nothing
            ...
            function s__OrdinaryWizard__OrdinaryWizard_anon__31 takes integer d returns nothing
                local integer i
        ...
        function s__OrdinaryWizard__OrdinaryWizard_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A002' , (50))
            call s__Spell_On(s__Spell_onSpell , 'A004' , (51))
            call s__Spell_On(s__Spell_onSpell , 'A006' , (52))
            call s__Spell_On(s__Spell_onStart , 'A002' , (53))
            call s__Spell_On(s__Spell_onStop , 'A002' , (54))
            call s__Spell_On(s__Spell_onStart , 'A006' , (53))
            call s__Spell_On(s__Spell_onStop , 'A006' , (54))
...
//library WindWalk:
        ...
        function s__WindWalk__WindWalk_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00M' , (73))
            call s__Spell_On(s__Spell_onSpell , 'A00L' , (74))
            call s__Spell_On(s__Spell_onSpell , 'A00J' , (75))
            call s__Spell_On(s__Spell_onSpell , 'A00K' , (76))
            call s__Spell_On(s__Spell_onReady , 'A00K' , (77))
            call s__Spell_On(s__Spell_onStop , 'A00K' , (78))
            call s__Spell_On(s__Spell_onReady , 'A00M' , (77))
            call s__Spell_On(s__Spell_onStop , 'A00M' , (78))
        endfunction

//library WindWalk ends
//library YeG:

            function YeG__anon__23 takes nothing returns boolean
                return GetUnitTypeId(GetFilterUnit()) == 'n001'
            endfunction
        function YeG__anon__22 takes nothing returns nothing
            local integer s
            local location d
            call GroupEnumUnitsInRange(tmp_group, 0, 0, 9999999999, Condition(function YeG__anon__23))
    ...
    function YeG__onInit takes nothing returns nothing
        ...
        call TimerStart(NewTimer(), 20, true, function YeG__anon__22)
    endfunction
...
//library ZZ:
        ...
        function s__ZZ__ZZ_R takes integer e returns nothing
            ...
            function s__ZZ__ZZ_anon__71 takes nothing returns nothing
                local integer data=(GetTimerData(GetExpiredTimer()))
                local integer u=(s___Data_c[s__Data_c[data]])
                local integer mj
                local real dis
        ...
        function s__ZZ__ZZ_E takes integer e returns nothing
            ...
            call TimerStart(t, 0.05, true, function s__ZZ__ZZ_anon__71)
            set t=null
        endfunction
        ...
        function s__ZZ__ZZ_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00S' , (85))
            call s__Spell_On(s__Spell_onSpell , 'A00R' , (86))
            call s__Spell_On(s__Spell_onSpell , 'A00P' , (87))
            call s__Spell_On(s__Spell_onSpell , 'A00O' , (88))
            call s__Spell_On(s__Spell_onStart , 'A00O' , (89))
            call s__Spell_On(s__Spell_onStop , 'A00O' , (90))
            call s__Spell_On(s__Spell_onStart , 'A00R' , (89))
            call s__Spell_On(s__Spell_onStop , 'A00R' , (90))
            call s__Spell_On(s__Spell_onStart , 'A00S' , (89))
            call s__Spell_On(s__Spell_onStop , 'A00S' , (90))
        endfunction
...
call ExecuteFunc("jasshelper__initstructs90933140")
...
function sa___prototype1_s__BlackSaber__BlackSaber_anon__75 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__BlackSaber__BlackSaber_anon__76 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__26 takes nothing returns boolean
 local integer dash=f__arg_integer1
...
function jasshelper__initstructs90933140 takes nothing returns nothing
    ...
    call TriggerAddAction(st___prototype1[16],function sa___prototype1_s__BlackSaber__BlackSaber_anon__74)
    call TriggerAddCondition(st___prototype1[16],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__74))
    set st___prototype1[17]=CreateTrigger()
    call TriggerAddAction(st___prototype1[17],function sa___prototype1_s__BlackSaber__BlackSaber_anon__75)
    call TriggerAddCondition(st___prototype1[17],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__75))
    set st___prototype1[18]=CreateTrigger()
    call TriggerAddAction(st___prototype1[18],function sa___prototype1_s__BlackSaber__BlackSaber_anon__76)
    call TriggerAddCondition(st___prototype1[18],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__76))
    set st___prototype1[19]=CreateTrigger()
    call TriggerAddAction(st___prototype1[19],function sa___prototype1_s__BlackSaber__BlackSaber_anon__77)
    call TriggerAddCondition(st___prototype1[19],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_anon__77))
    ...
    call TriggerAddAction(st___prototype1[22],function sa___prototype1_s__BlackSaber__BlackSaber_HERO_START)
    call TriggerAddCondition(st___prototype1[22],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_HERO_START))
    set st___prototype1[23]=CreateTrigger()
    call TriggerAddAction(st___prototype1[23],function sa___prototype1_s__BlackSaber__BlackSaber_HERO_STOP)
    call TriggerAddCondition(st___prototype1[23],Condition(function sa___prototype1_s__BlackSaber__BlackSaber_HERO_STOP))
    ...
    call TriggerAddAction(st___prototype1[24],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__33)
    call TriggerAddCondition(st___prototype1[24],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__33))
    set st___prototype1[25]=CreateTrigger()
    call TriggerAddAction(st___prototype1[25],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__34)
    call TriggerAddCondition(st___prototype1[25],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__34))
    set st___prototype1[26]=CreateTrigger()
    call TriggerAddAction(st___prototype1[26],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__35)
    call TriggerAddCondition(st___prototype1[26],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__35))
    set st___prototype1[27]=CreateTrigger()
    call TriggerAddAction(st___prototype1[27],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__40)
    call TriggerAddCondition(st___prototype1[27],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__40))
    set st___prototype1[28]=CreateTrigger()
    call TriggerAddAction(st___prototype1[28],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__41)
    call TriggerAddCondition(st___prototype1[28],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__41))
    set st___prototype1[29]=CreateTrigger()
    call TriggerAddAction(st___prototype1[29],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__38)
    call TriggerAddCondition(st___prototype1[29],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__38))
    set st___prototype1[30]=CreateTrigger()
    call TriggerAddAction(st___prototype1[30],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__43)
    call TriggerAddCondition(st___prototype1[30],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__43))
    set st___prototype1[31]=CreateTrigger()
    call TriggerAddAction(st___prototype1[31],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__44)
    call TriggerAddCondition(st___prototype1[31],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__44))
    set st___prototype1[32]=CreateTrigger()
    call TriggerAddAction(st___prototype1[32],function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__45)
    call TriggerAddCondition(st___prototype1[32],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_anon__45))
    ...
    call TriggerAddAction(st___prototype1[36],function sa___prototype1_s__DazzleMaster__DazzleMaster_D)
    call TriggerAddCondition(st___prototype1[36],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_D))
    set st___prototype1[37]=CreateTrigger()
    call TriggerAddAction(st___prototype1[37],function sa___prototype1_s__DazzleMaster__DazzleMaster_Q)
    call TriggerAddCondition(st___prototype1[37],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_Q))
    set st___prototype1[38]=CreateTrigger()
    call TriggerAddAction(st___prototype1[38],function sa___prototype1_s__DazzleMaster__DazzleMaster_W)
    call TriggerAddCondition(st___prototype1[38],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_W))
    set st___prototype1[39]=CreateTrigger()
    call TriggerAddAction(st___prototype1[39],function sa___prototype1_s__DazzleMaster__DazzleMaster_E)
    call TriggerAddCondition(st___prototype1[39],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_E))
    set st___prototype1[40]=CreateTrigger()
    call TriggerAddAction(st___prototype1[40],function sa___prototype1_s__DazzleMaster__DazzleMaster_R)
    call TriggerAddCondition(st___prototype1[40],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_R))
    set st___prototype1[41]=CreateTrigger()
    call TriggerAddAction(st___prototype1[41],function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_START)
    call TriggerAddCondition(st___prototype1[41],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_START))
    set st___prototype1[42]=CreateTrigger()
    call TriggerAddAction(st___prototype1[42],function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_STOP)
    call TriggerAddCondition(st___prototype1[42],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_HERO_STOP))
    set st___prototype1[43]=CreateTrigger()
    call TriggerAddAction(st___prototype1[43],function sa___prototype1_s__DazzleMaster__DazzleMaster_Attack)
    call TriggerAddCondition(st___prototype1[43],Condition(function sa___prototype1_s__DazzleMaster__DazzleMaster_Attack))
    ...
    call TriggerAddAction(st___prototype1[44],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__25)
    call TriggerAddCondition(st___prototype1[44],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__25))
    set st___prototype1[45]=CreateTrigger()
    call TriggerAddAction(st___prototype1[45],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__26)
    call TriggerAddCondition(st___prototype1[45],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__26))
    ...
    call TriggerAddAction(st___prototype1[47],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__29)
    call TriggerAddCondition(st___prototype1[47],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__29))
    set st___prototype1[48]=CreateTrigger()
    call TriggerAddAction(st___prototype1[48],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__30)
    call TriggerAddCondition(st___prototype1[48],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__30))
    set st___prototype1[49]=CreateTrigger()
    call TriggerAddAction(st___prototype1[49],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31)
    call TriggerAddCondition(st___prototype1[49],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_anon__31))
    set st___prototype1[50]=CreateTrigger()
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_Q))
    set st___prototype1[51]=CreateTrigger()
    call TriggerAddAction(st___prototype1[51],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[51],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_W))
    set st___prototype1[52]=CreateTrigger()
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_R))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_START))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard__OrdinaryWizard_HERO_STOP))
    set st___prototype46[4]=CreateTrigger()
    call TriggerAddAction(st___prototype46[4],function sa___prototype46_s__OrdinaryWizard__OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype46[4],Condition(function sa___prototype46_s__OrdinaryWizard__OrdinaryWizard_E))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__WindWalk__WindWalk_anon__50)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__50))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__WindWalk__WindWalk_anon__51)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__51))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__WindWalk__WindWalk_anon__49)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__49))
    ...
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__WindWalk__WindWalk_anon__55)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__55))
    ...
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__WindWalk__WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__59))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__WindWalk__WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__60))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__WindWalk__WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__56))
    ...
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__WindWalk__WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__64))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__WindWalk__WindWalk_anon__65)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__65))
    ...
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__WindWalk__WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__WindWalk__WindWalk_anon__66))
    ...
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__WindWalk__WindWalk_R)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__WindWalk__WindWalk_R))
    set st___prototype1[74]=CreateTrigger()
    call TriggerAddAction(st___prototype1[74],function sa___prototype1_s__WindWalk__WindWalk_E)
    call TriggerAddCondition(st___prototype1[74],Condition(function sa___prototype1_s__WindWalk__WindWalk_E))
    set st___prototype1[75]=CreateTrigger()
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__WindWalk__WindWalk_Q)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__WindWalk__WindWalk_Q))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__WindWalk__WindWalk_W)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__WindWalk__WindWalk_W))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__WindWalk__WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__WindWalk__WindWalk_HERO_START))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__WindWalk__WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__WindWalk__WindWalk_HERO_STOP))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__ZZ__ZZ_anon__68)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__ZZ__ZZ_anon__68))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__ZZ__ZZ_anon__69)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__ZZ__ZZ_anon__69))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__ZZ__ZZ_anon__67)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__ZZ__ZZ_anon__67))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__ZZ__ZZ_anon__70)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__ZZ__ZZ_anon__70))
    ...
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__ZZ__ZZ_anon__73)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__ZZ__ZZ_anon__73))
    set st___prototype1[85]=CreateTrigger()
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__ZZ__ZZ_R)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__ZZ__ZZ_R))
    set st___prototype1[86]=CreateTrigger()
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__ZZ__ZZ_E)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__ZZ__ZZ_E))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__ZZ__ZZ_W)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__ZZ__ZZ_W))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__ZZ__ZZ_Q)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__ZZ__ZZ_Q))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__ZZ__ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__ZZ__ZZ_HERO_START))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__ZZ__ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__ZZ__ZZ_HERO_STOP))
