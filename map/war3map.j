        ...
        function s__Winner_onLoop takes nothing returns nothing
            ...
            if ( s__Winner_GameEnd == false ) then
                ...
                elseif ( s__Winner_NowTime >= s__Winner_MaxTime ) then
                    ...
                    if ( s__Winner_Team == 0 ) then
                        set rtmp=( 0.02 * team_numbers[0] ) - ( 0.01 * ( team_numbers[1] + team_numbers[2] ) )
                    elseif ( s__Winner_Team == 1 ) then
                        set rtmp=( 0.02 * team_numbers[1] ) - ( 0.01 * ( team_numbers[0] + team_numbers[2] ) )
                    elseif ( s__Winner_Team == 2 ) then
                        set rtmp=( 0.02 * team_numbers[2] ) - ( 0.01 * ( team_numbers[0] + team_numbers[1] ) )
                    endif
...
call ExecuteFunc("jasshelper__initstructs605879015")
...
function jasshelper__initstructs605879015 takes nothing returns nothing
