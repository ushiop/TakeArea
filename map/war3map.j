...
//Generated method caller for Dash.AllStop
function sc__Dash_AllStop takes unit u returns nothing
    set f__arg_unit1=u
    call TriggerEvaluate(st__Dash_AllStop)
endfunction
...
function sc___prototype38_execute takes integer i,sound a1 returns nothing
    set f__arg_sound1=a1

    call TriggerExecute(st___prototype38[i])
endfunction
function sc___prototype38_evaluate takes integer i,sound a1 returns nothing
    set f__arg_sound1=a1
...
function h__KillSoundWhenDone takes sound a0 returns nothing
    ...
    call sc___prototype38_evaluate(1,a0)
...
//processed:     function interface Press__PressSnycEventInterface takes player arg0, string arg1 returns nothing  //主要用于同步玩家的按键 //网易提供的事件延迟太高了 //改为使用YDWE-LUA引擎的message.hook+GC实现
    ...
    function GCSnyc takes nothing returns nothing
        call s__Teams_ActionsForAllPlayer(function Press__anon__0)
    endfunction
...
//library KillUi ends
//library MR:
        function s__MR__MR_Chat takes integer e returns nothing
        endfunction
        function s__MR__MR_onInit takes nothing returns nothing
            call s__Events_On(s__Events_onPlayerChat , (50))
        endfunction
...
//library OrdinaryWizard:
        ...
        function s__OrdinaryWizard___OrdinaryWizard_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A002' , (57))
            call s__Spell_On(s__Spell_onSpell , 'A004' , (58))
            call s__Spell_On(s__Spell_onSpell , 'A006' , (59))
            call s__Spell_On(s__Spell_onStart , 'A002' , (60))
            call s__Spell_On(s__Spell_onStop , 'A002' , (61))
            call s__Spell_On(s__Spell_onStart , 'A006' , (60))
            call s__Spell_On(s__Spell_onStop , 'A006' , (61))
...
//library SL:
            ...
            function s__SL___SL_anon__100 takes integer dash returns nothing
                ...
                if ( s__Dash_Speed[dash] < 4 ) then
                    ...
                    if ( k != null ) then
                        ...
                        set s__Dash_onMove[dash1]=(70)
                        set s__Dash_onEnd[dash1]=(71)
                        ...
                        set dash1=s__Dash_Start(s__Units_unit[mj] , s__Util_XY(s__Units_unit[u] , k) - 45 , s__Util_XY2(s__Units_unit[u] , k) * 4 , s__Dash_SUB , 60 , true , false)
                        set s__Dash_Obj[dash1]=data
                        set s__Dash_onMove[dash1]=(72)
                        set s__Dash_onEnd[dash1]=(73)
                        set k=null
                    endif
                endif
            endfunction
        ...
        function s__SL___SL_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A01B' , (76))
            call s__Spell_On(s__Spell_onSpell , 'A01A' , (77))
            call s__Spell_On(s__Spell_onSpell , 'A017' , (78))
            call s__Spell_On(s__Spell_onSpell , 'A018' , (79))
            call s__Spell_On(s__Spell_onReady , 'A018' , (80))
            call s__Spell_On(s__Spell_onReady , 'A01B' , (80))
        endfunction
...
//library SwordMaster:
                ...
                function s__SwordMaster__SwordMaster_anon__112 takes nothing returns nothing
                    ...
                    elseif ( s___Data_r[s__Data_r[data]+2] == 0 ) then
                        if ( s__Units_Alive(u) == false or s__Units_IsAbility(u,'B009') == false ) then
                            ...
                            set s__Dash_onMove[s__Dash_Start(s__Units_unit[u] , s__Units_F(u) , 300 , s__Dash_SUB , 10 , true , false)]=(81)
        ...
        function s__SwordMaster__SwordMaster_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A01E' , (85))
            call s__Spell_On(s__Spell_onSpell , 'A01D' , (86))
            call s__Spell_On(s__Spell_onSpell , 'A01F' , (87))
...
//library WindWalk:
            ...
            function s__WindWalk___WindWalk_anon__56 takes integer dash returns nothing
                ...
                if ( k != null ) then
                    ...
                    set s__Dash_Obj[dash1]=data
                    set s__Dash_onMove[dash1]=(88)
                    set s__Dash_onEnd[dash1]=(89)
                endif
                set k=null
                if ( s__Dash_Speed[dash] < 4 ) then
                    call s__Dash_Stop(dash)
        ...
        function s__WindWalk___WindWalk_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00M' , (106))
            call s__Spell_On(s__Spell_onSpell , 'A00L' , (107))
            call s__Spell_On(s__Spell_onSpell , 'A00J' , (108))
            call s__Spell_On(s__Spell_onSpell , 'A00K' , (109))
            call s__Spell_On(s__Spell_onReady , 'A00K' , (110))
            call s__Spell_On(s__Spell_onStop , 'A00K' , (111))
            call s__Spell_On(s__Spell_onReady , 'A00M' , (110))
            call s__Spell_On(s__Spell_onStop , 'A00M' , (111))
        endfunction
...
//library ZZ:
        ...
        function s__ZZ___ZZ_onInit takes nothing returns nothing
            call s__Spell_On(s__Spell_onSpell , 'A00S' , (118))
            call s__Spell_On(s__Spell_onSpell , 'A00R' , (119))
            call s__Spell_On(s__Spell_onSpell , 'A00P' , (120))
            call s__Spell_On(s__Spell_onSpell , 'A00O' , (121))
            call s__Spell_On(s__Spell_onStart , 'A00O' , (122))
            call s__Spell_On(s__Spell_onStop , 'A00O' , (123))
            call s__Spell_On(s__Spell_onStart , 'A00R' , (122))
            call s__Spell_On(s__Spell_onStop , 'A00R' , (123))
            call s__Spell_On(s__Spell_onStart , 'A00S' , (122))
            call s__Spell_On(s__Spell_onStop , 'A00S' , (123))
        endfunction
...
//library NewUI:
    ...
    function NewUI___Reg takes nothing returns nothing
        ...
        call s__BuffUI_BackgroundMove(- 0.06 , - 0.186)
    ...
    function NewUI___Select takes integer e returns nothing
        ...
        if ( s__EventArgs_TriggerPlayer[e] == s__Players_localplayer ) then
            ...
            if ( IsUnitType(UISelectUnit, UNIT_TYPE_HERO) == true ) then
                ...
                call s__BuffUI_BackgroundMove(- 0.06 , - 0.226)
                call s__BuffUI_BackgroundTipMove(- 0.06 , - 0.212)
    ...
    function NewUI___onInit takes nothing returns nothing
        ...
        call s__Events_On(s__Events_onPlayerSelectUnit , (124))
    endfunction
...
call ExecuteFunc("jasshelper__initstructs1131555859")
...
function sa__Dash_AllStop takes nothing returns boolean
    call s__Dash_AllStop(f__arg_unit1)
   return true
endfunction
...
function sa___prototype38_SoundUtils__HookKillSoundWhenDone takes nothing returns boolean
...
function sa___prototype1_s__MR__MR_Chat takes nothing returns boolean
 local integer e=f__arg_integer1
...
function jasshelper__initstructs1131555859 takes nothing returns nothing
    ...
    set st__Dash_AllStop=CreateTrigger()
    call TriggerAddCondition(st__Dash_AllStop,Condition( function sa__Dash_AllStop))
    ...
    call TriggerAddAction(st___prototype38[1],function sa___prototype38_SoundUtils__HookKillSoundWhenDone)
    call TriggerAddCondition(st___prototype38[1],Condition(function sa___prototype38_SoundUtils__HookKillSoundWhenDone))
    ...
    call TriggerAddAction(st___prototype1[124],function sa___prototype1_NewUI___Select)
    call TriggerAddCondition(st___prototype1[124],Condition(function sa___prototype1_NewUI___Select))
    ...
    call TriggerAddAction(st___prototype1[50],function sa___prototype1_s__MR__MR_Chat)
    call TriggerAddCondition(st___prototype1[50],Condition(function sa___prototype1_s__MR__MR_Chat))
    set st___prototype1[51]=CreateTrigger()
    call TriggerAddAction(st___prototype1[51],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32)
    call TriggerAddCondition(st___prototype1[51],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__32))
    set st___prototype1[52]=CreateTrigger()
    call TriggerAddAction(st___prototype1[52],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__33)
    call TriggerAddCondition(st___prototype1[52],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__33))
    set st___prototype1[53]=CreateTrigger()
    call TriggerAddAction(st___prototype1[53],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35)
    call TriggerAddCondition(st___prototype1[53],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__35))
    set st___prototype1[54]=CreateTrigger()
    call TriggerAddAction(st___prototype1[54],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36)
    call TriggerAddCondition(st___prototype1[54],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__36))
    set st___prototype1[55]=CreateTrigger()
    call TriggerAddAction(st___prototype1[55],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37)
    call TriggerAddCondition(st___prototype1[55],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__37))
    set st___prototype1[56]=CreateTrigger()
    call TriggerAddAction(st___prototype1[56],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38)
    call TriggerAddCondition(st___prototype1[56],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_anon__38))
    set st___prototype1[57]=CreateTrigger()
    call TriggerAddAction(st___prototype1[57],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q)
    call TriggerAddCondition(st___prototype1[57],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_Q))
    set st___prototype1[58]=CreateTrigger()
    call TriggerAddAction(st___prototype1[58],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W)
    call TriggerAddCondition(st___prototype1[58],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_W))
    set st___prototype1[59]=CreateTrigger()
    call TriggerAddAction(st___prototype1[59],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R)
    call TriggerAddCondition(st___prototype1[59],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_R))
    set st___prototype1[60]=CreateTrigger()
    call TriggerAddAction(st___prototype1[60],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START)
    call TriggerAddCondition(st___prototype1[60],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_START))
    set st___prototype1[61]=CreateTrigger()
    call TriggerAddAction(st___prototype1[61],function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP)
    call TriggerAddCondition(st___prototype1[61],Condition(function sa___prototype1_s__OrdinaryWizard___OrdinaryWizard_HERO_STOP))
    set st___prototype47[6]=CreateTrigger()
    call TriggerAddAction(st___prototype47[6],function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E)
    call TriggerAddCondition(st___prototype47[6],Condition(function sa___prototype47_s__OrdinaryWizard___OrdinaryWizard_E))
    set st___prototype1[62]=CreateTrigger()
    call TriggerAddAction(st___prototype1[62],function sa___prototype1_s__SL___SL_anon__93)
    call TriggerAddCondition(st___prototype1[62],Condition(function sa___prototype1_s__SL___SL_anon__93))
    set st___prototype1[63]=CreateTrigger()
    call TriggerAddAction(st___prototype1[63],function sa___prototype1_s__SL___SL_anon__94)
    call TriggerAddCondition(st___prototype1[63],Condition(function sa___prototype1_s__SL___SL_anon__94))
    set st___prototype1[64]=CreateTrigger()
    call TriggerAddAction(st___prototype1[64],function sa___prototype1_s__SL___SL_anon__92)
    call TriggerAddCondition(st___prototype1[64],Condition(function sa___prototype1_s__SL___SL_anon__92))
    set st___prototype1[65]=CreateTrigger()
    call TriggerAddAction(st___prototype1[65],function sa___prototype1_s__SL___SL_anon__96)
    call TriggerAddCondition(st___prototype1[65],Condition(function sa___prototype1_s__SL___SL_anon__96))
    set st___prototype1[66]=CreateTrigger()
    call TriggerAddAction(st___prototype1[66],function sa___prototype1_s__SL___SL_anon__98)
    call TriggerAddCondition(st___prototype1[66],Condition(function sa___prototype1_s__SL___SL_anon__98))
    set st___prototype1[67]=CreateTrigger()
    call TriggerAddAction(st___prototype1[67],function sa___prototype1_s__SL___SL_anon__99)
    call TriggerAddCondition(st___prototype1[67],Condition(function sa___prototype1_s__SL___SL_anon__99))
    set st___prototype1[68]=CreateTrigger()
    call TriggerAddAction(st___prototype1[68],function sa___prototype1_s__SL___SL_anon__107)
    call TriggerAddCondition(st___prototype1[68],Condition(function sa___prototype1_s__SL___SL_anon__107))
    set st___prototype1[69]=CreateTrigger()
    call TriggerAddAction(st___prototype1[69],function sa___prototype1_s__SL___SL_anon__108)
    call TriggerAddCondition(st___prototype1[69],Condition(function sa___prototype1_s__SL___SL_anon__108))
    set st___prototype1[70]=CreateTrigger()
    call TriggerAddAction(st___prototype1[70],function sa___prototype1_s__SL___SL_anon__101)
    call TriggerAddCondition(st___prototype1[70],Condition(function sa___prototype1_s__SL___SL_anon__101))
    set st___prototype1[71]=CreateTrigger()
    call TriggerAddAction(st___prototype1[71],function sa___prototype1_s__SL___SL_anon__102)
    call TriggerAddCondition(st___prototype1[71],Condition(function sa___prototype1_s__SL___SL_anon__102))
    set st___prototype1[72]=CreateTrigger()
    call TriggerAddAction(st___prototype1[72],function sa___prototype1_s__SL___SL_anon__104)
    call TriggerAddCondition(st___prototype1[72],Condition(function sa___prototype1_s__SL___SL_anon__104))
    set st___prototype1[73]=CreateTrigger()
    call TriggerAddAction(st___prototype1[73],function sa___prototype1_s__SL___SL_anon__105)
    call TriggerAddCondition(st___prototype1[73],Condition(function sa___prototype1_s__SL___SL_anon__105))
    ...
    call TriggerAddAction(st___prototype1[75],function sa___prototype1_s__SL___SL_anon__109)
    call TriggerAddCondition(st___prototype1[75],Condition(function sa___prototype1_s__SL___SL_anon__109))
    set st___prototype1[76]=CreateTrigger()
    call TriggerAddAction(st___prototype1[76],function sa___prototype1_s__SL___SL_R)
    call TriggerAddCondition(st___prototype1[76],Condition(function sa___prototype1_s__SL___SL_R))
    set st___prototype1[77]=CreateTrigger()
    call TriggerAddAction(st___prototype1[77],function sa___prototype1_s__SL___SL_E)
    call TriggerAddCondition(st___prototype1[77],Condition(function sa___prototype1_s__SL___SL_E))
    set st___prototype1[78]=CreateTrigger()
    call TriggerAddAction(st___prototype1[78],function sa___prototype1_s__SL___SL_Q)
    call TriggerAddCondition(st___prototype1[78],Condition(function sa___prototype1_s__SL___SL_Q))
    set st___prototype1[79]=CreateTrigger()
    call TriggerAddAction(st___prototype1[79],function sa___prototype1_s__SL___SL_W)
    call TriggerAddCondition(st___prototype1[79],Condition(function sa___prototype1_s__SL___SL_W))
    set st___prototype1[80]=CreateTrigger()
    call TriggerAddAction(st___prototype1[80],function sa___prototype1_s__SL___SL_HERO_START)
    call TriggerAddCondition(st___prototype1[80],Condition(function sa___prototype1_s__SL___SL_HERO_START))
    set st___prototype1[81]=CreateTrigger()
    call TriggerAddAction(st___prototype1[81],function sa___prototype1_s__SwordMaster__SwordMaster_anon__113)
    call TriggerAddCondition(st___prototype1[81],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__113))
    set st___prototype1[82]=CreateTrigger()
    call TriggerAddAction(st___prototype1[82],function sa___prototype1_s__SwordMaster__SwordMaster_anon__114)
    call TriggerAddCondition(st___prototype1[82],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__114))
    set st___prototype1[83]=CreateTrigger()
    call TriggerAddAction(st___prototype1[83],function sa___prototype1_s__SwordMaster__SwordMaster_anon__115)
    call TriggerAddCondition(st___prototype1[83],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__115))
    set st___prototype1[84]=CreateTrigger()
    call TriggerAddAction(st___prototype1[84],function sa___prototype1_s__SwordMaster__SwordMaster_anon__117)
    call TriggerAddCondition(st___prototype1[84],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_anon__117))
    ...
    call TriggerAddAction(st___prototype1[85],function sa___prototype1_s__SwordMaster__SwordMaster_W)
    call TriggerAddCondition(st___prototype1[85],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_W))
    set st___prototype1[86]=CreateTrigger()
    call TriggerAddAction(st___prototype1[86],function sa___prototype1_s__SwordMaster__SwordMaster_E)
    call TriggerAddCondition(st___prototype1[86],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_E))
    set st___prototype1[87]=CreateTrigger()
    call TriggerAddAction(st___prototype1[87],function sa___prototype1_s__SwordMaster__SwordMaster_R)
    call TriggerAddCondition(st___prototype1[87],Condition(function sa___prototype1_s__SwordMaster__SwordMaster_R))
    set st___prototype47[7]=CreateTrigger()
    call TriggerAddAction(st___prototype47[7],function sa___prototype47_s__SwordMaster__SwordMaster_Spawn)
    call TriggerAddCondition(st___prototype47[7],Condition(function sa___prototype47_s__SwordMaster__SwordMaster_Spawn))
    set st___prototype1[88]=CreateTrigger()
    call TriggerAddAction(st___prototype1[88],function sa___prototype1_s__WindWalk___WindWalk_anon__57)
    call TriggerAddCondition(st___prototype1[88],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__57))
    set st___prototype1[89]=CreateTrigger()
    call TriggerAddAction(st___prototype1[89],function sa___prototype1_s__WindWalk___WindWalk_anon__58)
    call TriggerAddCondition(st___prototype1[89],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__58))
    set st___prototype1[90]=CreateTrigger()
    call TriggerAddAction(st___prototype1[90],function sa___prototype1_s__WindWalk___WindWalk_anon__56)
    call TriggerAddCondition(st___prototype1[90],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__56))
    set st___prototype1[91]=CreateTrigger()
    call TriggerAddAction(st___prototype1[91],function sa___prototype1_s__WindWalk___WindWalk_anon__59)
    call TriggerAddCondition(st___prototype1[91],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__59))
    set st___prototype1[92]=CreateTrigger()
    call TriggerAddAction(st___prototype1[92],function sa___prototype1_s__WindWalk___WindWalk_anon__61)
    call TriggerAddCondition(st___prototype1[92],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__61))
    set st___prototype1[93]=CreateTrigger()
    call TriggerAddAction(st___prototype1[93],function sa___prototype1_s__WindWalk___WindWalk_anon__62)
    call TriggerAddCondition(st___prototype1[93],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__62))
    set st___prototype1[94]=CreateTrigger()
    call TriggerAddAction(st___prototype1[94],function sa___prototype1_s__WindWalk___WindWalk_anon__60)
    call TriggerAddCondition(st___prototype1[94],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__60))
    set st___prototype1[95]=CreateTrigger()
    call TriggerAddAction(st___prototype1[95],function sa___prototype1_s__WindWalk___WindWalk_anon__66)
    call TriggerAddCondition(st___prototype1[95],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__66))
    set st___prototype1[96]=CreateTrigger()
    call TriggerAddAction(st___prototype1[96],function sa___prototype1_s__WindWalk___WindWalk_anon__67)
    call TriggerAddCondition(st___prototype1[96],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__67))
    set st___prototype1[97]=CreateTrigger()
    call TriggerAddAction(st___prototype1[97],function sa___prototype1_s__WindWalk___WindWalk_anon__63)
    call TriggerAddCondition(st___prototype1[97],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__63))
    set st___prototype1[98]=CreateTrigger()
    call TriggerAddAction(st___prototype1[98],function sa___prototype1_s__WindWalk___WindWalk_anon__64)
    call TriggerAddCondition(st___prototype1[98],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__64))
    ...
    call TriggerAddAction(st___prototype1[100],function sa___prototype1_s__WindWalk___WindWalk_anon__71)
    call TriggerAddCondition(st___prototype1[100],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__71))
    set st___prototype1[101]=CreateTrigger()
    call TriggerAddAction(st___prototype1[101],function sa___prototype1_s__WindWalk___WindWalk_anon__72)
    call TriggerAddCondition(st___prototype1[101],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__72))
    set st___prototype1[102]=CreateTrigger()
    call TriggerAddAction(st___prototype1[102],function sa___prototype1_s__WindWalk___WindWalk_anon__70)
    call TriggerAddCondition(st___prototype1[102],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__70))
    set st___prototype1[103]=CreateTrigger()
    call TriggerAddAction(st___prototype1[103],function sa___prototype1_s__WindWalk___WindWalk_anon__73)
    call TriggerAddCondition(st___prototype1[103],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__73))
    set st___prototype1[104]=CreateTrigger()
    call TriggerAddAction(st___prototype1[104],function sa___prototype1_s__WindWalk___WindWalk_anon__68)
    call TriggerAddCondition(st___prototype1[104],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__68))
    set st___prototype1[105]=CreateTrigger()
    call TriggerAddAction(st___prototype1[105],function sa___prototype1_s__WindWalk___WindWalk_anon__69)
    call TriggerAddCondition(st___prototype1[105],Condition(function sa___prototype1_s__WindWalk___WindWalk_anon__69))
    set st___prototype1[106]=CreateTrigger()
    call TriggerAddAction(st___prototype1[106],function sa___prototype1_s__WindWalk___WindWalk_R)
    call TriggerAddCondition(st___prototype1[106],Condition(function sa___prototype1_s__WindWalk___WindWalk_R))
    set st___prototype1[107]=CreateTrigger()
    call TriggerAddAction(st___prototype1[107],function sa___prototype1_s__WindWalk___WindWalk_E)
    call TriggerAddCondition(st___prototype1[107],Condition(function sa___prototype1_s__WindWalk___WindWalk_E))
    set st___prototype1[108]=CreateTrigger()
    call TriggerAddAction(st___prototype1[108],function sa___prototype1_s__WindWalk___WindWalk_Q)
    call TriggerAddCondition(st___prototype1[108],Condition(function sa___prototype1_s__WindWalk___WindWalk_Q))
    set st___prototype1[109]=CreateTrigger()
    call TriggerAddAction(st___prototype1[109],function sa___prototype1_s__WindWalk___WindWalk_W)
    call TriggerAddCondition(st___prototype1[109],Condition(function sa___prototype1_s__WindWalk___WindWalk_W))
    set st___prototype1[110]=CreateTrigger()
    call TriggerAddAction(st___prototype1[110],function sa___prototype1_s__WindWalk___WindWalk_HERO_START)
    call TriggerAddCondition(st___prototype1[110],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_START))
    set st___prototype1[111]=CreateTrigger()
    call TriggerAddAction(st___prototype1[111],function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP)
    call TriggerAddCondition(st___prototype1[111],Condition(function sa___prototype1_s__WindWalk___WindWalk_HERO_STOP))
    set st___prototype1[112]=CreateTrigger()
    call TriggerAddAction(st___prototype1[112],function sa___prototype1_s__ZZ___ZZ_anon__75)
    call TriggerAddCondition(st___prototype1[112],Condition(function sa___prototype1_s__ZZ___ZZ_anon__75))
    set st___prototype1[113]=CreateTrigger()
    call TriggerAddAction(st___prototype1[113],function sa___prototype1_s__ZZ___ZZ_anon__76)
    call TriggerAddCondition(st___prototype1[113],Condition(function sa___prototype1_s__ZZ___ZZ_anon__76))
    set st___prototype1[114]=CreateTrigger()
    call TriggerAddAction(st___prototype1[114],function sa___prototype1_s__ZZ___ZZ_anon__74)
    call TriggerAddCondition(st___prototype1[114],Condition(function sa___prototype1_s__ZZ___ZZ_anon__74))
    set st___prototype1[115]=CreateTrigger()
    call TriggerAddAction(st___prototype1[115],function sa___prototype1_s__ZZ___ZZ_anon__77)
    call TriggerAddCondition(st___prototype1[115],Condition(function sa___prototype1_s__ZZ___ZZ_anon__77))
    set st___prototype1[116]=CreateTrigger()
    call TriggerAddAction(st___prototype1[116],function sa___prototype1_s__ZZ___ZZ_anon__79)
    call TriggerAddCondition(st___prototype1[116],Condition(function sa___prototype1_s__ZZ___ZZ_anon__79))
    set st___prototype1[117]=CreateTrigger()
    call TriggerAddAction(st___prototype1[117],function sa___prototype1_s__ZZ___ZZ_anon__80)
    call TriggerAddCondition(st___prototype1[117],Condition(function sa___prototype1_s__ZZ___ZZ_anon__80))
    set st___prototype1[118]=CreateTrigger()
    call TriggerAddAction(st___prototype1[118],function sa___prototype1_s__ZZ___ZZ_R)
    call TriggerAddCondition(st___prototype1[118],Condition(function sa___prototype1_s__ZZ___ZZ_R))
    set st___prototype1[119]=CreateTrigger()
    call TriggerAddAction(st___prototype1[119],function sa___prototype1_s__ZZ___ZZ_E)
    call TriggerAddCondition(st___prototype1[119],Condition(function sa___prototype1_s__ZZ___ZZ_E))
    set st___prototype1[120]=CreateTrigger()
    call TriggerAddAction(st___prototype1[120],function sa___prototype1_s__ZZ___ZZ_W)
    call TriggerAddCondition(st___prototype1[120],Condition(function sa___prototype1_s__ZZ___ZZ_W))
    set st___prototype1[121]=CreateTrigger()
    call TriggerAddAction(st___prototype1[121],function sa___prototype1_s__ZZ___ZZ_Q)
    call TriggerAddCondition(st___prototype1[121],Condition(function sa___prototype1_s__ZZ___ZZ_Q))
    set st___prototype1[122]=CreateTrigger()
    call TriggerAddAction(st___prototype1[122],function sa___prototype1_s__ZZ___ZZ_HERO_START)
    call TriggerAddCondition(st___prototype1[122],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_START))
    set st___prototype1[123]=CreateTrigger()
    call TriggerAddAction(st___prototype1[123],function sa___prototype1_s__ZZ___ZZ_HERO_STOP)
    call TriggerAddCondition(st___prototype1[123],Condition(function sa___prototype1_s__ZZ___ZZ_HERO_STOP))
