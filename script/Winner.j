        ...
        private static method onLoop(){
            ...
            if(Winner.GameEnd==false){
                ...
                while(FirstOfGroup(g)!=null){
                    tmp=FirstOfGroup(g);
                    team_numbers[GetPlayerTeam(GetOwningPlayer(GetEnumUnit()))]=team_numbers[GetPlayerTeam(GetOwningPlayer(GetEnumUnit()))]+1;
                ...
                if(Winner.Team==-1){
                    ...
                    if(numbers==0){
                        ...
                        if(Winner.NowTime>=Winner.MaxTime){
                            ...
                            if(Winner.Team==0){
                                rtmp=(0.02*team_numbers[0])-(0.01*(team_numbers[1]+team_numbers[2]));
                            }else if(Winner.Team==1){
                                rtmp=(0.02*team_numbers[1])-(0.01*(team_numbers[0]+team_numbers[2]));
                            }else if(Winner.Team==2){
                                rtmp=(0.02*team_numbers[2])-(0.01*(team_numbers[0]+team_numbers[1]));
                            }
